...
public class ActivityChooserView extends ViewGroup {
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        frameLayout2.setAccessibilityDelegate(new View.AccessibilityDelegate(this) {
    ...
    public void showPopupUnchecked(int i) {
        if (this.mAdapter.getDataModel() != null) {
            ...
            this.mAdapter.getActivityCount();
            throw null;
        }
    ...
    private class Callbacks implements AdapterView.OnItemClickListener, View.OnClickListener, View.OnLongClickListener, PopupWindow.OnDismissListener {
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
            ...
            if (itemViewType == 0) {
                ...
                if (!activityChooserView.mIsSelectingDefaultActivity) {
                    ...
                    ActivityChooserView.this.mAdapter.getDataModel().chooseActivity(i);
                    throw null;
                } else if (i > 0) {
        ...
        public boolean onLongClick(View view) {
            ActivityChooserView activityChooserView = ActivityChooserView.this;
            if (view == activityChooserView.mDefaultActivityButton) {
                activityChooserView.mAdapter.getCount();
                throw null;
            }
            throw new IllegalArgumentException();
        }
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public int getCount() {
            this.mDataModel.getActivityCount();
            throw null;
        }
        ...
        public Object getItem(int i) {
            ...
            if (itemViewType != 0) {
                ...
                this.mDataModel.getDefaultActivity();
                throw null;
            } else {
                this.mDataModel.getActivity(i);
                throw null;
            }
        }
