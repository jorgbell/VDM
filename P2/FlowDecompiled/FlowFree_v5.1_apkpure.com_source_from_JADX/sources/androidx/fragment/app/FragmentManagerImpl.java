                    ...
                    if (next.mState <= 0 || fragmentState.mSavedFragmentState != null) {
                        ...
                        if (str != null) {
                            ...
                            if (fragment != null) {
                                ...
                                putFragment(fragmentState.mSavedFragmentState, "android:target_state", fragment);
            ...
            if (fragmentManagerState.mActive != null) {
                ...
                if (fragmentManagerState.mBackStack != null) {
                    ...
                    while (true) {
                        ...
                        if (DEBUG) {
                            Log.v("FragmentManager", "restoreAllState: back stack #" + i + " (index " + instantiate2.mIndex + "): " + instantiate2);
                            PrintWriter printWriter = new PrintWriter(new LogWriter("FragmentManager"));
