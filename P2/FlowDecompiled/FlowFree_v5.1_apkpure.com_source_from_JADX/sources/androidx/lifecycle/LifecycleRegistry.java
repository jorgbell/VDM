...
public class LifecycleRegistry extends Lifecycle {
    ...
    static Lifecycle.State getStateAfter(Lifecycle.Event event) {
        switch (C01721.$SwitchMap$androidx$lifecycle$Lifecycle$Event[event.ordinal()]) {
            case 1:
            case 2:
    ...
    static /* synthetic */ class C01721 {
        ...
        static {
            ...
            L_0x008d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.lifecycle.LifecycleRegistry.C01721.<clinit>():void");
        }
    }

    private static Lifecycle.Event downEvent(Lifecycle.State state) {
        int i = C01721.$SwitchMap$androidx$lifecycle$Lifecycle$State[state.ordinal()];
        if (i == 1) {
