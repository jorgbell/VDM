...
public class DefaultLoadControl implements LoadControl {
    ...
    protected DefaultLoadControl(DefaultAllocator defaultAllocator, int i, int i2, int i3, int i4, int i5, int i6, boolean z, int i7, boolean z2) {
        ...
        this.minBufferAudioUs = C0200C.msToUs((long) i);
        this.minBufferVideoUs = C0200C.msToUs((long) i8);
        this.maxBufferUs = C0200C.msToUs((long) i9);
        this.bufferForPlaybackUs = C0200C.msToUs((long) i10);
        this.bufferForPlaybackAfterRebufferUs = C0200C.msToUs((long) i11);
        this.targetBufferBytesOverwrite = i6;
        this.prioritizeTimeOverSizeThresholds = z;
        this.backBufferDurationUs = C0200C.msToUs((long) i12);
