...
final class ExoPlayerImplInternal implements Handler.Callback, MediaPeriod.Callback, TrackSelector.InvalidationListener, MediaSource.SourceInfoRefreshListener, DefaultMediaClock.PlaybackParameterListener, PlayerMessage.Sender {
    ...
    public ExoPlayerImplInternal(Renderer[] rendererArr, TrackSelector trackSelector2, TrackSelectorResult trackSelectorResult, LoadControl loadControl2, BandwidthMeter bandwidthMeter2, boolean z, int i, boolean z2, Handler handler2, Clock clock2) {
        ...
        handlerThread.start();
        this.handler = clock2.createHandler(handlerThread.getLooper(), this);
    }
    ...
    public synchronized void sendMessage(PlayerMessage playerMessage) {
        if (this.released) {
            Log.m16w("ExoPlayerImplInternal", "Ignoring messages sent after release.");
    ...
    public boolean handleMessage(Message message) {
        ...
        try {
            ...
            Log.m14e("ExoPlayerImplInternal", "Playback error.", e);
            this.eventHandler.obtainMessage(2, e).sendToTarget();
            stopInternal(true, false, false);
            maybeNotifyPlaybackInfoChanged();
        } catch (IOException e2) {
            Log.m14e("ExoPlayerImplInternal", "Source error.", e2);
            ...
            Log.m14e("ExoPlayerImplInternal", "Internal runtime error.", e3);
    ...
    private void seekToCurrentPosition(boolean z) throws ExoPlaybackException {
        MediaSource.MediaPeriodId mediaPeriodId = this.queue.getPlayingPeriod().info.f7id;
        ...
        if (this.queue.hasPlayingPeriod()) {
            ...
            if (readDiscontinuity != -9223372036854775807L) {
                ...
                if (readDiscontinuity != this.playbackInfo.positionUs) {
                    PlaybackInfo playbackInfo2 = this.playbackInfo;
                    this.playbackInfo = playbackInfo2.copyWithNewPosition(playbackInfo2.periodId, readDiscontinuity, playbackInfo2.contentPositionUs, getTotalBufferedDurationUs());
                    this.playbackInfoUpdate.setPositionDiscontinuity(4);
                }
            } else {
    ...
    private void seekToInternal(androidx.media2.exoplayer.external.ExoPlayerImplInternal.SeekPosition r23) throws androidx.media2.exoplayer.external.ExoPlaybackException {
        ...
        L_0x008c:
            r4 = r12
        L_0x008d:
            long r6 = androidx.media2.exoplayer.external.C0200C.usToMs(r4)     // Catch:{ all -> 0x00de }
            androidx.media2.exoplayer.external.PlaybackInfo r0 = r1.playbackInfo     // Catch:{ all -> 0x00de }
            long r10 = r0.positionUs     // Catch:{ all -> 0x00de }
            long r10 = androidx.media2.exoplayer.external.C0200C.usToMs(r10)     // Catch:{ all -> 0x00de }
    ...
    private long seekToPeriodPosition(MediaSource.MediaPeriodId mediaPeriodId, long j, boolean z) throws ExoPlaybackException {
        ...
        while (true) {
            if (mediaPeriodHolder != null) {
                if (mediaPeriodId.equals(mediaPeriodHolder.info.f7id) && mediaPeriodHolder.prepared) {
    ...
    private void resetInternal(boolean r24, boolean r25, boolean r26, boolean r27) {
        ...
        L_0x0025:
            ...
            androidx.media2.exoplayer.external.util.Log.m14e(r6, r7, r0)
        L_0x002a:
            int r5 = r5 + 1
            goto L_0x0018
        L_0x002d:
        ...
        L_0x003b:
            ...
            androidx.media2.exoplayer.external.util.Log.m14e(r6, r0, r7)
        L_0x0042:
            int r5 = r5 + 1
            goto L_0x0033
        L_0x0045:
        ...
        L_0x004f:
            ...
            if (r3 != 0) goto L_0x0084
            androidx.media2.exoplayer.external.PlaybackInfo r3 = r1.playbackInfo
            androidx.media2.exoplayer.external.Timeline r4 = r3.timeline
        ...
        L_0x00fb:
            ...
            androidx.media2.exoplayer.external.source.TrackGroupArray r4 = androidx.media2.exoplayer.external.source.TrackGroupArray.EMPTY
            goto L_0x0107
        L_0x0105:
            androidx.media2.exoplayer.external.source.TrackGroupArray r4 = r3.trackGroups
        L_0x0107:
            r14 = r4
    ...
    public final /* synthetic */ void lambda$sendMessageToTargetThread$0$ExoPlayerImplInternal(PlayerMessage playerMessage) {
        try {
            ...
            Log.m14e("ExoPlayerImplInternal", "Unexpected error delivering message on external thread.", e);
    ...
    private boolean resolvePendingMessagePosition(PendingMessageInfo pendingMessageInfo) {
        ...
        if (obj == null) {
            Pair<Object, Long> resolveSeekPosition = resolveSeekPosition(new SeekPosition(pendingMessageInfo.message.getTimeline(), pendingMessageInfo.message.getWindowIndex(), C0200C.msToUs(pendingMessageInfo.message.getPositionMs())), false);
    ...
    /* JADX WARNING: Removed duplicated region for block: B:66:0x005b A[EDGE_INSN: B:66:0x005b->B:20:0x005b ?: BREAK  , SYNTHETIC] */
    private void maybeTriggerPendingMessages(long r7, long r9) throws androidx.media2.exoplayer.external.ExoPlaybackException {
        ...
        L_0x0014:
            ...
            long r7 = r7 - r1
        L_0x001f:
            androidx.media2.exoplayer.external.Timeline r1 = r0.timeline
            androidx.media2.exoplayer.external.source.MediaSource$MediaPeriodId r0 = r0.periodId
        ...
        L_0x009c:
            ...
            if (r5 > 0) goto L_0x010c
            androidx.media2.exoplayer.external.PlayerMessage r3 = r1.message     // Catch:{ all -> 0x00eb }
            r6.sendMessageToTarget(r3)     // Catch:{ all -> 0x00eb }
                ...
                if (selectTracks != null) {
                    if (z) {
                        ...
                        if (!(playbackInfo2.playbackState == 4 || applyTrackSelection == playbackInfo2.positionUs)) {
                            ...
                            this.playbackInfo = playbackInfo3.copyWithNewPosition(playbackInfo3.periodId, applyTrackSelection, playbackInfo3.contentPositionUs, getTotalBufferedDurationUs());
                            this.playbackInfoUpdate.setPositionDiscontinuity(4);
    ...
    private boolean isTimelineReady() {
        ...
        long j = playingPeriod.info.durationUs;
        return j == -9223372036854775807L || this.playbackInfo.positionUs < j || (next != null && (next.prepared || next.info.f7id.isAd()));
    }
    ...
    private void handleSourceInfoRefreshed(androidx.media2.exoplayer.external.ExoPlayerImplInternal.MediaSourceRefreshInfo r14) throws androidx.media2.exoplayer.external.ExoPlaybackException {
        ...
        L_0x00f5:
            ...
            androidx.media2.exoplayer.external.source.MediaSource$MediaPeriodId r1 = r1.f7id
        ...
        if (mediaSource2 != null) {
            ...
            if (this.queue.hasPlayingPeriod()) {
                ...
                while (this.playWhenReady && playingPeriod != readingPeriod && this.rendererPositionUs >= playingPeriod.getNext().getStartPositionRendererTime()) {
                    ...
                    this.playbackInfo = playbackInfo2.copyWithNewPosition(mediaPeriodInfo.f7id, mediaPeriodInfo.startPositionUs, mediaPeriodInfo.contentPositionUs, getTotalBufferedDurationUs());
    ...
    private void handleLoadingMediaPeriodChanged(boolean z) {
        long j;
        MediaPeriodHolder loadingPeriod = this.queue.getLoadingPeriod();
        MediaSource.MediaPeriodId mediaPeriodId = loadingPeriod == null ? this.playbackInfo.periodId : loadingPeriod.info.f7id;
