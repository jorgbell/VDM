...
final class MediaPeriodInfo {
    ...
    /* renamed from: id */
    public final MediaSource.MediaPeriodId f7id;
    ...
    public MediaPeriodInfo copyWithStartPositionUs(long j) {
        ...
        return new MediaPeriodInfo(this.f7id, j, this.contentPositionUs, this.endPositionUs, this.durationUs, this.isLastInTimelinePeriod, this.isFinal);
    }
    ...
    public MediaPeriodInfo copyWithContentPositionUs(long j) {
        ...
        return new MediaPeriodInfo(this.f7id, this.startPositionUs, j, this.endPositionUs, this.durationUs, this.isLastInTimelinePeriod, this.isFinal);
    }
    ...
    public int hashCode() {
        return ((((((((((((527 + this.f7id.hashCode()) * 31) + ((int) this.startPositionUs)) * 31) + ((int) this.contentPositionUs)) * 31) + ((int) this.endPositionUs)) * 31) + ((int) this.durationUs)) * 31) + (this.isLastInTimelinePeriod ? 1 : 0)) * 31) + (this.isFinal ? 1 : 0);
    }
}
