...
final class MediaPeriodQueue {
    ...
    public MediaPeriodHolder advancePlayingPeriod() {
        ...
        if (mediaPeriodHolder != null) {
            ...
            if (i == 0) {
                ...
                this.oldFrontPeriodWindowSequenceNumber = mediaPeriodHolder2.info.f7id.windowSequenceNumber;
            }
    ...
    public void clear(boolean z) {
        ...
        if (frontPeriod != null) {
            ...
            this.oldFrontPeriodWindowSequenceNumber = frontPeriod.info.f7id.windowSequenceNumber;
            frontPeriod.release();
        ...
        while (frontPeriod != null) {
            ...
            if (!areDurationsCompatible(mediaPeriodInfo2.durationUs, mediaPeriodInfo.durationUs)) {
                ...
                if (j4 == -9223372036854775807L) {
                    ...
                    j3 = frontPeriod.toRendererTime(j4);
                }
                boolean z = frontPeriod == this.reading && (j2 == Long.MIN_VALUE || j2 >= j3);
                if (removeAfter(frontPeriod) || z) {
                    return false;
                }
                return true;
            }
    ...
    public MediaPeriodInfo getUpdatedMediaPeriodInfo(MediaPeriodInfo mediaPeriodInfo) {
        ...
        this.timeline.getPeriodByUid(mediaPeriodInfo.f7id.periodUid, this.period);
    ...
    private long resolvePeriodIndexToWindowSequenceNumber(Object obj) {
        ...
        for (MediaPeriodHolder frontPeriod = getFrontPeriod(); frontPeriod != null; frontPeriod = frontPeriod.getNext()) {
            if (frontPeriod.uid.equals(obj)) {
                return frontPeriod.info.f7id.windowSequenceNumber;
            }
        }
        for (MediaPeriodHolder frontPeriod2 = getFrontPeriod(); frontPeriod2 != null; frontPeriod2 = frontPeriod2.getNext()) {
            ...
            if (indexOfPeriod2 != -1 && this.timeline.getPeriod(indexOfPeriod2, this.period).windowIndex == i) {
                return frontPeriod2.info.f7id.windowSequenceNumber;
            }
        }
    ...
    private boolean canKeepMediaPeriodHolder(MediaPeriodInfo mediaPeriodInfo, MediaPeriodInfo mediaPeriodInfo2) {
        return mediaPeriodInfo.startPositionUs == mediaPeriodInfo2.startPositionUs && mediaPeriodInfo.f7id.equals(mediaPeriodInfo2.f7id);
    }
    ...
    private MediaPeriodInfo getFollowingMediaPeriodInfo(MediaPeriodHolder mediaPeriodHolder, long j) {
        ...
        if (mediaPeriodInfo.isLastInTimelinePeriod) {
            int indexOfPeriod = this.timeline.getIndexOfPeriod(mediaPeriodInfo.f7id.periodUid);
            ...
            long j6 = mediaPeriodInfo.f7id.windowSequenceNumber;
            if (this.timeline.getWindow(i, this.window).firstPeriodIndex == nextPeriodIndex) {
                ...
                if (next == null || !next.uid.equals(obj3)) {
                    ...
                    j4 = next.info.f7id.windowSequenceNumber;
                }
                j5 = longValue;
                j3 = j4;
                obj = obj3;
