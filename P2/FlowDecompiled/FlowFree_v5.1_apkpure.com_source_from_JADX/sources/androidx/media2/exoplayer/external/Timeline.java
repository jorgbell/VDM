...
public abstract class Timeline {
    ...
    public static final class Window {
        ...
        public long getDefaultPositionMs() {
            return C0200C.usToMs(this.defaultPositionUs);
        }
        ...
        public long getDurationMs() {
            return C0200C.usToMs(this.durationUs);
        }
    ...
    public static final class Period {
        ...
        public long getPositionInWindowMs() {
            return C0200C.usToMs(this.positionInWindowUs);
        }
    ...
    public final Pair<Object, Long> getPeriodPosition(Window window, Period period, int i, long j) {
        Pair<Object, Long> periodPosition = getPeriodPosition(window, period, i, j, 0);
