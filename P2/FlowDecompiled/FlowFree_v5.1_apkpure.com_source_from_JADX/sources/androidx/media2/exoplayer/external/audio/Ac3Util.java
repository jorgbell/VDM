...
public final class Ac3Util {
    ...
    public static Format parseAc3AnnexFFormat(ParsableByteArray parsableByteArray, String str, String str2, DrmInitData drmInitData) {
        ...
        return Format.createAudioSampleFormat(str, "audio/ac3", (String) null, -1, -1, i2, i, (List<byte[]>) null, drmInitData, 0, str2);
    }
    ...
    public static Format parseEAc3AnnexFFormat(ParsableByteArray parsableByteArray, String str, String str2, DrmInitData drmInitData) {
        ...
        return Format.createAudioSampleFormat(str, (parsableByteArray.bytesLeft() <= 0 || (parsableByteArray.readUnsignedByte() & 1) == 0) ? "audio/eac3" : "audio/eac3-joc", (String) null, -1, -1, i2, i, (List<byte[]>) null, drmInitData, 0, str2);
    }
    ...
    public static SyncFrameInfo parseAc3SyncframeInfo(ParsableBitArray parsableBitArray) {
        ...
        if (z) {
            ...
            str = (parsableBitArray.readBit() && parsableBitArray2.readBits(6) == 1 && parsableBitArray2.readBits(8) == 1) ? "audio/eac3-joc" : "audio/eac3";
            i5 = i10;
            i2 = readBits2;
            i3 = i6;
            i = i11;
    ...
    public static int parseTrueHdSyncframeAudioSampleCount(byte[] bArr) {
        ...
        if ((bArr[7] & Constants.UNKNOWN) == 187) {
            z = true;
        }
    ...
    public static int parseTrueHdSyncframeAudioSampleCount(ByteBuffer byteBuffer, int i) {
        return 40 << ((byteBuffer.get((byteBuffer.position() + i) + ((byteBuffer.get((byteBuffer.position() + i) + 7) & Constants.UNKNOWN) == 187 ? 9 : 8)) >> 4) & 7);
    }
