...
public final class Ac4Util {
    private static final int[] SAMPLE_COUNT = {AdError.CACHE_ERROR_CODE, AdError.SERVER_ERROR_CODE, 1920, 1601, 1600, AdError.NO_FILL_ERROR_CODE, 1000, 960, 800, 800, 480, 400, 400, 2048};
    ...
    public static int parseAc4SyncframeSize(byte[] bArr, int i) {
        ...
        byte b = ((bArr[2] & Constants.UNKNOWN) << 8) | (bArr[3] & Constants.UNKNOWN);
        if (b == 65535) {
            b = ((bArr[4] & Constants.UNKNOWN) << 16) | ((bArr[5] & Constants.UNKNOWN) << 8) | (bArr[6] & Constants.UNKNOWN);
        } else {
            i2 = 4;
        }
        if (i == 44097) {
