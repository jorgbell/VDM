...
public final class AudioFocusManager {
    ...
    private int requestAudioFocusDefault() {
        ...
        return audioManager2.requestAudioFocus(audioFocusListener, Util.getStreamTypeForAudioUsage(audioAttributes2.usage), this.focusGain);
    }
    ...
    private int requestAudioFocusV26() {
        ...
        if (audioFocusRequest2 == null || this.rebuildAudioFocusRequest) {
            ...
            AudioAttributes audioAttributes2 = this.audioAttributes;
            Assertions.checkNotNull(audioAttributes2);
            this.audioFocusRequest = builder.setAudioAttributes(audioAttributes2.getAudioAttributesV21()).setWillPauseWhenDucked(willPauseWhenDucked).setOnAudioFocusChangeListener(this.focusListener).build();
    ...
    private static int convertAudioAttributesToFocusGain(AudioAttributes audioAttributes2) {
        ...
        switch (i) {
            case 0:
                Log.m16w("AudioFocusManager", "Specify a proper usage in the audio attributes for audio focus handling. Using AUDIOFOCUS_GAIN by default.");
                return 1;
            case 1:
            case 14:
                return 1;
            ...
            default:
                ...
                sb.append(i);
                Log.m16w("AudioFocusManager", sb.toString());
                return 0;
        }
        return 3;
    }
