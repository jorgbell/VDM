...
public final class DefaultAudioSink implements AudioSink {
    ...
    private void initialize() throws AudioSink.InitializationException {
        ...
        Assertions.checkNotNull(configuration2);
        ...
        audioTrackPositionTracker2.setAudioTrack(audioTrack3, configuration3.outputEncoding, configuration3.outputPcmFrameSize, configuration3.bufferSize);
        setVolumeInternal();
    ...
    public boolean handleBuffer(ByteBuffer byteBuffer, long j) throws AudioSink.InitializationException, AudioSink.WriteException {
        ...
        if (this.inputBuffer != null) {
            ...
            Configuration configuration2 = this.configuration;
            if (!configuration2.isInputPcm && this.framesPerEncodedSample == 0) {
        ...
        if (!this.inputBuffer.hasRemaining()) {
            ...
            Log.m16w(str, "Resetting stalled audio track");
            flush();
            return true;
        }
    }
    ...
    private final class PositionTrackerListener implements AudioTrackPositionTracker.Listener {
        ...
        public void onInvalidLatency(long j) {
            ...
            sb.append(j);
            Log.m16w("AudioTrack", sb.toString());
        }
