...
class DefaultDrmSession<T extends ExoMediaCrypto> implements DrmSession<T> {
    ...
    public void release() {
        ...
        if (i == 0) {
            ...
            DefaultDrmSession<T>.PostRequestHandler postRequestHandler2 = this.postRequestHandler;
            Util.castNonNull(postRequestHandler2);
            postRequestHandler2.removeCallbacksAndMessages((Object) null);
    ...
    public void provision() {
        ...
        postRequestHandler2.post(0, provisionRequest, true);
    }
        ...
        if (i == 0 || i == 1) {
            if (this.offlineLicenseKeySetId == null) {
                ...
                if (this.mode == 0 && licenseDurationRemainingSec <= 60) {
                    ...
                    Log.m12d("DefaultDrmSession", sb.toString());
    ...
    private boolean restoreKeys() {
        try {
            ...
            Log.m14e("DefaultDrmSession", "Error trying to restore Widevine keys.", e);
            onError(e);
            return false;
        }
    }
    ...
    private long getLicenseDurationRemainingSec() {
        if (!C0200C.WIDEVINE_UUID.equals(this.uuid)) {
            return Long.MAX_VALUE;
        }
        Pair<Long, Long> licenseDurationRemainingSec = WidevineUtil.getLicenseDurationRemainingSec(this);
        Assertions.checkNotNull(licenseDurationRemainingSec);
        Pair pair = licenseDurationRemainingSec;
    ...
    private void postKeyRequest(byte[] bArr, int i, boolean z) {
        try {
            ...
            postRequestHandler2.post(1, keyRequest, z);
        } catch (Exception e) {
            onKeysError(e);
        }
    }
        ...
        public void handleMessage(Message message) {
            ...
            try {
                ...
                if (i == 0) {
                    ...
                    e = defaultDrmSession2.callback.executeKeyRequest(defaultDrmSession2.uuid, (ExoMediaDrm.KeyRequest) obj);
                } else {
