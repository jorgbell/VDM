...
public final class DrmInitData implements Comparator<SchemeData>, Parcelable {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v2, resolved type: androidx.media2.exoplayer.external.drm.DrmInitData$SchemeData[]} */
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private DrmInitData(java.lang.String r1, boolean r2, androidx.media2.exoplayer.external.drm.DrmInitData.SchemeData... r3) {
        /*
            r0 = this;
            r0.<init>()
            r0.schemeType = r1
            ...
            r3 = r1
            androidx.media2.exoplayer.external.drm.DrmInitData$SchemeData[] r3 = (androidx.media2.exoplayer.external.drm.DrmInitData.SchemeData[]) r3
        L_0x000e:
            r0.schemeDatas = r3
            int r1 = r3.length
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.media2.exoplayer.external.drm.DrmInitData.<init>(java.lang.String, boolean, androidx.media2.exoplayer.external.drm.DrmInitData$SchemeData[]):void");
    }

    DrmInitData(Parcel parcel) {
        this.schemeType = parcel.readString();
        SchemeData[] schemeDataArr = (SchemeData[]) parcel.createTypedArray(SchemeData.CREATOR);
        Util.castNonNull(schemeDataArr);
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public androidx.media2.exoplayer.external.drm.DrmInitData merge(androidx.media2.exoplayer.external.drm.DrmInitData r3) {
        /*
            r2 = this;
        ...
        L_0x001c:
            androidx.media2.exoplayer.external.drm.DrmInitData$SchemeData[] r1 = r2.schemeDatas
            androidx.media2.exoplayer.external.drm.DrmInitData$SchemeData[] r3 = r3.schemeDatas
            java.lang.Object[] r3 = androidx.media2.exoplayer.external.util.Util.nullSafeArrayConcatenation(r1, r3)
            androidx.media2.exoplayer.external.drm.DrmInitData$SchemeData[] r3 = (androidx.media2.exoplayer.external.drm.DrmInitData.SchemeData[]) r3
            androidx.media2.exoplayer.external.drm.DrmInitData r1 = new androidx.media2.exoplayer.external.drm.DrmInitData
            r1.<init>((java.lang.String) r0, (androidx.media2.exoplayer.external.drm.DrmInitData.SchemeData[]) r3)
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.media2.exoplayer.external.drm.DrmInitData.merge(androidx.media2.exoplayer.external.drm.DrmInitData):androidx.media2.exoplayer.external.drm.DrmInitData");
    }
    ...
    public static final class SchemeData implements Parcelable {
        ...
        public boolean matches(UUID uuid2) {
            return C0200C.UUID_NIL.equals(this.uuid) || uuid2.equals(this.uuid);
        }
