...
import androidx.media2.exoplayer.external.extractor.p005ts.Ac3Extractor;
import androidx.media2.exoplayer.external.extractor.p005ts.Ac4Extractor;
import androidx.media2.exoplayer.external.extractor.p005ts.AdtsExtractor;
import androidx.media2.exoplayer.external.extractor.p005ts.PsExtractor;
import androidx.media2.exoplayer.external.extractor.p005ts.TsExtractor;
...
public final class DefaultExtractorsFactory implements ExtractorsFactory {
    ...
    public synchronized Extractor[] createExtractors() {
        ...
        if (constructor != null) {
            try {
                extractorArr[13] = (Extractor) constructor.newInstance(new Object[0]);
            } catch (Exception e) {
