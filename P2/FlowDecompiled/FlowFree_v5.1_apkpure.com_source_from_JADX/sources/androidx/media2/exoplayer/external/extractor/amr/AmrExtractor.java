...
public final class AmrExtractor implements Extractor {
    ...
    static {
        ExtractorsFactory extractorsFactory = AmrExtractor$$Lambda$0.$instance;
    ...
    private void maybeOutputFormat() {
        if (!this.hasOutputFormat) {
            ...
            this.trackOutput.format(Format.createAudioSampleFormat((String) null, z ? "audio/amr-wb" : "audio/3gpp", (String) null, -1, MAX_FRAME_SIZE_BYTES, 1, z ? VastVideoViewController.MAX_VIDEO_DURATION_FOR_CLOSE_BUTTON : 8000, -1, (List<byte[]>) null, (DrmInitData) null, 0, (String) null));
        }
    }
