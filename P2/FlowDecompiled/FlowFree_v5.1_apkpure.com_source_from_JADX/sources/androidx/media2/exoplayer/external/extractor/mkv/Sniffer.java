...
final class Sniffer {
    ...
    public boolean sniff(ExtractorInput extractorInput) throws IOException, InterruptedException {
        ...
        this.peekLength = 4;
        for (long readUnsignedInt = this.scratch.readUnsignedInt(); readUnsignedInt != 440786851; readUnsignedInt = ((readUnsignedInt << 8) & -256) | ((long) (this.scratch.data[0] & Constants.UNKNOWN))) {
    ...
    private long readUint(ExtractorInput extractorInput) throws IOException, InterruptedException {
        ...
        byte b = this.scratch.data[0] & Constants.UNKNOWN;
        if (b == 0) {
        ...
        while (i < i3) {
            i++;
            i4 = (this.scratch.data[i] & Constants.UNKNOWN) + (i4 << 8);
        }
