...
public final class Mp3Extractor implements Extractor {
    ...
    static {
        ExtractorsFactory extractorsFactory = Mp3Extractor$$Lambda$0.$instance;
    }
    ...
    public int read(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException, InterruptedException {
        ...
        if (this.seeker == null) {
            ...
            trackOutput2.format(Format.createAudioSampleFormat((String) null, str, (String) null, -1, 4096, i, i2, -1, gaplessInfoHolder2.encoderDelay, gaplessInfoHolder2.encoderPadding, (List<byte[]>) null, (DrmInitData) null, 0, (String) null, (this.flags & 2) != 0 ? null : this.metadata));
        }
    ...
    private int readSample(ExtractorInput extractorInput) throws IOException, InterruptedException {
        ...
        MpegAudioHeader mpegAudioHeader = this.synchronizedHeader;
        this.trackOutput.sampleMetadata(j + ((this.samplesRead * 1000000) / ((long) mpegAudioHeader.sampleRate)), 1, mpegAudioHeader.frameSize, 0, (TrackOutput.CryptoData) null);
    ...
    /* JADX WARNING: Removed duplicated region for block: B:11:0x003d A[ADDED_TO_REGION] */
    /* JADX WARNING: Removed duplicated region for block: B:25:0x00a7 A[ADDED_TO_REGION] */
