...
public final class Mp4Extractor implements Extractor, SeekMap {
    ...
    static {
        ExtractorsFactory extractorsFactory = Mp4Extractor$$Lambda$0.$instance;
    }
    ...
    private void processMoovAtom(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        while (i < size) {
            ...
            if (track.type == 2 && j > 0) {
                ...
                if (i4 > 1) {
                    copyWithMaxInputSize = copyWithMaxInputSize.copyWithFrameRate(((float) i4) / (((float) j) / 1000000.0f));
                }
            }
