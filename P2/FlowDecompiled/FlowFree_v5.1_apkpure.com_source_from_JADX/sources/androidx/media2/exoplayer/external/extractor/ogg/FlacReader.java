...
final class FlacReader extends StreamReader {
    ...
    public boolean readHeaders(ParsableByteArray parsableByteArray, long j, StreamReader.SetupData setupData) throws IOException, InterruptedException {
        ...
        if (this.streamInfo == null) {
            ...
            setupData.format = Format.createAudioSampleFormat((String) null, "audio/flac", (String) null, -1, bitRate, flacStreamInfo.channels, flacStreamInfo.sampleRate, singletonList, (DrmInitData) null, 0, (String) null);
            return true;
    ...
    private int getFlacFrameBlockSize(ParsableByteArray parsableByteArray) {
        int i;
        int i2;
        int i3 = (parsableByteArray.data[2] & Constants.UNKNOWN) >> 4;
        switch (i3) {
            case 1:
                return 192;
            case 2:
