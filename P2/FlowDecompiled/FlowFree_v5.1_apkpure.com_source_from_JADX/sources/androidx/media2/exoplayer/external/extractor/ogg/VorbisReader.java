...
final class VorbisReader extends StreamReader {
    ...
    public boolean readHeaders(ParsableByteArray parsableByteArray, long j, StreamReader.SetupData setupData) throws IOException, InterruptedException {
        ...
        setupData.format = Format.createAudioSampleFormat((String) null, "audio/vorbis", (String) null, vorbisIdHeader2.bitrateNominal, -1, vorbisIdHeader2.channels, (int) vorbisIdHeader2.sampleRate, arrayList, (DrmInitData) null, 0, (String) null);
        return true;
    }
