...
public final class AdtsExtractor implements Extractor {
    ...
    static {
        ExtractorsFactory extractorsFactory = AdtsExtractor$$Lambda$0.$instance;
    }
    ...
    public boolean sniff(androidx.media2.exoplayer.external.extractor.ExtractorInput r9) throws java.io.IOException, java.lang.InterruptedException {
        ...
        L_0x0008:
            ...
            boolean r5 = androidx.media2.exoplayer.external.extractor.p005ts.AdtsReader.isAdtsSyncWord(r5)
        ...
        L_0x0055:
            ...
            goto L_0x0008
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.media2.exoplayer.external.extractor.p005ts.AdtsExtractor.sniff(androidx.media2.exoplayer.external.extractor.ExtractorInput):boolean");
    }
    ...
    private void maybeOutputSeekMap(long j, boolean z, boolean z2) {
        if (!this.hasOutputSeekMap) {
            ...
            if (!z3 || this.reader.getSampleDurationUs() != -9223372036854775807L || z2) {
                ...
                Assertions.checkNotNull(extractorOutput2);
                ExtractorOutput extractorOutput3 = extractorOutput2;
                if (!z3 || this.reader.getSampleDurationUs() == -9223372036854775807L) {
                    extractorOutput3.seekMap(new SeekMap.Unseekable(-9223372036854775807L));
                } else {
                    extractorOutput3.seekMap(getConstantBitrateSeekMap(j));
                }
