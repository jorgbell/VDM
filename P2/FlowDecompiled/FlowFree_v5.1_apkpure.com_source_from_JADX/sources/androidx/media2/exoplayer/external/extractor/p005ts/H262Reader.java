...
public final class H262Reader implements ElementaryStreamReader {
    ...
    public void consume(ParsableByteArray parsableByteArray) {
        ...
        while (true) {
            ...
            byte b = parsableByteArray2.data[i2] & Constants.UNKNOWN;
            ...
            if (b == 0 || b == 179) {
                ...
                if (!z2 || this.sampleHasPicture) {
                    ...
                    if (j == -9223372036854775807L) {
                        j = z2 ? this.sampleTimeUs + this.frameDurationUs : 0;
                    }
                    this.sampleTimeUs = j;
    ...
    private static android.util.Pair<androidx.media2.exoplayer.external.Format, java.lang.Long> parseCsdBuffer(androidx.media2.exoplayer.external.extractor.p005ts.H262Reader.CsdBuffer r20, java.lang.String r21) {
        /*
            r0 = r20
            byte[] r1 = r0.data
            int r2 = r0.length
        ...
        L_0x0098:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.media2.exoplayer.external.extractor.p005ts.H262Reader.parseCsdBuffer(androidx.media2.exoplayer.external.extractor.ts.H262Reader$CsdBuffer, java.lang.String):android.util.Pair");
    }
