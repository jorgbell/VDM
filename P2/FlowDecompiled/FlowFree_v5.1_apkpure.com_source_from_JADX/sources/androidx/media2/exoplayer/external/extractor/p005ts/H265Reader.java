        ...
        if (parsableNalUnitBitArray.readBit() && parsableNalUnitBitArray.readBit()) {
            ...
            if (readBits2 == 255) {
                ...
                if (readBits2 < fArr.length) {
                    ...
                    sb.append(readBits2);
                    Log.m16w("H265Reader", sb.toString());
                }
            }
            return Format.createVideoSampleFormat(str, "video/hevc", (String) null, -1, -1, i4, i5, -1.0f, Collections.singletonList(bArr), -1, f, (DrmInitData) null);
        }
        f = 1.0f;
        return Format.createVideoSampleFormat(str, "video/hevc", (String) null, -1, -1, i4, i5, -1.0f, Collections.singletonList(bArr), -1, f, (DrmInitData) null);
    }
