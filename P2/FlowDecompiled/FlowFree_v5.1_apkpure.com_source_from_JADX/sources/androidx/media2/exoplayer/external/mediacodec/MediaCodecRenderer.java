...
public abstract class MediaCodecRenderer extends BaseRenderer {
            ...
            if (drmSession != null) {
                if (this.mediaCrypto == null) {
                    ...
                    if (mediaCrypto2 != null) {
                        try {
                            MediaCrypto mediaCrypto3 = new MediaCrypto(mediaCrypto2.uuid, mediaCrypto2.sessionId);
                            this.mediaCrypto = mediaCrypto3;
                            this.mediaCryptoRequiresSecureDecoder = !mediaCrypto2.forceAllowInsecureDecoderComponents && mediaCrypto3.requiresSecureDecoderComponent(str);
            ...
            while (this.codec == null) {
                ...
                if (shouldInitCodec(peekFirst)) {
                    try {
                        ...
                        sb.append(valueOf);
                        Log.m17w("MediaCodecRenderer", sb.toString(), e2);
    ...
    private List<MediaCodecInfo> getAvailableCodecInfos(boolean z) throws MediaCodecUtil.DecoderQueryException {
        ...
        if (decoderInfos.isEmpty() && z) {
            ...
            if (!decoderInfos.isEmpty()) {
                ...
                sb.append(valueOf);
                sb.append(".");
                Log.m16w("MediaCodecRenderer", sb.toString());
            }
        }
        return decoderInfos;
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:60:0x00c0, code lost:
        if (r6.height == r2.height) goto L_0x00c4;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void onInputFormatChanged(androidx.media2.exoplayer.external.FormatHolder r6) throws androidx.media2.exoplayer.external.ExoPlaybackException {
        /*
            r5 = this;
            androidx.media2.exoplayer.external.Format r0 = r5.inputFormat
            androidx.media2.exoplayer.external.Format r6 = r6.format
            r5.inputFormat = r6
            r1 = 1
            r5.waitingForFirstSampleInFormat = r1
            androidx.media2.exoplayer.external.drm.DrmInitData r2 = r6.drmInitData
            r3 = 0
            if (r0 != 0) goto L_0x0010
            r0 = r3
            goto L_0x0012
        L_0x0010:
            androidx.media2.exoplayer.external.drm.DrmInitData r0 = r0.drmInitData
        L_0x0012:
            boolean r0 = androidx.media2.exoplayer.external.util.Util.areEqual(r2, r0)
            r0 = r0 ^ r1
            if (r0 == 0) goto L_0x004f
            androidx.media2.exoplayer.external.drm.DrmInitData r0 = r6.drmInitData
            if (r0 == 0) goto L_0x004c
            androidx.media2.exoplayer.external.drm.DrmSessionManager<androidx.media2.exoplayer.external.drm.FrameworkMediaCrypto> r0 = r5.drmSessionManager
            if (r0 == 0) goto L_0x003c
            android.os.Looper r2 = android.os.Looper.myLooper()
            androidx.media2.exoplayer.external.drm.DrmInitData r3 = r6.drmInitData
            androidx.media2.exoplayer.external.drm.DrmSession r0 = r0.acquireSession(r2, r3)
            androidx.media2.exoplayer.external.drm.DrmSession<androidx.media2.exoplayer.external.drm.FrameworkMediaCrypto> r2 = r5.sourceDrmSession
            if (r0 == r2) goto L_0x0033
            androidx.media2.exoplayer.external.drm.DrmSession<androidx.media2.exoplayer.external.drm.FrameworkMediaCrypto> r2 = r5.codecDrmSession
            if (r0 != r2) goto L_0x0038
        L_0x0033:
            androidx.media2.exoplayer.external.drm.DrmSessionManager<androidx.media2.exoplayer.external.drm.FrameworkMediaCrypto> r2 = r5.drmSessionManager
            r2.releaseSession(r0)
        L_0x0038:
            r5.setSourceDrmSession(r0)
            goto L_0x004f
        L_0x003c:
            ...
            r6.<init>(r0)
            int r0 = r5.getIndex()
            androidx.media2.exoplayer.external.ExoPlaybackException r6 = androidx.media2.exoplayer.external.ExoPlaybackException.createForRenderer(r6, r0)
            throw r6
        L_0x004c:
            r5.setSourceDrmSession(r3)
        L_0x004f:
        ...
        L_0x0057:
            ...
            androidx.media2.exoplayer.external.drm.DrmSession<androidx.media2.exoplayer.external.drm.FrameworkMediaCrypto> r3 = r5.codecDrmSession
        ...
        L_0x0065:
            ...
            androidx.media2.exoplayer.external.mediacodec.MediaCodecInfo r3 = r5.codecInfo
            boolean r3 = r3.secure
            if (r3 == 0) goto L_0x0077
        L_0x006d:
            int r3 = androidx.media2.exoplayer.external.util.Util.SDK_INT
            r4 = 23
            if (r3 >= r4) goto L_0x007b
            androidx.media2.exoplayer.external.drm.DrmSession<androidx.media2.exoplayer.external.drm.FrameworkMediaCrypto> r3 = r5.codecDrmSession
            if (r2 == r3) goto L_0x007b
        L_0x0077:
            r5.drainAndReinitializeCodec()
            return
        L_0x007b:
            androidx.media2.exoplayer.external.mediacodec.MediaCodecInfo r2 = r5.codecInfo
            androidx.media2.exoplayer.external.Format r3 = r5.codecFormat
            int r0 = r5.canKeepCodec(r0, r2, r3, r6)
            ...
            androidx.media2.exoplayer.external.drm.DrmSession<androidx.media2.exoplayer.external.drm.FrameworkMediaCrypto> r6 = r5.sourceDrmSession
            androidx.media2.exoplayer.external.drm.DrmSession<androidx.media2.exoplayer.external.drm.FrameworkMediaCrypto> r0 = r5.codecDrmSession
            if (r6 == r0) goto L_0x00eb
            r5.drainAndUpdateCodecDrmSession()
            goto L_0x00eb
        L_0x009c:
            java.lang.IllegalStateException r6 = new java.lang.IllegalStateException
            r6.<init>()
            throw r6
        L_0x00a2:
            boolean r0 = r5.codecNeedsReconfigureWorkaround
            if (r0 == 0) goto L_0x00aa
            r5.drainAndReinitializeCodec()
            goto L_0x00eb
        L_0x00aa:
            r5.codecReconfigured = r1
            r5.codecReconfigurationState = r1
            int r0 = r5.codecAdaptationWorkaroundMode
            if (r0 == r2) goto L_0x00c4
            if (r0 != r1) goto L_0x00c3
            int r0 = r6.width
            androidx.media2.exoplayer.external.Format r2 = r5.codecFormat
            int r3 = r2.width
        ...
        L_0x00c3:
            r1 = 0
        L_0x00c4:
            r5.codecNeedsAdaptationWorkaroundBuffer = r1
            r5.codecFormat = r6
            r5.updateCodecOperatingRate()
            androidx.media2.exoplayer.external.drm.DrmSession<androidx.media2.exoplayer.external.drm.FrameworkMediaCrypto> r6 = r5.sourceDrmSession
            androidx.media2.exoplayer.external.drm.DrmSession<androidx.media2.exoplayer.external.drm.FrameworkMediaCrypto> r0 = r5.codecDrmSession
    ...
    private boolean drainOutputBuffer(long j, long j2) throws ExoPlaybackException {
        ...
        if (!this.codecNeedsEosOutputExceptionWorkaround || !this.codecReceivedEos) {
            ...
            z = processOutputBuffer(j, j2, mediaCodec, byteBuffer2, i2, bufferInfo3.flags, bufferInfo3.presentationTimeUs, this.shouldSkipOutputBuffer, this.outputFormat);
        } else {
            try {
                ...
                z = processOutputBuffer(j, j2, mediaCodec2, byteBuffer3, i3, bufferInfo4.flags, bufferInfo4.presentationTimeUs, this.shouldSkipOutputBuffer, this.outputFormat);
    ...
    private void updateDrmSessionOrReinitializeCodecV23() throws ExoPlaybackException {
        ...
        if (mediaCrypto2 == null) {
            reinitializeCodec();
        } else if (C0200C.PLAYREADY_UUID.equals(mediaCrypto2.uuid)) {
            reinitializeCodec();
