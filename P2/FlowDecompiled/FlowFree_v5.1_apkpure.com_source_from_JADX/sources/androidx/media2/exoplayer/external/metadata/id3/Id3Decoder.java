...
public final class Id3Decoder implements MetadataDecoder {
    ...
    static final /* synthetic */ boolean lambda$static$0$Id3Decoder(int i, int i2, int i3, int i4, int i5) {
        return false;
    }

    static {
        FramePredicate framePredicate2 = Id3Decoder$$Lambda$0.$instance;
    }
    ...
    public Metadata decode(byte[] bArr, int i) {
        ...
        if (!validateFrames(parsableByteArray, decodeHeader.majorVersion, i2, false)) {
            if (decodeHeader.majorVersion != 4 || !validateFrames(parsableByteArray, 4, i2, true)) {
                ...
                Log.m16w("Id3Decoder", sb.toString());
                return null;
            }
            z = true;
        }
    ...
    private static Id3Header decodeHeader(ParsableByteArray parsableByteArray) {
        if (parsableByteArray.bytesLeft() < 10) {
            Log.m16w("Id3Decoder", "Data too short to be an ID3 tag");
            return null;
        }
        ...
        if (readUnsignedByte == 2) {
            if ((readUnsignedByte2 & 64) != 0) {
                Log.m16w("Id3Decoder", "Skipped ID3 tag with majorVersion=2 and undefined compression scheme");
                return null;
            }
            ...
            Log.m16w("Id3Decoder", sb2.toString());
            return null;
        }
    ...
    private static boolean validateFrames(androidx.media2.exoplayer.external.util.ParsableByteArray r18, int r19, int r20, boolean r21) {
        /*
            r1 = r18
            r0 = r19
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static androidx.media2.exoplayer.external.metadata.id3.Id3Frame decodeFrame(int r19, androidx.media2.exoplayer.external.util.ParsableByteArray r20, boolean r21, int r22, androidx.media2.exoplayer.external.metadata.id3.Id3Decoder.FramePredicate r23) {
        /*
            r0 = r19
            r7 = r20
        ...
        L_0x0067:
            ...
            androidx.media2.exoplayer.external.util.Log.m16w(r4, r0)
            int r0 = r20.limit()
            r7.setPosition(r0)
            return r16
        L_0x0082:
        ...
        L_0x011c:
            androidx.media2.exoplayer.external.metadata.id3.TextInformationFrame r1 = decodeTxxxFrame(r7, r15)     // Catch:{ UnsupportedEncodingException -> 0x0222 }
            goto L_0x01f2
        L_0x0122:
            if (r8 != r1) goto L_0x0131
            java.lang.String r1 = getFrameId(r0, r8, r9, r10, r13)     // Catch:{ UnsupportedEncodingException -> 0x0222 }
            androidx.media2.exoplayer.external.metadata.id3.TextInformationFrame r1 = decodeTextInformationFrame(r7, r15, r1)     // Catch:{ UnsupportedEncodingException -> 0x0222 }
            goto L_0x01f2
        L_0x012e:
            r0 = move-exception
            goto L_0x022b
        ...
        L_0x013d:
            androidx.media2.exoplayer.external.metadata.id3.UrlLinkFrame r1 = decodeWxxxFrame(r7, r15)     // Catch:{ UnsupportedEncodingException -> 0x0222 }
            goto L_0x01f2
        L_0x0143:
            if (r8 != r4) goto L_0x014f
            java.lang.String r1 = getFrameId(r0, r8, r9, r10, r13)     // Catch:{ UnsupportedEncodingException -> 0x0222 }
            androidx.media2.exoplayer.external.metadata.id3.UrlLinkFrame r1 = decodeUrlLinkFrame(r7, r15, r1)     // Catch:{ UnsupportedEncodingException -> 0x0222 }
            goto L_0x01f2
        L_0x014f:
            r3 = 73
            r4 = 80
            ...
            androidx.media2.exoplayer.external.metadata.id3.PrivFrame r1 = decodePrivFrame(r7, r15)     // Catch:{ UnsupportedEncodingException -> 0x0222 }
            goto L_0x01f2
        L_0x0165:
            r5 = 71
            r6 = 79
        ...
        L_0x0177:
            androidx.media2.exoplayer.external.metadata.id3.GeobFrame r1 = decodeGeobFrame(r7, r15)     // Catch:{ UnsupportedEncodingException -> 0x0222 }
            goto L_0x01f2
        L_0x017d:
            r5 = 65
            r11 = 67
        ...
        L_0x0192:
            androidx.media2.exoplayer.external.metadata.id3.ApicFrame r1 = decodeApicFrame(r7, r15, r0)     // Catch:{ UnsupportedEncodingException -> 0x0222 }
            goto L_0x01f2
        L_0x0198:
            r3 = 77
        ...
        L_0x01a4:
            androidx.media2.exoplayer.external.metadata.id3.CommentFrame r1 = decodeCommentFrame(r7, r15)     // Catch:{ UnsupportedEncodingException -> 0x0222 }
            goto L_0x01f2
        L_0x01a9:
            ...
            r5 = r22
            r6 = r23
            androidx.media2.exoplayer.external.metadata.id3.ChapterFrame r1 = decodeChapterFrame(r1, r2, r3, r4, r5, r6)     // Catch:{ UnsupportedEncodingException -> 0x0222 }
            goto L_0x01f2
        L_0x01c3:
            ...
            r5 = r22
            r6 = r23
            androidx.media2.exoplayer.external.metadata.id3.ChapterTocFrame r1 = decodeChapterTOCFrame(r1, r2, r3, r4, r5, r6)     // Catch:{ UnsupportedEncodingException -> 0x0222 }
            goto L_0x01f2
        L_0x01db:
            ...
            androidx.media2.exoplayer.external.metadata.id3.MlltFrame r1 = decodeMlltFrame(r7, r15)     // Catch:{ UnsupportedEncodingException -> 0x0222 }
            goto L_0x01f2
        L_0x01ea:
            java.lang.String r1 = getFrameId(r0, r8, r9, r10, r13)     // Catch:{ UnsupportedEncodingException -> 0x0222 }
            androidx.media2.exoplayer.external.metadata.id3.BinaryFrame r1 = decodeBinaryFrame(r7, r15, r1)     // Catch:{ UnsupportedEncodingException -> 0x0222 }
        L_0x01f2:
            ...
            androidx.media2.exoplayer.external.util.Log.m16w(r12, r0)     // Catch:{ UnsupportedEncodingException -> 0x0222 }
        L_0x021e:
            r7.setPosition(r14)
            return r1
        L_0x0222:
            java.lang.String r0 = "Unsupported character encoding"
            androidx.media2.exoplayer.external.util.Log.m16w(r12, r0)     // Catch:{ all -> 0x012e }
            r7.setPosition(r14)
            return r16
        L_0x022b:
            r7.setPosition(r14)
        ...
        L_0x022f:
            ...
            androidx.media2.exoplayer.external.util.Log.m16w(r12, r0)
            r7.setPosition(r14)
            return r16
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.media2.exoplayer.external.metadata.id3.Id3Decoder.decodeFrame(int, androidx.media2.exoplayer.external.util.ParsableByteArray, boolean, int, androidx.media2.exoplayer.external.metadata.id3.Id3Decoder$FramePredicate):androidx.media2.exoplayer.external.metadata.id3.Id3Frame");
    }
        ...
        if (i2 == 2) {
            ...
            if (lowerInvariant.indexOf(47) == -1) {
                ...
                if (valueOf2.length() != 0) {
                    ...
                    lowerInvariant = new String("image/");
                }
            }
            str = lowerInvariant;
        }
        byte b = bArr[i3 + 1] & Constants.UNKNOWN;
        int i5 = i3 + 2;
        int indexOfEos = indexOfEos(bArr, i5, readUnsignedByte);
        return new ApicFrame(str, new String(bArr, i5, indexOfEos - i5, charsetName), b, copyOfRangeIfValid(bArr, indexOfEos + delimiterLength(readUnsignedByte), i4));
    }
