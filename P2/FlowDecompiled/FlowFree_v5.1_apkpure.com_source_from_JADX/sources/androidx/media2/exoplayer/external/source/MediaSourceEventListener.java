...
public interface MediaSourceEventListener {
    ...
    public static final class EventDispatcher {
        ...
        public void mediaPeriodCreated() {
            MediaSource.MediaPeriodId mediaPeriodId2 = this.mediaPeriodId;
            Assertions.checkNotNull(mediaPeriodId2);
            MediaSource.MediaPeriodId mediaPeriodId3 = mediaPeriodId2;
            Iterator<ListenerAndHandler> it = this.listenerAndHandlers.iterator();
            while (it.hasNext()) {
                ListenerAndHandler next = it.next();
                postOrRun(next.handler, new MediaSourceEventListener$EventDispatcher$$Lambda$0(this, next.listener, mediaPeriodId3));
            }
        }

        /* access modifiers changed from: package-private */
        /* renamed from: lambda$mediaPeriodCreated$0$MediaSourceEventListener$EventDispatcher */
        public final /* synthetic */ void mo5078xa9fff584(MediaSourceEventListener mediaSourceEventListener, MediaSource.MediaPeriodId mediaPeriodId2) {
        ...
        public void mediaPeriodReleased() {
            ...
            while (it.hasNext()) {
                ListenerAndHandler next = it.next();
                postOrRun(next.handler, new MediaSourceEventListener$EventDispatcher$$Lambda$1(this, next.listener, mediaPeriodId3));
            }
        }

        /* access modifiers changed from: package-private */
        /* renamed from: lambda$mediaPeriodReleased$1$MediaSourceEventListener$EventDispatcher */
        public final /* synthetic */ void mo5079xb596e71e(MediaSourceEventListener mediaSourceEventListener, MediaSource.MediaPeriodId mediaPeriodId2) {
        ...
        public void readingStarted() {
            ...
            while (it.hasNext()) {
                ListenerAndHandler next = it.next();
                postOrRun(next.handler, new MediaSourceEventListener$EventDispatcher$$Lambda$6(this, next.listener, mediaPeriodId3));
            }
        }
        ...
        public final /* synthetic */ void mo5073x9a021abe(MediaSourceEventListener mediaSourceEventListener, MediaLoadData mediaLoadData) {
