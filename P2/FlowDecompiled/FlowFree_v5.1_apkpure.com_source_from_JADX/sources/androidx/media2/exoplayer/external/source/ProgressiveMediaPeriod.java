...
final class ProgressiveMediaPeriod implements MediaPeriod, ExtractorOutput, Loader.Callback<ExtractingLoadable>, Loader.ReleaseCallback, SampleQueue.UpstreamFormatChangedListener {
    ...
    public final /* synthetic */ void lambda$new$0$ProgressiveMediaPeriod() {
        if (!this.released) {
            ...
            Assertions.checkNotNull(callback2);
        ...
        if (!this.released && !this.prepared && this.sampleQueuesBuilt && seekMap2 != null) {
            ...
            for (int i3 = 0; i3 < length3; i3++) {
                ...
                if (icyHeaders2 != null) {
                    ...
                    if (isAudio && upstreamFormat.bitrate == -1 && (i = icyHeaders2.bitrate) != -1) {
    ...
    private PreparedState getPreparedState() {
        PreparedState preparedState2 = this.preparedState;
        Assertions.checkNotNull(preparedState2);
        return preparedState2;
    }
    ...
    final class ExtractingLoadable implements Loader.Loadable, IcyDataSource.Listener {
        ...
        public void load() throws IOException, InterruptedException {
            ...
            while (i == 0 && !this.loadCanceled) {
                ...
                try {
                    ...
                    try {
                        Extractor selectExtractor = this.extractorHolder.selectExtractor(defaultExtractorInput2, this.extractorOutput, uri3);
        ...
        public void onIcyMetadata(ParsableByteArray parsableByteArray) {
            ...
            trackOutput2.sampleMetadata(max, 1, bytesLeft, 0, (TrackOutput.CryptoData) null);
    ...
    private static final class TrackId {
        ...
        public boolean equals(Object obj) {
            ...
            if (this.f17id == trackId.f17id && this.isIcyTrack == trackId.isIcyTrack) {
                return true;
            }
            return false;
        }
        ...
        public int hashCode() {
            return (this.f17id * 31) + (this.isIcyTrack ? 1 : 0);
        }
    }
}
