...
final class SampleMetadataQueue {
    ...
    public synchronized void commitSample(long r6, int r8, long r9, int r11, androidx.media2.exoplayer.external.extractor.TrackOutput.CryptoData r12) {
        /*
            r5 = this;
            monitor-enter(r5)
            boolean r0 = r5.upstreamKeyframeRequired     // Catch:{ all -> 0x00d7 }
            r1 = 0
            ...
            return
        L_0x000c:
            r5.upstreamKeyframeRequired = r1     // Catch:{ all -> 0x00d7 }
        L_0x000e:
            boolean r0 = r5.upstreamFormatRequired     // Catch:{ all -> 0x00d7 }
            r2 = 1
        ...
        L_0x0015:
            r0 = 0
        L_0x0016:
            androidx.media2.exoplayer.external.util.Assertions.checkState(r0)     // Catch:{ all -> 0x00d7 }
        ...
        L_0x0020:
            r0 = 0
        L_0x0021:
            r5.isLastSampleQueued = r0     // Catch:{ all -> 0x00d7 }
            long r3 = r5.largestQueuedTimestampUs     // Catch:{ all -> 0x00d7 }
            long r3 = java.lang.Math.max(r3, r6)     // Catch:{ all -> 0x00d7 }
            r5.largestQueuedTimestampUs = r3     // Catch:{ all -> 0x00d7 }
            int r0 = r5.length     // Catch:{ all -> 0x00d7 }
            int r0 = r5.getRelativeIndex(r0)     // Catch:{ all -> 0x00d7 }
            long[] r3 = r5.timesUs     // Catch:{ all -> 0x00d7 }
            r3[r0] = r6     // Catch:{ all -> 0x00d7 }
            long[] r6 = r5.offsets     // Catch:{ all -> 0x00d7 }
            r6[r0] = r9     // Catch:{ all -> 0x00d7 }
            int[] r7 = r5.sizes     // Catch:{ all -> 0x00d7 }
            r7[r0] = r11     // Catch:{ all -> 0x00d7 }
            int[] r7 = r5.flags     // Catch:{ all -> 0x00d7 }
            r7[r0] = r8     // Catch:{ all -> 0x00d7 }
            androidx.media2.exoplayer.external.extractor.TrackOutput$CryptoData[] r7 = r5.cryptoDatas     // Catch:{ all -> 0x00d7 }
            r7[r0] = r12     // Catch:{ all -> 0x00d7 }
            androidx.media2.exoplayer.external.Format[] r7 = r5.formats     // Catch:{ all -> 0x00d7 }
            androidx.media2.exoplayer.external.Format r8 = r5.upstreamFormat     // Catch:{ all -> 0x00d7 }
            r7[r0] = r8     // Catch:{ all -> 0x00d7 }
            int[] r7 = r5.sourceIds     // Catch:{ all -> 0x00d7 }
            int r8 = r5.upstreamSourceId     // Catch:{ all -> 0x00d7 }
            r7[r0] = r8     // Catch:{ all -> 0x00d7 }
            int r7 = r5.length     // Catch:{ all -> 0x00d7 }
            int r7 = r7 + r2
            r5.length = r7     // Catch:{ all -> 0x00d7 }
            int r8 = r5.capacity     // Catch:{ all -> 0x00d7 }
            ...
            androidx.media2.exoplayer.external.extractor.TrackOutput$CryptoData[] r2 = new androidx.media2.exoplayer.external.extractor.TrackOutput.CryptoData[r7]     // Catch:{ all -> 0x00d7 }
            androidx.media2.exoplayer.external.Format[] r3 = new androidx.media2.exoplayer.external.Format[r7]     // Catch:{ all -> 0x00d7 }
            int r4 = r5.relativeFirstIndex     // Catch:{ all -> 0x00d7 }
            int r8 = r8 - r4
            java.lang.System.arraycopy(r6, r4, r10, r1, r8)     // Catch:{ all -> 0x00d7 }
            long[] r6 = r5.timesUs     // Catch:{ all -> 0x00d7 }
            int r4 = r5.relativeFirstIndex     // Catch:{ all -> 0x00d7 }
            java.lang.System.arraycopy(r6, r4, r11, r1, r8)     // Catch:{ all -> 0x00d7 }
            int[] r6 = r5.flags     // Catch:{ all -> 0x00d7 }
            int r4 = r5.relativeFirstIndex     // Catch:{ all -> 0x00d7 }
            java.lang.System.arraycopy(r6, r4, r12, r1, r8)     // Catch:{ all -> 0x00d7 }
            int[] r6 = r5.sizes     // Catch:{ all -> 0x00d7 }
            int r4 = r5.relativeFirstIndex     // Catch:{ all -> 0x00d7 }
            java.lang.System.arraycopy(r6, r4, r0, r1, r8)     // Catch:{ all -> 0x00d7 }
            androidx.media2.exoplayer.external.extractor.TrackOutput$CryptoData[] r6 = r5.cryptoDatas     // Catch:{ all -> 0x00d7 }
            int r4 = r5.relativeFirstIndex     // Catch:{ all -> 0x00d7 }
            java.lang.System.arraycopy(r6, r4, r2, r1, r8)     // Catch:{ all -> 0x00d7 }
            androidx.media2.exoplayer.external.Format[] r6 = r5.formats     // Catch:{ all -> 0x00d7 }
            int r4 = r5.relativeFirstIndex     // Catch:{ all -> 0x00d7 }
            java.lang.System.arraycopy(r6, r4, r3, r1, r8)     // Catch:{ all -> 0x00d7 }
            int[] r6 = r5.sourceIds     // Catch:{ all -> 0x00d7 }
            int r4 = r5.relativeFirstIndex     // Catch:{ all -> 0x00d7 }
            java.lang.System.arraycopy(r6, r4, r9, r1, r8)     // Catch:{ all -> 0x00d7 }
            int r6 = r5.relativeFirstIndex     // Catch:{ all -> 0x00d7 }
            long[] r4 = r5.offsets     // Catch:{ all -> 0x00d7 }
            java.lang.System.arraycopy(r4, r1, r10, r8, r6)     // Catch:{ all -> 0x00d7 }
            long[] r4 = r5.timesUs     // Catch:{ all -> 0x00d7 }
            java.lang.System.arraycopy(r4, r1, r11, r8, r6)     // Catch:{ all -> 0x00d7 }
            int[] r4 = r5.flags     // Catch:{ all -> 0x00d7 }
            java.lang.System.arraycopy(r4, r1, r12, r8, r6)     // Catch:{ all -> 0x00d7 }
            int[] r4 = r5.sizes     // Catch:{ all -> 0x00d7 }
            java.lang.System.arraycopy(r4, r1, r0, r8, r6)     // Catch:{ all -> 0x00d7 }
            androidx.media2.exoplayer.external.extractor.TrackOutput$CryptoData[] r4 = r5.cryptoDatas     // Catch:{ all -> 0x00d7 }
            java.lang.System.arraycopy(r4, r1, r2, r8, r6)     // Catch:{ all -> 0x00d7 }
            androidx.media2.exoplayer.external.Format[] r4 = r5.formats     // Catch:{ all -> 0x00d7 }
            java.lang.System.arraycopy(r4, r1, r3, r8, r6)     // Catch:{ all -> 0x00d7 }
            int[] r4 = r5.sourceIds     // Catch:{ all -> 0x00d7 }
            java.lang.System.arraycopy(r4, r1, r9, r8, r6)     // Catch:{ all -> 0x00d7 }
            r5.offsets = r10     // Catch:{ all -> 0x00d7 }
            r5.timesUs = r11     // Catch:{ all -> 0x00d7 }
            r5.flags = r12     // Catch:{ all -> 0x00d7 }
            r5.sizes = r0     // Catch:{ all -> 0x00d7 }
            r5.cryptoDatas = r2     // Catch:{ all -> 0x00d7 }
            r5.formats = r3     // Catch:{ all -> 0x00d7 }
            r5.sourceIds = r9     // Catch:{ all -> 0x00d7 }
            r5.relativeFirstIndex = r1     // Catch:{ all -> 0x00d7 }
            int r6 = r5.capacity     // Catch:{ all -> 0x00d7 }
            r5.length = r6     // Catch:{ all -> 0x00d7 }
            r5.capacity = r7     // Catch:{ all -> 0x00d7 }
        L_0x00d5:
            monitor-exit(r5)
            return
        L_0x00d7:
