...
public final class HlsMediaSource extends BaseMediaSource implements HlsPlaylistTracker.PrimaryPlaylistListener {
    ...
    public void onPrimaryPlaylistRefreshed(HlsMediaPlaylist hlsMediaPlaylist) {
        ...
        long usToMs = hlsMediaPlaylist2.hasProgramDateTime ? C0200C.usToMs(hlsMediaPlaylist2.startTimeUs) : -9223372036854775807L;
        int i = hlsMediaPlaylist2.playlistType;
        long j3 = (i == 2 || i == 1) ? usToMs : -9223372036854775807L;
        ...
        if (this.playlistTracker.isLive()) {
            ...
            singlePeriodTimeline = new SinglePeriodTimeline(j3, usToMs, j7, j7, 0, j6, true, false, this.tag);
        }
