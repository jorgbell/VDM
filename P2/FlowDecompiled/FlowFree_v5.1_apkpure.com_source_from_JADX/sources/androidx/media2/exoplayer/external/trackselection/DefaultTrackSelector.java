...
public class DefaultTrackSelector extends MappingTrackSelector {
    ...
    private static int[] getAdaptiveAudioTracks(TrackGroup trackGroup, int[] iArr, boolean z, boolean z2) {
        ...
        for (int i4 = 0; i4 < trackGroup.length; i4++) {
            ...
            if (isSupportedAdaptiveAudioTrack(format2, i5, audioConfigurationTuple, z, z2)) {
                iArr2[i3] = i4;
                i3++;
            }
        }
    ...
    private static boolean isSupportedAdaptiveAudioTrack(Format format, int i, AudioConfigurationTuple audioConfigurationTuple, boolean z, boolean z2) {
        ...
        int i3;
        String str;
        if (!isSupported(i, false) || (i2 = format.channelCount) == -1 || i2 != audioConfigurationTuple.channelCount) {
            return false;
        }
        if (!z && ((str = format.sampleMimeType) == null || !TextUtils.equals(str, audioConfigurationTuple.mimeType))) {
            return false;
        }
        if (z2 || ((i3 = format.sampleRate) != -1 && i3 == audioConfigurationTuple.sampleRate)) {
            return true;
        }
        return false;
    }
        ...
        if (!(i == Integer.MAX_VALUE || i2 == Integer.MAX_VALUE)) {
            ...
            for (int i6 = 0; i6 < trackGroup.length; i6++) {
                ...
                if (i7 > 0 && (i3 = format.height) > 0) {
                    ...
                    int i10 = i8 * i9;
                    if (i8 >= ((int) (((float) maxVideoSizeInViewport.x) * 0.98f)) && i9 >= ((int) (((float) maxVideoSizeInViewport.y) * 0.98f)) && i10 < i5) {
                        i5 = i10;
                    }
                }
            }
    ...
    protected static final class AudioTrackScore implements Comparable<AudioTrackScore> {
        ...
        public AudioTrackScore(Format format, Parameters parameters2, int i) {
            ...
            this.bitrate = i4;
            if ((i4 != -1 && i4 > parameters2.maxAudioBitrate) || (i3 != -1 && i3 > parameters2.maxAudioChannelCount)) {
                z = false;
            }
            ...
            while (true) {
                ...
                int formatLanguageScore = DefaultTrackSelector.getFormatLanguageScore(format, systemLanguageCodes[i6]);
