...
public final class DefaultBandwidthMeter implements BandwidthMeter, TransferListener {
    ...
    public synchronized void onConnectivityAction() {
        ...
        L_0x0009:
            ...
            goto L_0x0013
        L_0x000f:
            int r0 = androidx.media2.exoplayer.external.util.Util.getNetworkType(r0)     // Catch:{ all -> 0x0058 }
        L_0x0013:
        ...
        L_0x0025:
            ...
            androidx.media2.exoplayer.external.util.Clock r0 = r10.clock     // Catch:{ all -> 0x0058 }
        ...
        L_0x003d:
            ...
            androidx.media2.exoplayer.external.util.SlidingPercentile r0 = r10.slidingPercentile     // Catch:{ all -> 0x0058 }
    ...
    private static class ConnectivityActionReceiver extends BroadcastReceiver {
            ...
            if (!isInitialStickyBroadcast()) {
                ...
                for (int i = 0; i < this.bandwidthMeters.size(); i++) {
                    ...
                    if (defaultBandwidthMeter != null) {
                        mo5439xc0d413df(defaultBandwidthMeter);
                    }
                }
            }
        }
        ...
        public void mo5439xc0d413df(DefaultBandwidthMeter defaultBandwidthMeter) {
