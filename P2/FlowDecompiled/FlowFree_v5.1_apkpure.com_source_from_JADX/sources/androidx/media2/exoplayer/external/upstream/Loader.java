    ...
    private final class LoadTask<T extends Loadable> extends Handler implements Runnable {
        ...
        public void run() {
            try {
                ...
                Log.m14e("LoadTask", "Unexpected exception loading stream", e2);
                if (!this.released) {
                    obtainMessage(3, new UnexpectedLoaderException(e2)).sendToTarget();
                }
            } catch (OutOfMemoryError e3) {
                Log.m14e("LoadTask", "OutOfMemory error loading stream", e3);
                if (!this.released) {
                    obtainMessage(3, new UnexpectedLoaderException(e3)).sendToTarget();
                }
            } catch (Error e4) {
                Log.m14e("LoadTask", "Unexpected error loading stream", e4);
                if (!this.released) {
                ...
                if (i == 0) {
                    ...
                    if (i2 == 1) {
                        ...
                        try {
                            ...
                            Log.m14e("LoadTask", "Unexpected exception handling load completed", e);
                        ...
                        this.errorCount = i3;
                        LoadErrorAction onLoadError = this.callback.onLoadError(this.loadable, elapsedRealtime, j2, iOException, i3);
