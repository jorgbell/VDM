...
public final class NalUnitUtil {
    ...
    public static void discardToSps(ByteBuffer byteBuffer) {
        ...
        while (true) {
            int i3 = i + 1;
            if (i3 < position) {
                byte b = byteBuffer.get(i) & Constants.UNKNOWN;
                if (i2 == 3) {
    ...
    public static androidx.media2.exoplayer.external.util.NalUnitUtil.SpsData parseSpsNalUnit(byte[] r21, int r22, int r23) {
        /*
            androidx.media2.exoplayer.external.util.ParsableNalUnitBitArray r0 = new androidx.media2.exoplayer.external.util.ParsableNalUnitBitArray
            r1 = r21
            r2 = r22
            r3 = r23
            r0.<init>(r1, r2, r3)
        ...
        L_0x0152:
            ...
            androidx.media2.exoplayer.external.util.Log.m16w(r2, r0)
        L_0x016a:
            r9 = 1065353216(0x3f800000, float:1.0)
        L_0x016c:
            androidx.media2.exoplayer.external.util.NalUnitUtil$SpsData r0 = new androidx.media2.exoplayer.external.util.NalUnitUtil$SpsData
            r2 = r0
            r10 = r11
            r11 = r16
