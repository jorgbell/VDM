...
public final class ParsableBitArray {
    ...
    public int readBits(int i) {
        ...
        int i7 = (-1 >>> (32 - i)) & (i3 | ((bArr2[i6] & Constants.UNKNOWN) >> (8 - i2)));
        if (i2 == 8) {
            this.bitOffset = 0;
    ...
    public void readBits(byte[] bArr, int i, int i2) {
        ...
        if (i7 != 0) {
            ...
            if (i8 + i7 > 8) {
                ...
                bArr[i3] = (byte) (b2 | ((bArr3[i9] & Constants.UNKNOWN) << i8));
                this.bitOffset = i8 - 8;
            }
    ...
    private void assertValidOffset() {
        ...
        L_0x0011:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.media2.exoplayer.external.util.ParsableBitArray.assertValidOffset():void");
    }
}
