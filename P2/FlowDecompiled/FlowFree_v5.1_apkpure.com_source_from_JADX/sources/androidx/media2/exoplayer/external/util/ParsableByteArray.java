...
public final class ParsableByteArray {
    ...
    public int readUnsignedShort() {
        ...
        this.position = i2;
        this.position = i2 + 1;
        return (bArr[i2] & Constants.UNKNOWN) | ((bArr[i] & Constants.UNKNOWN) << 8);
    }
    ...
    public int readLittleEndianUnsignedShort() {
        ...
        this.position = i2 + 1;
        return ((bArr[i2] & Constants.UNKNOWN) << 8) | b;
    }
    ...
    public int readUnsignedInt24() {
        ...
        int i3 = i2 + 1;
        this.position = i3;
        byte b = ((bArr[i] & Constants.UNKNOWN) << 16) | ((bArr[i2] & Constants.UNKNOWN) << 8);
        this.position = i3 + 1;
        return (bArr[i3] & Constants.UNKNOWN) | b;
    }
    ...
    public int readInt24() {
        ...
        int i3 = i2 + 1;
        this.position = i3;
        byte b = (((bArr[i] & Constants.UNKNOWN) << 24) >> 8) | ((bArr[i2] & Constants.UNKNOWN) << 8);
        this.position = i3 + 1;
        return (bArr[i3] & Constants.UNKNOWN) | b;
    }
    ...
    public int readInt() {
        ...
        int i3 = i2 + 1;
        this.position = i3;
        byte b = ((bArr[i] & Constants.UNKNOWN) << 24) | ((bArr[i2] & Constants.UNKNOWN) << 16);
        int i4 = i3 + 1;
        this.position = i4;
        byte b2 = b | ((bArr[i3] & Constants.UNKNOWN) << 8);
        this.position = i4 + 1;
        return (bArr[i4] & Constants.UNKNOWN) | b2;
    }
    ...
    public int readLittleEndianInt() {
        ...
        int i3 = i2 + 1;
        this.position = i3;
        byte b2 = b | ((bArr[i2] & Constants.UNKNOWN) << 8);
        int i4 = i3 + 1;
        this.position = i4;
        byte b3 = b2 | ((bArr[i3] & Constants.UNKNOWN) << 16);
        this.position = i4 + 1;
        return ((bArr[i4] & Constants.UNKNOWN) << 24) | b3;
    }
    ...
    public int readUnsignedFixedPoint1616() {
        ...
        int i3 = i2 + 1;
        this.position = i3;
        byte b = (bArr[i2] & Constants.UNKNOWN) | ((bArr[i] & Constants.UNKNOWN) << 8);
        this.position = i3 + 2;
        return b;
    }
