...
public final class ParsableNalUnitBitArray {
    ...
    public int readBits(int i) {
        ...
        while (true) {
            ...
            i4 |= (bArr[i6] & Constants.UNKNOWN) << i5;
        ...
        int i8 = (-1 >>> (32 - i)) & (i4 | ((bArr2[i7] & Constants.UNKNOWN) >> (8 - i2)));
        if (i2 == 8) {
            this.bitOffset = 0;
    ...
    private void assertValidOffset() {
        ...
        L_0x0011:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.media2.exoplayer.external.util.ParsableNalUnitBitArray.assertValidOffset():void");
    }
}
