    ...
    private static class AudioFocusHandlerImplBase implements AudioFocusHandlerImpl {
        ...
        private class BecomingNoisyReceiver extends BroadcastReceiver {
            ...
            /* JADX WARNING: Code restructure failed: missing block: B:15:0x0051, code lost:
                if (r5 == 1) goto L_0x0069;
             */
            /* JADX WARNING: Code restructure failed: missing block: B:17:0x0055, code lost:
                if (r5 == 14) goto L_0x0058;
             */
            /* JADX WARNING: Code restructure failed: missing block: B:18:0x0058, code lost:
                r4 = r3.this$0.mPlayer;
                r4.setPlayerVolume(r4.getPlayerVolume() * 0.2f);
             */
            ...
            public void onReceive(android.content.Context r4, android.content.Intent r5) {
                ...
                L_0x000d:
                    ...
                    r1.append(r5)     // Catch:{ all -> 0x0073 }
                    androidx.media2.player.AudioFocusHandler$AudioFocusHandlerImplBase r5 = androidx.media2.player.AudioFocusHandler.AudioFocusHandlerImplBase.this     // Catch:{ all -> 0x0073 }
                    boolean r5 = r5.mBecomingNoisyReceiverRegistered     // Catch:{ all -> 0x0073 }
                    r1.append(r5)     // Catch:{ all -> 0x0073 }
                    java.lang.String r5 = ", attr="
                    r1.append(r5)     // Catch:{ all -> 0x0073 }
                    androidx.media2.player.AudioFocusHandler$AudioFocusHandlerImplBase r5 = androidx.media2.player.AudioFocusHandler.AudioFocusHandlerImplBase.this     // Catch:{ all -> 0x0073 }
                    androidx.media.AudioAttributesCompat r5 = r5.mAudioAttributes     // Catch:{ all -> 0x0073 }
                    r1.append(r5)     // Catch:{ all -> 0x0073 }
                    java.lang.String r5 = r1.toString()     // Catch:{ all -> 0x0073 }
                    android.util.Log.d(r0, r5)     // Catch:{ all -> 0x0073 }
                    androidx.media2.player.AudioFocusHandler$AudioFocusHandlerImplBase r5 = androidx.media2.player.AudioFocusHandler.AudioFocusHandlerImplBase.this     // Catch:{ all -> 0x0073 }
                    boolean r0 = r5.mBecomingNoisyReceiverRegistered     // Catch:{ all -> 0x0073 }
                    if (r0 == 0) goto L_0x0071
                    androidx.media.AudioAttributesCompat r5 = r5.mAudioAttributes     // Catch:{ all -> 0x0073 }
                    if (r5 != 0) goto L_0x004b
                    goto L_0x0071
                L_0x004b:
                    int r5 = r5.getUsage()     // Catch:{ all -> 0x0073 }
        ...
        private class AudioFocusListener implements AudioManager.OnAudioFocusChangeListener {
            ...
            public void onAudioFocusChange(int r4) {
                ...
                L_0x000f:
                    ...
                    java.lang.Object r4 = r4.mLock
                    monitor-enter(r4)
                    androidx.media2.player.AudioFocusHandler$AudioFocusHandlerImplBase r0 = androidx.media2.player.AudioFocusHandler.AudioFocusHandlerImplBase.this     // Catch:{ all -> 0x002f }
                    boolean r1 = r0.mResumeWhenAudioFocusGain     // Catch:{ all -> 0x002f }
                    if (r1 != 0) goto L_0x0027
                    monitor-exit(r4)     // Catch:{ all -> 0x002f }
                    goto L_0x00bd
                L_0x0027:
                    monitor-exit(r4)     // Catch:{ all -> 0x002f }
                    androidx.media2.player.MediaPlayer r4 = r0.mPlayer
                    r4.play()
                    goto L_0x00bd
                L_0x002f:
                    r0 = move-exception
                ...
                L_0x0032:
                    ...
                    monitor-enter(r0)
                    float r1 = r3.mPlayerDuckingVolume     // Catch:{ all -> 0x0053 }
                    int r4 = (r4 > r1 ? 1 : (r4 == r1 ? 0 : -1))
                    if (r4 == 0) goto L_0x0048
                    monitor-exit(r0)     // Catch:{ all -> 0x0053 }
                    goto L_0x00bd
                L_0x0048:
                    float r4 = r3.mPlayerVolumeBeforeDucking     // Catch:{ all -> 0x0053 }
                    monitor-exit(r0)     // Catch:{ all -> 0x0053 }
                    androidx.media2.player.AudioFocusHandler$AudioFocusHandlerImplBase r0 = androidx.media2.player.AudioFocusHandler.AudioFocusHandlerImplBase.this
                ...
                L_0x0056:
                    ...
                    java.lang.Object r4 = r4.mLock
                    monitor-enter(r4)
                    androidx.media2.player.AudioFocusHandler$AudioFocusHandlerImplBase r0 = androidx.media2.player.AudioFocusHandler.AudioFocusHandlerImplBase.this     // Catch:{ all -> 0x0068 }
                    r0.mResumeWhenAudioFocusGain = r1     // Catch:{ all -> 0x0068 }
                ...
                L_0x006b:
                    ...
                    java.lang.Object r4 = r4.mLock
                    monitor-enter(r4)
                    androidx.media2.player.AudioFocusHandler$AudioFocusHandlerImplBase r0 = androidx.media2.player.AudioFocusHandler.AudioFocusHandlerImplBase.this     // Catch:{ all -> 0x007d }
                    r0.mResumeWhenAudioFocusGain = r2     // Catch:{ all -> 0x007d }
                ...
                L_0x0080:
                    ...
                    java.lang.Object r4 = r4.mLock
                    monitor-enter(r4)
                    androidx.media2.player.AudioFocusHandler$AudioFocusHandlerImplBase r0 = androidx.media2.player.AudioFocusHandler.AudioFocusHandlerImplBase.this     // Catch:{ all -> 0x00c1 }
                    androidx.media.AudioAttributesCompat r0 = r0.mAudioAttributes     // Catch:{ all -> 0x00c1 }
                    if (r0 != 0) goto L_0x008d
                    monitor-exit(r4)     // Catch:{ all -> 0x00c1 }
                    goto L_0x00bd
                L_0x008d:
                    int r0 = r0.getContentType()     // Catch:{ all -> 0x00c1 }
                ...
                L_0x009f:
                    ...
                    monitor-enter(r1)
                    r3.mPlayerVolumeBeforeDucking = r4     // Catch:{ all -> 0x00be }
                    r3.mPlayerDuckingVolume = r0     // Catch:{ all -> 0x00be }
