...
public final class MediaPlayer extends SessionPlayer {
    ...
    public MediaPlayer(Context context) {
        ...
        this.mPlayer.setDrmEventCallback(this.mExecutor, new Mp2DrmCallback(this));
    ...
    public ListenableFuture<SessionPlayer.PlayerResult> play() {
        synchronized (this.mStateLock) {
            ...
            C02722 r0 = new PendingFuture<SessionPlayer.PlayerResult>(this.mExecutor) {
                /* access modifiers changed from: package-private */
    ...
    public ListenableFuture<SessionPlayer.PlayerResult> pause() {
        synchronized (this.mStateLock) {
            ...
            C02783 r0 = new PendingFuture<SessionPlayer.PlayerResult>(this.mExecutor) {
                /* access modifiers changed from: package-private */
                public List<ResolvableFuture<SessionPlayer.PlayerResult>> onExecute() {
                    ArrayList arrayList = new ArrayList();
    ...
    public ListenableFuture<SessionPlayer.PlayerResult> prepare() {
        synchronized (this.mStateLock) {
            ...
            C02894 r0 = new PendingFuture<SessionPlayer.PlayerResult>(this.mExecutor) {
                /* access modifiers changed from: package-private */
                public List<ResolvableFuture<SessionPlayer.PlayerResult>> onExecute() {
                    ArrayList arrayList = new ArrayList();
                    ResolvableFuture create = ResolvableFuture.create();
    ...
    public ListenableFuture<SessionPlayer.PlayerResult> seekTo(long j) {
        synchronized (this.mStateLock) {
            ...
            final long j2 = j;
            C02905 r1 = new PendingFuture<SessionPlayer.PlayerResult>(this.mExecutor, true) {
                /* access modifiers changed from: package-private */
                public List<ResolvableFuture<SessionPlayer.PlayerResult>> onExecute() {
                    ArrayList arrayList = new ArrayList();
                    ResolvableFuture create = ResolvableFuture.create();
    ...
    public ListenableFuture<SessionPlayer.PlayerResult> setPlaybackSpeed(final float f) {
        synchronized (this.mStateLock) {
            ...
            C02916 r0 = new PendingFuture<SessionPlayer.PlayerResult>(this.mExecutor) {
                /* access modifiers changed from: package-private */
                public List<ResolvableFuture<SessionPlayer.PlayerResult>> onExecute() {
                    if (f <= 0.0f) {
                    ...
                    synchronized (MediaPlayer.this.mPendingCommands) {
                        ...
                        PlaybackParams.Builder builder = new PlaybackParams.Builder(mediaPlayer2.getPlaybackParams());
                        builder.setSpeed(f);
                        MediaPlayer.this.addPendingCommandLocked(24, create, mediaPlayer2.setPlaybackParams(builder.build()));
                    }
                    arrayList.add(create);
                    return arrayList;
                }
    ...
    public ListenableFuture<SessionPlayer.PlayerResult> setAudioAttributes(final AudioAttributesCompat audioAttributesCompat) {
        ...
        synchronized (this.mStateLock) {
            ...
            C02927 r0 = new PendingFuture<SessionPlayer.PlayerResult>(this.mExecutor) {
                /* access modifiers changed from: package-private */
                public List<ResolvableFuture<SessionPlayer.PlayerResult>> onExecute() {
                    ArrayList arrayList = new ArrayList();
                    ResolvableFuture create = ResolvableFuture.create();
    ...
    public ListenableFuture<SessionPlayer.PlayerResult> setMediaItem(final MediaItem mediaItem) {
        ...
        if (!(mediaItem instanceof FileMediaItem) || !((FileMediaItem) mediaItem).isClosed()) {
            synchronized (this.mStateLock) {
                ...
                C02938 r0 = new PendingFuture<SessionPlayer.PlayerResult>(this.mExecutor) {
                    /* access modifiers changed from: package-private */
                    public List<ResolvableFuture<SessionPlayer.PlayerResult>> onExecute() {
                        ...
                        synchronized (MediaPlayer.this.mPlaylistLock) {
                            ...
                            mediaItem = mediaItem;
                            mediaPlayer.mCurPlaylistItem = mediaItem;
                            mediaPlayer.mNextPlaylistItem = null;
                            mediaPlayer.mCurrentShuffleIdx = -1;
                        }
                        arrayList.addAll(mediaPlayer.setMediaItemsInternal(mediaItem, (MediaItem) null));
                        return arrayList;
                    }
                };
                addPendingFuture(r0);
    ...
    public ListenableFuture<SessionPlayer.PlayerResult> skipToPreviousPlaylistItem() {
        synchronized (this.mStateLock) {
            ...
            C026913 r0 = new PendingFuture<SessionPlayer.PlayerResult>(this.mExecutor) {
                /* access modifiers changed from: package-private */
                public List<ResolvableFuture<SessionPlayer.PlayerResult>> onExecute() {
                    synchronized (MediaPlayer.this.mPlaylistLock) {
                        MediaPlayer mediaPlayer = MediaPlayer.this;
                        ...
                        if (i < 0) {
                            List<ResolvableFuture<SessionPlayer.PlayerResult>> createFuturesForResultCode = mediaPlayer.createFuturesForResultCode(-2);
                        ...
                        if (i2 < 0) {
                            ...
                            if (i3 != 2) {
                                if (i3 != 3) {
                                    List<ResolvableFuture<SessionPlayer.PlayerResult>> createFuturesForResultCode2 = mediaPlayer.createFuturesForResultCode(-2);
    ...
    public ListenableFuture<SessionPlayer.PlayerResult> skipToNextPlaylistItem() {
        synchronized (this.mStateLock) {
            ...
            C027014 r0 = new PendingFuture<SessionPlayer.PlayerResult>(this.mExecutor) {
                /* access modifiers changed from: package-private */
                /* JADX WARNING: Code restructure failed: missing block: B:21:0x003c, code lost:
                    if (r2 == null) goto L_0x0043;
                 */
                /* JADX WARNING: Code restructure failed: missing block: B:23:0x0042, code lost:
                    return r1.setMediaItemsInternal(r2, r3);
                 */
                /* JADX WARNING: Code restructure failed: missing block: B:24:0x0043, code lost:
                    r0 = new java.util.ArrayList();
                    r0.add(r5.this$0.skipToNextInternal());
                 */
                ...
                public java.util.List<androidx.media2.player.futures.ResolvableFuture<androidx.media2.common.SessionPlayer.PlayerResult>> onExecute() {
                    /*
                        ...
                        monitor-enter(r0)
                        androidx.media2.player.MediaPlayer r1 = androidx.media2.player.MediaPlayer.this     // Catch:{ all -> 0x0052 }
                        int r2 = r1.mCurrentShuffleIdx     // Catch:{ all -> 0x0052 }
                        r3 = -2
                        if (r2 >= 0) goto L_0x0012
                        java.util.List r1 = r1.createFuturesForResultCode(r3)     // Catch:{ all -> 0x0052 }
                        monitor-exit(r0)     // Catch:{ all -> 0x0052 }
                        return r1
                    L_0x0012:
                        int r2 = r2 + 1
                        java.util.ArrayList<androidx.media2.common.MediaItem> r1 = r1.mShuffledList     // Catch:{ all -> 0x0052 }
                        int r1 = r1.size()     // Catch:{ all -> 0x0052 }
                        if (r2 < r1) goto L_0x002e
                        androidx.media2.player.MediaPlayer r1 = androidx.media2.player.MediaPlayer.this     // Catch:{ all -> 0x0052 }
                        int r2 = r1.mRepeatMode     // Catch:{ all -> 0x0052 }
                        r4 = 2
                    ...
                    L_0x002e:
                        androidx.media2.player.MediaPlayer r1 = androidx.media2.player.MediaPlayer.this     // Catch:{ all -> 0x0052 }
                        r1.mCurrentShuffleIdx = r2     // Catch:{ all -> 0x0052 }
                        r1.updateAndGetCurrentNextItemIfNeededLocked()     // Catch:{ all -> 0x0052 }
                        androidx.media2.player.MediaPlayer r1 = androidx.media2.player.MediaPlayer.this     // Catch:{ all -> 0x0052 }
                        androidx.media2.common.MediaItem r2 = r1.mCurPlaylistItem     // Catch:{ all -> 0x0052 }
                        androidx.media2.common.MediaItem r3 = r1.mNextPlaylistItem     // Catch:{ all -> 0x0052 }
                        monitor-exit(r0)     // Catch:{ all -> 0x0052 }
                        if (r2 == 0) goto L_0x0043
                        java.util.List r0 = r1.setMediaItemsInternal(r2, r3)
                        return r0
                    L_0x0043:
                    ...
                    L_0x0052:
                        ...
                        throw r1
                    */
                    throw new UnsupportedOperationException("Method not decompiled: androidx.media2.player.MediaPlayer.C027014.onExecute():java.util.List");
                }
            };
            addPendingFuture(r0);
            return r0;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:24:0x0023, code lost:
        r0 = r4.mPlaylist;
        r2 = r4.mShuffledList;
        r0 = r0.indexOf(r2.get(r2.size() - 1));
     */
    ...
    public int getPreviousMediaItemIndex() {
        /*
            ...
            monitor-enter(r0)
            boolean r1 = r4.mClosed     // Catch:{ all -> 0x0048 }
            r2 = -1
        ...
        L_0x000a:
            ...
            monitor-enter(r1)
            int r0 = r4.mCurrentShuffleIdx     // Catch:{ all -> 0x0045 }
            if (r0 >= 0) goto L_0x0014
        ...
        L_0x0014:
            int r0 = r0 + -1
            if (r0 >= 0) goto L_0x0037
            int r0 = r4.mRepeatMode     // Catch:{ all -> 0x0045 }
            r3 = 2
        ...
        L_0x0021:
            ...
            return r2
        L_0x0023:
            androidx.media2.player.MediaPlayer$MediaItemList r0 = r4.mPlaylist     // Catch:{ all -> 0x0045 }
            java.util.ArrayList<androidx.media2.common.MediaItem> r2 = r4.mShuffledList     // Catch:{ all -> 0x0045 }
            int r3 = r2.size()     // Catch:{ all -> 0x0045 }
            int r3 = r3 + -1
            java.lang.Object r2 = r2.get(r3)     // Catch:{ all -> 0x0045 }
            int r0 = r0.indexOf(r2)     // Catch:{ all -> 0x0045 }
            monitor-exit(r1)     // Catch:{ all -> 0x0045 }
            return r0
        L_0x0037:
            androidx.media2.player.MediaPlayer$MediaItemList r2 = r4.mPlaylist     // Catch:{ all -> 0x0045 }
            java.util.ArrayList<androidx.media2.common.MediaItem> r3 = r4.mShuffledList     // Catch:{ all -> 0x0045 }
            java.lang.Object r0 = r3.get(r0)     // Catch:{ all -> 0x0045 }
            int r0 = r2.indexOf(r0)     // Catch:{ all -> 0x0045 }
            monitor-exit(r1)     // Catch:{ all -> 0x0045 }
            return r0
        L_0x0045:
            r0 = move-exception
    ...
    public int getNextMediaItemIndex() {
        /*
            ...
            java.lang.Object r0 = r4.mStateLock
            monitor-enter(r0)
            boolean r1 = r4.mClosed     // Catch:{ all -> 0x0049 }
            r2 = -1
            if (r1 == 0) goto L_0x000a
        ...
        L_0x000a:
            ...
            java.lang.Object r1 = r4.mPlaylistLock
            monitor-enter(r1)
            int r0 = r4.mCurrentShuffleIdx     // Catch:{ all -> 0x0046 }
            if (r0 >= 0) goto L_0x0014
            monitor-exit(r1)     // Catch:{ all -> 0x0046 }
            return r2
        L_0x0014:
            int r0 = r0 + 1
            java.util.ArrayList<androidx.media2.common.MediaItem> r3 = r4.mShuffledList     // Catch:{ all -> 0x0046 }
            int r3 = r3.size()     // Catch:{ all -> 0x0046 }
            if (r0 < r3) goto L_0x0038
            int r0 = r4.mRepeatMode     // Catch:{ all -> 0x0046 }
            r3 = 2
        ...
        L_0x0027:
            ...
            return r2
        L_0x0029:
            androidx.media2.player.MediaPlayer$MediaItemList r0 = r4.mPlaylist     // Catch:{ all -> 0x0046 }
            java.util.ArrayList<androidx.media2.common.MediaItem> r2 = r4.mShuffledList     // Catch:{ all -> 0x0046 }
            r3 = 0
            java.lang.Object r2 = r2.get(r3)     // Catch:{ all -> 0x0046 }
            int r0 = r0.indexOf(r2)     // Catch:{ all -> 0x0046 }
            monitor-exit(r1)     // Catch:{ all -> 0x0046 }
            return r0
        L_0x0038:
            androidx.media2.player.MediaPlayer$MediaItemList r2 = r4.mPlaylist     // Catch:{ all -> 0x0046 }
            java.util.ArrayList<androidx.media2.common.MediaItem> r3 = r4.mShuffledList     // Catch:{ all -> 0x0046 }
            java.lang.Object r0 = r3.get(r0)     // Catch:{ all -> 0x0046 }
            int r0 = r2.indexOf(r0)     // Catch:{ all -> 0x0046 }
            monitor-exit(r1)     // Catch:{ all -> 0x0046 }
            return r0
        L_0x0046:
            r0 = move-exception
    ...
    public ListenableFuture<SessionPlayer.PlayerResult> setSurface(final Surface surface) {
        synchronized (this.mStateLock) {
            ...
            C027119 r0 = new PendingFuture<SessionPlayer.PlayerResult>(this.mExecutor) {
                /* access modifiers changed from: package-private */
                public List<ResolvableFuture<SessionPlayer.PlayerResult>> onExecute() {
                    ArrayList arrayList = new ArrayList();
                    ResolvableFuture create = ResolvableFuture.create();
    ...
    public ListenableFuture<SessionPlayer.PlayerResult> setPlayerVolume(final float f) {
        ...
        synchronized (this.mStateLock) {
            ...
            C027320 r0 = new PendingFuture<SessionPlayer.PlayerResult>(this.mExecutor) {
                /* access modifiers changed from: package-private */
                public List<ResolvableFuture<SessionPlayer.PlayerResult>> onExecute() {
                    ArrayList arrayList = new ArrayList();
    ...
    public ListenableFuture<SessionPlayer.PlayerResult> setPlaybackParams(final PlaybackParams playbackParams) {
        ...
        synchronized (this.mStateLock) {
            ...
            C027421 r0 = new PendingFuture<SessionPlayer.PlayerResult>(this.mExecutor) {
                /* access modifiers changed from: package-private */
                public List<ResolvableFuture<SessionPlayer.PlayerResult>> onExecute() {
                    ArrayList arrayList = new ArrayList();
                    ResolvableFuture create = ResolvableFuture.create();
    ...
    public ListenableFuture<SessionPlayer.PlayerResult> seekTo(long j, int i) {
        synchronized (this.mStateLock) {
            ...
            final int i2 = i;
            final long j2 = j;
            C027522 r1 = new PendingFuture<SessionPlayer.PlayerResult>(this.mExecutor, true) {
                /* access modifiers changed from: package-private */
                public List<ResolvableFuture<SessionPlayer.PlayerResult>> onExecute() {
                    ArrayList arrayList = new ArrayList();
                    ResolvableFuture create = ResolvableFuture.create();
    ...
    public ListenableFuture<SessionPlayer.PlayerResult> selectTrack(final TrackInfo trackInfo) {
        ...
        synchronized (this.mStateLock) {
            ...
            C027626 r1 = new PendingFuture<SessionPlayer.PlayerResult>(this.mExecutor) {
                /* access modifiers changed from: package-private */
                public List<ResolvableFuture<SessionPlayer.PlayerResult>> onExecute() {
                    ArrayList arrayList = new ArrayList();
                    ResolvableFuture create = ResolvableFuture.create();
    ...
    public ListenableFuture<SessionPlayer.PlayerResult> deselectTrack(final TrackInfo trackInfo) {
        ...
        synchronized (this.mStateLock) {
            ...
            final int id = trackInfo.getId();
            C027727 r1 = new PendingFuture<SessionPlayer.PlayerResult>(this.mExecutor) {
                /* access modifiers changed from: package-private */
                public List<ResolvableFuture<SessionPlayer.PlayerResult>> onExecute() {
                    ArrayList arrayList = new ArrayList();
                    ResolvableFuture create = ResolvableFuture.create();
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:11:0x0018, code lost:
        ...
        ((java.util.concurrent.Executor) r1.second).execute(new androidx.media2.player.MediaPlayer.C028132(r4));
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x0022, code lost:
        if ((r2 instanceof androidx.media2.player.MediaPlayer.PlayerCallback) == false) goto L_0x0012;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:13:0x0024, code lost:
        r2 = (androidx.media2.player.MediaPlayer.PlayerCallback) r2;
        ((java.util.concurrent.Executor) r1.second).execute(new androidx.media2.player.MediaPlayer.C028233(r4));
     */
    ...
    public void notifyMediaPlayerCallback(final androidx.media2.player.MediaPlayer.MediaPlayerCallbackNotifier r5) {
        /*
            ...
            java.lang.Object r0 = r4.mStateLock
            monitor-enter(r0)
            boolean r1 = r4.mClosed     // Catch:{ all -> 0x0034 }
            if (r1 == 0) goto L_0x0009
        ...
        L_0x0012:
            ...
            androidx.core.util.Pair r1 = (androidx.core.util.Pair) r1
            F r2 = r1.first
            boolean r3 = r2 instanceof androidx.media2.player.MediaPlayer.PlayerCallback
    ...
    class Mp2Callback extends MediaPlayer2.EventCallback {
        ...
        public void onInfo(MediaPlayer2 mediaPlayer2, final MediaItem mediaItem, int i, final int i2) {
            ...
            if (i == 2) {
                synchronized (MediaPlayer.this.mPlaylistLock) {
                    MediaPlayer mediaPlayer3 = MediaPlayer.this;
                    if (mediaPlayer3.mCurPlaylistItem == mediaItem) {
                        z = false;
                        mediaItem2 = null;
                    } else {
                        mediaPlayer3.mCurrentShuffleIdx = mediaPlayer3.mShuffledList.indexOf(mediaItem);
                ...
                synchronized (MediaPlayer.this.mPlaylistLock) {
                    ...
                    mediaPlayer4.mCurrentShuffleIdx = mediaPlayer4.mShuffledList.indexOf(mediaItem);
                    mediaPlayer = MediaPlayer.this;
                    mediaItem3 = mediaPlayer.mNextPlaylistItem;
                }
                if (mediaItem3 == null) {
