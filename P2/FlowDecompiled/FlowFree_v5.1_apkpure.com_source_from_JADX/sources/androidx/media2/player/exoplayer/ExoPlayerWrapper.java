...
final class ExoPlayerWrapper {
    ...
    public void setMediaItem(MediaItem mediaItem) {
        MediaItemQueue mediaItemQueue = this.mMediaItemQueue;
        Preconditions.checkNotNull(mediaItem);
        mediaItemQueue.setMediaItem(mediaItem);
    }
    ...
    public MediaTimestamp getTimestamp() {
        ...
        if (this.mPlayer.getPlaybackState() == 1) {
            ...
            j = C0200C.msToUs(getCurrentPosition());
        }
    ...
    public void reset() {
        ...
        this.mPlayer = ExoPlayerFactory.newSimpleInstance(context, new RenderersFactory(context, this.mAudioSink, textRenderer), trackSelector.getPlayerTrackSelector(), new DefaultLoadControl(), (DrmSessionManager<FrameworkMediaCrypto>) null, this.mBandwidthMeter, new AnalyticsCollector.Factory(), this.mLooper);
        ...
        this.mPlaybackParams = builder.build();
    }
    ...
    private static final class FileDescriptorRegistry {
        ...
        public Object registerMediaItemAndGetLock(FileDescriptor fileDescriptor) {
            ...
            Entry entry = this.mEntries.get(fileDescriptor);
            Preconditions.checkNotNull(entry);
            Entry entry2 = entry;
            entry2.mMediaItemCount++;
            return entry2.mLock;
        }
        ...
        public void unregisterMediaItem(FileDescriptor fileDescriptor) {
            ...
            Preconditions.checkNotNull(entry);
            Entry entry2 = entry;
            int i = entry2.mMediaItemCount - 1;
            entry2.mMediaItemCount = i;
            if (i == 0) {
    ...
    private static final class MediaItemQueue {
        ...
        private void appendMediaItem(androidx.media2.common.MediaItem r21, java.util.Collection<androidx.media2.player.exoplayer.ExoPlayerWrapper.MediaItemInfo> r22, java.util.Collection<androidx.media2.exoplayer.external.source.MediaSource> r23) {
            ...
            L_0x0048:
                ...
                long r13 = androidx.media2.exoplayer.external.C0200C.msToUs(r4)
                long r15 = androidx.media2.exoplayer.external.C0200C.msToUs(r6)
                r17 = 0
                r18 = 0
                r19 = 1
                r11 = r2
