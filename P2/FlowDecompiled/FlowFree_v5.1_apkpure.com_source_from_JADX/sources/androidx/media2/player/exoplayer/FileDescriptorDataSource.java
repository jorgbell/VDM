...
class FileDescriptorDataSource extends BaseDataSource {
    ...
    public int read(byte[] r8, int r9, int r10) throws java.io.IOException {
        ...
        L_0x001b:
            ...
            monitor-enter(r0)
            java.io.FileDescriptor r1 = r7.mFileDescriptor     // Catch:{ all -> 0x0054 }
            long r5 = r7.mPosition     // Catch:{ all -> 0x0054 }
            androidx.media2.player.exoplayer.FileDescriptorUtil.seek(r1, r5)     // Catch:{ all -> 0x0054 }
            java.io.InputStream r1 = r7.mInputStream     // Catch:{ all -> 0x0054 }
            androidx.core.util.Preconditions.checkNotNull(r1)     // Catch:{ all -> 0x0054 }
            java.io.InputStream r1 = (java.io.InputStream) r1     // Catch:{ all -> 0x0054 }
            int r8 = r1.read(r8, r9, r10)     // Catch:{ all -> 0x0054 }
            if (r8 != r4) goto L_0x0040
            long r8 = r7.mBytesRemaining     // Catch:{ all -> 0x0054 }
            int r10 = (r8 > r2 ? 1 : (r8 == r2 ? 0 : -1))
            if (r10 != 0) goto L_0x003a
            monitor-exit(r0)     // Catch:{ all -> 0x0054 }
            return r4
        L_0x003a:
            java.io.EOFException r8 = new java.io.EOFException     // Catch:{ all -> 0x0054 }
            r8.<init>()     // Catch:{ all -> 0x0054 }
            throw r8     // Catch:{ all -> 0x0054 }
        L_0x0040:
            long r9 = r7.mPosition     // Catch:{ all -> 0x0054 }
            long r4 = (long) r8     // Catch:{ all -> 0x0054 }
            long r9 = r9 + r4
            r7.mPosition = r9     // Catch:{ all -> 0x0054 }
            monitor-exit(r0)     // Catch:{ all -> 0x0054 }
