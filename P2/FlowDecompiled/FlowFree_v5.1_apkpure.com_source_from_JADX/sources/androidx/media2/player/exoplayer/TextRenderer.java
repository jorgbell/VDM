...
class TextRenderer extends BaseRenderer {
    ...
    public synchronized void render(long r6, long r8) {
        /*
            r5 = this;
            monitor-enter(r5)
            int r8 = r5.getState()     // Catch:{ all -> 0x0120 }
            r9 = 2
            if (r8 == r9) goto L_0x000a
            monitor-exit(r5)
            return
        L_0x000a:
            r5.display(r6)     // Catch:{ all -> 0x0120 }
            boolean r8 = r5.mHasPendingInputBuffer     // Catch:{ all -> 0x0120 }
            r0 = 1
            r1 = 0
            if (r8 != 0) goto L_0x003d
            androidx.media2.exoplayer.external.text.SubtitleInputBuffer r8 = r5.mInputBuffer     // Catch:{ all -> 0x0120 }
            r8.clear()     // Catch:{ all -> 0x0120 }
            androidx.media2.exoplayer.external.FormatHolder r8 = r5.mFormatHolder     // Catch:{ all -> 0x0120 }
            androidx.media2.exoplayer.external.text.SubtitleInputBuffer r2 = r5.mInputBuffer     // Catch:{ all -> 0x0120 }
            int r8 = r5.readSource(r8, r2, r1)     // Catch:{ all -> 0x0120 }
            r2 = -3
        ...
        L_0x0027:
            androidx.media2.exoplayer.external.text.SubtitleInputBuffer r8 = r5.mInputBuffer     // Catch:{ all -> 0x0120 }
            boolean r8 = r8.isEndOfStream()     // Catch:{ all -> 0x0120 }
            if (r8 == 0) goto L_0x0033
            r5.mInputStreamEnded = r0     // Catch:{ all -> 0x0120 }
            monitor-exit(r5)
            return
        L_0x0033:
            r5.mHasPendingInputBuffer = r0     // Catch:{ all -> 0x0120 }
            androidx.media2.exoplayer.external.text.SubtitleInputBuffer r8 = r5.mInputBuffer     // Catch:{ all -> 0x0120 }
            r8.flip()     // Catch:{ all -> 0x0120 }
            goto L_0x003d
        L_0x003b:
            monitor-exit(r5)
            return
        L_0x003d:
            androidx.media2.exoplayer.external.text.SubtitleInputBuffer r8 = r5.mInputBuffer     // Catch:{ all -> 0x0120 }
            long r2 = r8.timeUs     // Catch:{ all -> 0x0120 }
            long r2 = r2 - r6
            ...
            return
        L_0x004b:
            r5.mHasPendingInputBuffer = r1     // Catch:{ all -> 0x0120 }
            androidx.media2.exoplayer.external.util.ParsableByteArray r6 = r5.mCcData     // Catch:{ all -> 0x0120 }
            java.nio.ByteBuffer r7 = r8.data     // Catch:{ all -> 0x0120 }
            byte[] r7 = r7.array()     // Catch:{ all -> 0x0120 }
            androidx.media2.exoplayer.external.text.SubtitleInputBuffer r8 = r5.mInputBuffer     // Catch:{ all -> 0x0120 }
            java.nio.ByteBuffer r8 = r8.data     // Catch:{ all -> 0x0120 }
            int r8 = r8.limit()     // Catch:{ all -> 0x0120 }
            r6.reset(r7, r8)     // Catch:{ all -> 0x0120 }
            androidx.media2.player.exoplayer.TextRenderer$DataBuilder r6 = r5.mLine21DataBuilder     // Catch:{ all -> 0x0120 }
            r6.clear()     // Catch:{ all -> 0x0120 }
        L_0x0065:
            androidx.media2.exoplayer.external.util.ParsableByteArray r6 = r5.mCcData     // Catch:{ all -> 0x0120 }
            int r6 = r6.bytesLeft()     // Catch:{ all -> 0x0120 }
            r7 = 3
            if (r6 < r7) goto L_0x0109
            androidx.media2.exoplayer.external.util.ParsableByteArray r6 = r5.mCcData     // Catch:{ all -> 0x0120 }
            int r6 = r6.readUnsignedByte()     // Catch:{ all -> 0x0120 }
            byte r6 = (byte) r6     // Catch:{ all -> 0x0120 }
            androidx.media2.exoplayer.external.util.ParsableByteArray r8 = r5.mCcData     // Catch:{ all -> 0x0120 }
            int r8 = r8.readUnsignedByte()     // Catch:{ all -> 0x0120 }
            byte r8 = (byte) r8     // Catch:{ all -> 0x0120 }
            androidx.media2.exoplayer.external.util.ParsableByteArray r2 = r5.mCcData     // Catch:{ all -> 0x0120 }
            int r2 = r2.readUnsignedByte()     // Catch:{ all -> 0x0120 }
            byte r2 = (byte) r2     // Catch:{ all -> 0x0120 }
            r3 = r6 & 4
        ...
        L_0x008a:
            ...
            androidx.media2.player.exoplayer.TextRenderer$DataBuilder r6 = r5.mDtvDataBuilder     // Catch:{ all -> 0x0120 }
            boolean r6 = r6.hasData()     // Catch:{ all -> 0x0120 }
            if (r6 == 0) goto L_0x00a1
            androidx.media2.player.exoplayer.TextRenderer$DataBuilder r6 = r5.mDtvDataBuilder     // Catch:{ all -> 0x0120 }
            androidx.media2.exoplayer.external.text.SubtitleInputBuffer r7 = r5.mInputBuffer     // Catch:{ all -> 0x0120 }
            long r3 = r7.timeUs     // Catch:{ all -> 0x0120 }
            r5.handleDtvPacket(r6, r3)     // Catch:{ all -> 0x0120 }
        L_0x00a1:
            androidx.media2.player.exoplayer.TextRenderer$DataBuilder r6 = r5.mDtvDataBuilder     // Catch:{ all -> 0x0120 }
            r6.append(r8, r2)     // Catch:{ all -> 0x0120 }
            goto L_0x0065
        L_0x00a7:
            androidx.media2.player.exoplayer.TextRenderer$DataBuilder r7 = r5.mDtvDataBuilder     // Catch:{ all -> 0x0120 }
            int r3 = r7.mLength     // Catch:{ all -> 0x0120 }
            if (r3 <= 0) goto L_0x00b3
            if (r4 != r9) goto L_0x00b3
            r7.append(r8, r2)     // Catch:{ all -> 0x0120 }
            goto L_0x0065
        L_0x00b3:
        ...
        L_0x00d6:
            int r2 = r2 + r6
            int[] r6 = r5.mLine21Channels     // Catch:{ all -> 0x0120 }
            r6[r4] = r2     // Catch:{ all -> 0x0120 }
            r5.maybeAdvertiseChannel(r1, r2)     // Catch:{ all -> 0x0120 }
        L_0x00de:
            int r6 = r5.mSelectedType     // Catch:{ all -> 0x0120 }
            if (r6 != 0) goto L_0x0065
            int r6 = r5.mSelectedChannel     // Catch:{ all -> 0x0120 }
            int[] r2 = r5.mLine21Channels     // Catch:{ all -> 0x0120 }
            r2 = r2[r4]     // Catch:{ all -> 0x0120 }
            if (r6 != r2) goto L_0x0065
            androidx.media2.player.exoplayer.TextRenderer$DataBuilder r6 = r5.mLine21DataBuilder     // Catch:{ all -> 0x0120 }
            byte r2 = (byte) r4     // Catch:{ all -> 0x0120 }
            r6.append(r2, r7, r8)     // Catch:{ all -> 0x0120 }
            goto L_0x0065
        L_0x00f2:
        ...
        L_0x00f6:
            ...
            androidx.media2.player.exoplayer.TextRenderer$DataBuilder r6 = r5.mDtvDataBuilder     // Catch:{ all -> 0x0120 }
            androidx.media2.exoplayer.external.text.SubtitleInputBuffer r7 = r5.mInputBuffer     // Catch:{ all -> 0x0120 }
            long r7 = r7.timeUs     // Catch:{ all -> 0x0120 }
            r5.handleDtvPacket(r6, r7)     // Catch:{ all -> 0x0120 }
            goto L_0x0065
        L_0x0109:
            int r6 = r5.mSelectedType     // Catch:{ all -> 0x0120 }
            ...
            androidx.media2.exoplayer.external.text.SubtitleInputBuffer r7 = r5.mInputBuffer     // Catch:{ all -> 0x0120 }
            long r7 = r7.timeUs     // Catch:{ all -> 0x0120 }
            r5.handleLine21Packet(r6, r7)     // Catch:{ all -> 0x0120 }
        L_0x011e:
            monitor-exit(r5)
            return
        L_0x0120:
    ...
    private void display(long j) {
        if (this.mSelectedType != -1 && this.mSelectedChannel != -1) {
            ...
            while (!this.mCcMap.isEmpty()) {
                ...
                Object obj = this.mCcMap.get(Long.valueOf(longValue));
