...
public class MediaControlView extends MediaViewGroup {
        ...
        this.mSeekListener = new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int i, boolean z) {
                ...
                if (mediaControlView.mPlayer != null && mediaControlView.mSeekAvailable && z && mediaControlView.mDragging) {
                    ...
                    if (j > 0) {
                        MediaControlView.this.seekTo((j * ((long) i)) / 1000, !mediaControlView.isCurrentMediaItemFromNetwork());
                    }
                }
            }
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                ...
                if (mediaControlView.mPlayer != null && mediaControlView.mSeekAvailable) {
                    ...
                    if (MediaControlView.this.isCurrentMediaItemFromNetwork()) {
                        MediaControlView mediaControlView2 = MediaControlView.this;
                        mediaControlView2.mCurrentSeekPosition = -1;
                        mediaControlView2.mNextSeekPosition = -1;
                    }
        ...
        this.mRewListener = new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (mediaControlView.mPlayer != null) {
                    ...
                    MediaControlView.this.seekTo(Math.max((z ? mediaControlView3.mDuration : mediaControlView3.getLatestSeekPosition()) - 10000, 0), true);
                    if (z) {
            ...
            public void onClick(View view) {
                ...
                if (mediaControlView.mOnFullScreenListener != null) {
                    ...
                    if (z) {
                        ...
                        Resources resources = mediaControlView.mResources;
                        int i = R$drawable.ic_fullscreen_exit;
                        imageButton.setImageDrawable(resources.getDrawable(i));
                        MediaControlView mediaControlView2 = MediaControlView.this;
                        mediaControlView2.mMinimalFullScreenButton.setImageDrawable(mediaControlView2.mResources.getDrawable(i));
                    } else {
                        ImageButton imageButton2 = mediaControlView.mFullScreenButton;
                        Resources resources2 = mediaControlView.mResources;
                        int i2 = R$drawable.ic_fullscreen;
                        imageButton2.setImageDrawable(resources2.getDrawable(i2));
                        MediaControlView mediaControlView3 = MediaControlView.this;
                        mediaControlView3.mMinimalFullScreenButton.setImageDrawable(mediaControlView3.mResources.getDrawable(i2));
                    }
                    MediaControlView mediaControlView4 = MediaControlView.this;
                    mediaControlView4.mIsFullScreen = z;
                    mediaControlView4.mOnFullScreenListener.onFullScreen(mediaControlView4, z);
                }
            }
        };
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
                ...
                if (i2 == 0) {
                    if (i != mediaControlView.mSelectedAudioTrackIndex && mediaControlView.mAudioTracks.size() > 0) {
                        MediaControlView mediaControlView2 = MediaControlView.this;
                        mediaControlView2.mPlayer.selectTrack(mediaControlView2.mAudioTracks.get(i));
                    }
                    MediaControlView.this.dismissSettingsWindow();
                } else if (i2 == 1) {
                    if (i != mediaControlView.mSelectedSpeedIndex) {
                        MediaControlView.this.mPlayer.setPlaybackSpeed(((float) mediaControlView.mPlaybackSpeedMultBy100List.get(i).intValue()) / 100.0f);
                    }
                    MediaControlView.this.dismissSettingsWindow();
                } else if (i2 == 2) {
                    ...
                    if (i != i3 + 1) {
                        if (i > 0) {
                            mediaControlView.mPlayer.selectTrack(mediaControlView.mSubtitleTracks.get(i - 1));
                        } else {
                            mediaControlView.mPlayer.deselectTrack(mediaControlView.mSubtitleTracks.get(i3));
                        }
                    }
                    MediaControlView.this.dismissSettingsWindow();
                } else if (i2 == 3) {
    ...
    public void onMeasure(int i, int i2) {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (i11 == -1) {
                    ...
                    i5 = 0;
                    i6 = View.MeasureSpec.makeMeasureSpec(i3, 0);
                } else {
                    i5 = 0;
                ...
                if (i12 == -1) {
                    i7 = View.MeasureSpec.makeMeasureSpec(paddingTop, 1073741824);
                } else if (i12 == -2) {
        ...
        setMeasuredDimension(ViewGroup.resolveSizeAndState(resolveSize, i8, i4), ViewGroup.resolveSizeAndState(resolveSize2, i9, i4 << 16));
    }
    ...
    private void initControllerView() {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                MediaControlView mediaControlView = MediaControlView.this;
                mediaControlView.mProgress.getThumb().setLevel((int) (((float) (mediaControlView.mSizeType == 2 ? 0 : 10000)) * floatValue));
    ...
    public long setProgress() {
        ...
        if (this.mIsAdvertisement) {
            ...
            if (this.mAdRemainingView != null) {
                ...
                if (j3 - currentPosition >= 0) {
                    j2 = j3 - currentPosition;
                }
                this.mAdRemainingView.setText(this.mResources.getString(R$string.MediaControlView_ad_remaining_time, new Object[]{stringForTime(j2)}));
            }
        }
    ...
    class PlayerCallback extends PlayerWrapper.PlayerCallback {
            ...
            if (playerWrapper == MediaControlView.this.mPlayer) {
                ...
                if (i == 1) {
                    ...
                    if (MediaControlView.this.getWindowToken() != null) {
                        ...
                        builder.setMessage(R$string.mcv2_playback_error_text);
                        builder.setPositiveButton(R$string.mcv2_error_dialog_button, new DialogInterface.OnClickListener(this) {
        ...
        public void onSeekCompleted(PlayerWrapper playerWrapper, long j) {
            if (playerWrapper == MediaControlView.this.mPlayer) {
                ...
                mediaControlView3.mCurrentSeekPosition = -1;
                ...
                if (trackInfo.getTrackType() == 4) {
                    for (int i = 0; i < MediaControlView.this.mSubtitleTracks.size(); i++) {
                        if (MediaControlView.this.mSubtitleTracks.get(i).equals(trackInfo)) {
                            ...
                            if (mediaControlView.mSettingsMode == 2) {
                                mediaControlView.mSubSettingsAdapter.setCheckPosition(i + 1);
                            }
                            MediaControlView mediaControlView2 = MediaControlView.this;
                            mediaControlView2.mSubtitleButton.setImageDrawable(mediaControlView2.mResources.getDrawable(R$drawable.ic_subtitle_on));
                            MediaControlView mediaControlView3 = MediaControlView.this;
                    ...
                    for (int i2 = 0; i2 < MediaControlView.this.mAudioTracks.size(); i2++) {
                        if (MediaControlView.this.mAudioTracks.get(i2).equals(trackInfo)) {
                            ...
                            mediaControlView4.mSettingsSubTextsList.set(0, mediaControlView4.mSubSettingsAdapter.getMainText(i2));
                            return;
                        }
                    }
                }
                ...
                if (trackInfo.getTrackType() == 4) {
                    for (int i = 0; i < MediaControlView.this.mSubtitleTracks.size(); i++) {
                        if (MediaControlView.this.mSubtitleTracks.get(i).equals(trackInfo)) {
                            ...
                            if (mediaControlView.mSettingsMode == 2) {
                                mediaControlView.mSubSettingsAdapter.setCheckPosition(-1 + 1);
                            }
                            MediaControlView mediaControlView2 = MediaControlView.this;
                            mediaControlView2.mSubtitleButton.setImageDrawable(mediaControlView2.mResources.getDrawable(R$drawable.ic_subtitle_off));
                            MediaControlView mediaControlView3 = MediaControlView.this;
                            mediaControlView3.mSubtitleButton.setContentDescription(mediaControlView3.mResources.getString(R$string.mcv2_cc_is_off));
                            return;
                        }
                    }
                }
