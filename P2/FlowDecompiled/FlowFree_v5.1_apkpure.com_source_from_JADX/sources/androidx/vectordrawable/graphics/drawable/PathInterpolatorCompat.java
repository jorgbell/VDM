...
public class PathInterpolatorCompat implements Interpolator {
    ...
    private void initPath(Path path) {
        ...
        if (min > 0) {
            this.f19mX = new float[min];
            this.f20mY = new float[min];
            ...
            if (((double) Math.abs(this.f19mX[0])) <= 1.0E-5d && ((double) Math.abs(this.f20mY[0])) <= 1.0E-5d) {
                int i3 = min - 1;
                if (((double) Math.abs(this.f19mX[i3] - 1.0f)) <= 1.0E-5d && ((double) Math.abs(this.f20mY[i3] - 1.0f)) <= 1.0E-5d) {
                    float f = 0.0f;
                    int i4 = 0;
                    while (i < min) {
                        float[] fArr2 = this.f19mX;
                        int i5 = i4 + 1;
                        float f2 = fArr2[i4];
                        if (f2 >= f) {
                            fArr2[i] = f2;
            ...
            sb.append(this.f19mX[0]);
            sb.append(",");
            sb.append(this.f20mY[0]);
            sb.append(" end:");
            int i6 = min - 1;
            sb.append(this.f19mX[i6]);
            sb.append(",");
            sb.append(this.f20mY[i6]);
