...
public class SystemJobService extends JobService implements ExecutionListener {
    ...
    public boolean onStartJob(android.app.job.JobParameters r9) {
        ...
        L_0x0045:
            ...
            monitor-enter(r3)
            java.util.Map<java.lang.String, android.app.job.JobParameters> r4 = r8.mJobParameters     // Catch:{ all -> 0x00be }
            boolean r4 = r4.containsKey(r0)     // Catch:{ all -> 0x00be }
            if (r4 == 0) goto L_0x0067
            androidx.work.Logger r9 = androidx.work.Logger.get()     // Catch:{ all -> 0x00be }
            java.lang.String r4 = TAG     // Catch:{ all -> 0x00be }
        ...
        L_0x0067:
            ...
            java.lang.String r5 = TAG     // Catch:{ all -> 0x00be }
            ...
            java.util.Map<java.lang.String, android.app.job.JobParameters> r2 = r8.mJobParameters     // Catch:{ all -> 0x00be }
