...
public class C1153m {
    /* renamed from: a */
    public static String m2647a(String str, String str2) {
        return m2650a(str, str2, new byte[]{-83, -98, -53, -112, -29, -118, 55, 117, 59, 8, -12, -15, 73, 110, -67, 57, 117, 4, -26, 97, 66, -12, 125, 91, -119, -103, -30, 114, 123, 54, 51, -77});
    }

    /* renamed from: a */
    public static String m2648a(String str, String str2, long j) {
        return m2649a(str, str2, j, new byte[]{-83, -98, -53, -112, -29, -118, 55, 117, 59, 8, -12, -15, 73, 110, -67, 57, 117, 4, -26, 97, 66, -12, 125, 91, -119, -103, -30, 114, 123, 54, 51, -77});
    }

    /* renamed from: a */
    private static String m2649a(String str, String str2, long j, byte[] bArr) {
        String str3 = str;
        String str4 = str2;
        byte[] bArr2 = bArr;
        if (str4 == null) {
            ...
            if (bArr2.length < 32) {
                ...
                try {
                    ...
                    byte[] a = m2653a(substring2, bArr2);
                    ...
                    String b = m2655b(byteArrayOutputStream.toByteArray());
                    String a2 = m2651a(bArr);
    ...
    /* renamed from: a */
    private static String m2650a(String str, String str2, byte[] bArr) {
        String str3 = str;
        String str4 = str2;
        byte[] bArr2 = bArr;
        if (str4 == null) {
            ...
            if (bArr2.length < 32) {
                ...
                try {
                    ...
                    String str5 = split[1];
                    String str6 = split[2];
                    byte[] a = m2652a(split[3]);
                    if (!str4.endsWith(str6)) {
                        return null;
                    }
                    if (!m2651a(bArr).equals(str5)) {
                        return null;
                    }
                    byte[] a2 = m2653a(str4.substring(0, 32), bArr2);
                    ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(a);
                    char c4 = 8;
                    try {
                        long read = (((long) ((byteArrayInputStream.read() ^ a2[5]) & Constants.UNKNOWN)) << 40) | (((long) ((byteArrayInputStream.read() ^ a2[0]) & Constants.UNKNOWN)) << 0) | (((long) ((byteArrayInputStream.read() ^ a2[1]) & Constants.UNKNOWN)) << 8) | (((long) ((byteArrayInputStream.read() ^ a2[2]) & Constants.UNKNOWN)) << 16) | (((long) ((byteArrayInputStream.read() ^ a2[3]) & Constants.UNKNOWN)) << 24) | (((long) ((byteArrayInputStream.read() ^ a2[4]) & Constants.UNKNOWN)) << 32) | (((long) ((byteArrayInputStream.read() ^ a2[6]) & Constants.UNKNOWN)) << 48) | (((long) ((byteArrayInputStream.read() ^ a2[7]) & Constants.UNKNOWN)) << 56);
                        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
    ...
    /* renamed from: a */
    private static String m2651a(byte[] bArr) {
        try {
            MessageDigest instance = MessageDigest.getInstance("SHA-1");
            instance.update(bArr);
            return C1155o.m2670a(instance.digest());
    ...
    /* renamed from: a */
    private static byte[] m2652a(String str) {
        return Base64.decode(m2654b(str), 0);
    }

    /* renamed from: a */
    private static byte[] m2653a(String str, byte[] bArr) {
        try {
    ...
    /* renamed from: b */
    private static String m2654b(String str) {
        return str.replace('-', '+').replace('_', '/').replace('*', '=');
    }

    /* renamed from: b */
    private static String m2655b(byte[] bArr) throws UnsupportedEncodingException {
        return m2656c(Base64.encode(bArr, 2));
    }

    /* renamed from: c */
    private static String m2656c(byte[] bArr) throws UnsupportedEncodingException {
