...
public class C1163s {
    /* renamed from: a */
    public static void m2766a(final View view, long j, final Runnable runnable) {
    ...
    /* renamed from: a */
    public static boolean m2767a(int i) {
        return i == 0;
    }

    /* renamed from: a */
    public static boolean m2768a(int i, int i2) {
        return m2767a(i) != m2767a(i2);
    }
    ...
    public static int[] m2769a(int r6, int r7, int r8) {
        /*
            r0 = 2
            r1 = 0
            r2 = 1
        ...
        L_0x0044:
            ...
            goto L_0x007b
        L_0x0047:
            boolean r3 = com.applovin.impl.sdk.utils.C1119g.m2529b()
        ...
        L_0x007b:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.applovin.impl.sdk.utils.C1163s.m2769a(int, int, int):int[]");
    }

    /* renamed from: b */
    public static String m2770b(int i) {
        return i == 0 ? "VISIBLE" : i == 4 ? "INVISIBLE" : i == 8 ? "GONE" : String.valueOf(i);
    }

    /* renamed from: b */
    public static void m2771b(final View view, long j, final Runnable runnable) {
