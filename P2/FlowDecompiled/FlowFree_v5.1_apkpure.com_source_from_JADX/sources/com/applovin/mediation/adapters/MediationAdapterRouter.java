...
public abstract class MediationAdapterRouter {
    ...
    protected MediationAdapterRouter() {
        for (AppLovinSdk next : AppLovinSdk.m2841a()) {
            if (AppLovinMediationProvider.MAX.equalsIgnoreCase(next.getMediationProvider())) {
                this.mSdk = next.coreSdk;
            }
        }
        if (this.mSdk == null) {
            C1107r.m2484i(this.mTag, "Invalid mediation provider detected. Please set AppLovin SDK mediation provider to MAX via AppLovinSdk.getInstance(context).setMediationProvider( AppLovinMediationProvider.MAX )");
        }
    }
    ...
    public void log(String str) {
        C1062k kVar = this.mSdk;
        if (kVar != null) {
            kVar.mo9411z().mo9586c(this.mTag, str);
        }
    }
    ...
    public void log(String str, Throwable th) {
        C1062k kVar = this.mSdk;
        if (kVar != null) {
            kVar.mo9411z().mo9585b(this.mTag, str, th);
        }
    }
