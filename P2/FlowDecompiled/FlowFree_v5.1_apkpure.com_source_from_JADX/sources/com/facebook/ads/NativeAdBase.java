...
@Keep
public abstract class NativeAdBase implements C1419Ad {
    ...
    @Keep
    public interface NativeAdLoadConfigBuilder extends C1419Ad.LoadConfigBuilder {
    ...
    @Keep
    public interface NativeLoadAdConfig extends C1419Ad.LoadAdConfig {
    }
