...
public final class C1664dg {

    /* renamed from: a */
    public static final Set<String> f4215a;

    /* renamed from: b */
    private static X509TrustManagerExtensions f4216b;
    ...
    static {
        ...
        if (Build.VERSION.SDK_INT >= 17) {
            f4216b = new X509TrustManagerExtensions(m4372a());
        }
    }

    /* renamed from: a */
    public static void m4373a(HttpsURLConnection httpsURLConnection) throws SSLException {
        if (Build.VERSION.SDK_INT >= 17 && f4216b != null) {
            String str = "";
            try {
                Certificate[] serverCertificates = httpsURLConnection.getServerCertificates();
                List<X509Certificate> checkServerTrusted = f4216b.checkServerTrusted((X509Certificate[]) Arrays.copyOf(serverCertificates, serverCertificates.length, X509Certificate[].class), "RSA", httpsURLConnection.getURL().getHost());
                if (checkServerTrusted != null) {
                    ...
                    for (X509Certificate next : checkServerTrusted) {
                        ...
                        if (f4215a.contains(encodeToString)) {
                            C1648cy.m4319a("SslPinningValidator", "Found matched pin: ".concat(String.valueOf(encodeToString)));
                            return;
                        }
                ...
                C1648cy.m4320a("SslPinningValidator", "Error in validating pinning: ", (Throwable) e);
            } catch (CertificateException e2) {
                C1648cy.m4320a("SslPinningValidator", "Error in getting certificate: ", (Throwable) e2);
            }
        }
    }
    ...
    private static javax.net.ssl.X509TrustManager m4372a() {
        /*
        ...
        L_0x0015:
            ...
            r3 = r2
        L_0x0017:
            com.flurry.sdk.C1648cy.m4320a((java.lang.String) r1, (java.lang.String) r0, (java.lang.Throwable) r4)
            goto L_0x0020
        L_0x001b:
            r4 = move-exception
            r3 = r2
        ...
        L_0x0038:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.flurry.sdk.C1664dg.m4372a():javax.net.ssl.X509TrustManager");
    }
}
