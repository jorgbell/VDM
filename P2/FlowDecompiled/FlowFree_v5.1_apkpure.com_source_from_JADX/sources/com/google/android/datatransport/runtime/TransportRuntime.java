...
public class TransportRuntime implements TransportInternal {
    ...
    public static void initialize(Context context) {
        if (instance == null) {
            synchronized (TransportRuntime.class) {
                if (instance == null) {
                    TransportRuntimeComponent.Builder builder = DaggerTransportRuntimeComponent.builder();
    ...
    private static Set<Encoding> getSupportedEncodings(Destination destination) {
        ...
        return Collections.singleton(Encoding.m4837of("proto"));
    }
    ...
    private EventInternal convert(SendRequest sendRequest) {
        ...
        builder.setEncodedPayload(new EncodedPayload(sendRequest.getEncoding(), sendRequest.getPayload()));
        builder.setCode(sendRequest.getEvent().getCode());
