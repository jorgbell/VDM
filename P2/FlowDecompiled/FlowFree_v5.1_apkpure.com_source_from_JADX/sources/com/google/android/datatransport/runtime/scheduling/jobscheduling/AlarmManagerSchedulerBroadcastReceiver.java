...
public class AlarmManagerSchedulerBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (queryParameter2 != null) {
            builder.setExtras(Base64.decode(queryParameter2, 0));
        }
        TransportRuntime.getInstance().getUploader().upload(builder.build(), i, AlarmManagerSchedulerBroadcastReceiver$$Lambda$1.lambdaFactory$());
    }
}
