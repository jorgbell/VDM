    ...
    public void logAndUpdateState(TransportContext transportContext, int i) {
        ...
        if (iterable.iterator().hasNext()) {
            if (transportBackend == null) {
                Logging.m4839d("Uploader", "Unknown backend for %s, deleting event batch for it...", (Object) transportContext);
                ...
                BackendRequest.Builder builder = BackendRequest.builder();
                builder.setEvents(arrayList);
                builder.setExtras(transportContext.getExtras());
                backendResponse = transportBackend.send(builder.build());
            }
