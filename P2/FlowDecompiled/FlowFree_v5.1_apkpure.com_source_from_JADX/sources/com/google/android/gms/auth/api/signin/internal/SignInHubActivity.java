...
import com.google.android.gms.internal.p040authapi.zzaz;
    ...
    public void onCreate(Bundle bundle) {
        ...
        if ("com.google.android.gms.auth.NO_IMPL".equals(str)) {
            ...
            if (bundle != null) {
                ...
                intent3.putExtra("config", this.zzcy);
                try {
            ...
            if (i == 40962) {
                if (intent != null) {
                    ...
                    if (signInAccount != null && signInAccount.getGoogleSignInAccount() != null) {
                        ...
                        GoogleSignInOptions zzu = this.zzcy.zzu();
                        zzaz.checkNotNull(googleSignInAccount);
                        zzd.zzc(zzu, googleSignInAccount);
