...
public class MurmurHash3 {
    public static int murmurhash3_x86_32(@RecentlyNonNull byte[] bArr, int i, int i2, int i3) {
        int i4 = (i2 & -4) + i;
        while (i < i4) {
            int i5 = ((bArr[i] & Constants.UNKNOWN) | ((bArr[i + 1] & Constants.UNKNOWN) << 8) | ((bArr[i + 2] & Constants.UNKNOWN) << 16) | (bArr[i + 3] << 24)) * -862048943;
        ...
        if (i7 != 1) {
            if (i7 != 2) {
                if (i7 == 3) {
                    i8 = (bArr[i4 + 2] & Constants.UNKNOWN) << 16;
                }
                int i9 = i3 ^ i2;
            ...
            i8 |= (bArr[i4 + 1] & Constants.UNKNOWN) << 8;
        }
        int i12 = ((bArr[i4] & Constants.UNKNOWN) | i8) * -862048943;
