...
public final class zzawc extends AbstractSafeParcelable {
    ...
    public zzawc(Bundle bundle, zzbbq zzbbq, ApplicationInfo applicationInfo, String str, List<String> list, PackageInfo packageInfo, String str2, String str3, zzdsy zzdsy, String str4) {
        this.zza = bundle;
        this.zzb = zzbbq;
        this.zzd = str;
