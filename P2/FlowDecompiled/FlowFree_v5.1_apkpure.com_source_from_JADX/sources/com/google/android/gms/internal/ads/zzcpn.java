...
public final class zzcpn implements SensorEventListener {
    ...
    public final void onSensorChanged(SensorEvent sensorEvent) {
        if (((Boolean) zzaaa.zzc().zzb(zzaeq.zzfY)).booleanValue()) {
            ...
            float f = this.zzc;
            zzaei zzaei = zzaeq.zzfZ;
            if (floatValue > f + ((Float) zzaaa.zzc().zzb(zzaei)).floatValue()) {
                this.zzc = this.zzd.floatValue();
                this.zzh = true;
            } else if (this.zzd.floatValue() < this.zzc - ((Float) zzaaa.zzc().zzb(zzaei)).floatValue()) {
                this.zzc = this.zzd.floatValue();
                this.zzg = true;
            }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:19:0x0038, code lost:
        com.google.android.gms.internal.ads.zzbbk.zzi("Flick detection failed to initialize. Failed to obtain gyroscope.");
     */
