...
public final class zzdip implements zzdiy<Bundle> {
    ...
    public zzdip(boolean z, boolean z2, String str, boolean z3, int i, int i2, int i3) {
        this.zza = z;
        this.zzb = z2;
        this.zzc = str;
        this.zzd = z3;
    ...
    public final /* bridge */ /* synthetic */ void zzd(Object obj) {
        ...
        bundle.putString("extra_caps", (String) zzaaa.zzc().zzb(zzaeq.zzbV));
        bundle.putInt("target_api", this.zze);
        bundle.putInt("dv", this.zzf);
        bundle.putInt("lv", this.zzg);
        Bundle zza2 = zzdrs.zza(bundle, "sdk_env");
        zza2.putBoolean("mf", zzagd.zza.zze().booleanValue());
        ...
        Bundle zza3 = zzdrs.zza(zza2, "build_meta");
        zza3.putString("cl", "367272508");
