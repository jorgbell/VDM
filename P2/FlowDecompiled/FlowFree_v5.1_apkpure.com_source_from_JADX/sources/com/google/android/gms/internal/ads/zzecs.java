...
public final class zzecs {
    ...
    public static boolean zzc(@NullableDecl String str) {
        return zzeck.zza(str);
    }

    public static String zzd(@NullableDecl String str, @NullableDecl Object... objArr) {
        int length;
        int length2;
        int indexOf;
        String str2;
