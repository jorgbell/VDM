...
final class zzeqv {
    private static long zzb(byte[] bArr, int i) {
        return ((long) (((bArr[i + 3] & Constants.UNKNOWN) << 24) | (bArr[i] & Constants.UNKNOWN) | ((bArr[i + 1] & Constants.UNKNOWN) << 8) | ((bArr[i + 2] & Constants.UNKNOWN) << 16))) & 4294967295L;
    }
        ...
        if (bArr3.length == 32) {
            ...
            while (true) {
                ...
                if (i3 < length) {
                    ...
                    zzd(bArr6, ((((j34 >> 18) | (((j21 & j30) | (j29 & j31)) << 8)) & 4294967295L) + zzb4 + (zzb3 >> 32)) & 4294967295L, 12);
                    return bArr6;
                }
            }
        } else {
