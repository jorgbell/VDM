...
final class zzesp {
    private final zzeso zza;

    private zzesp(zzeso zzeso) {
        zzetr.zzb(zzeso, "output");
        this.zza = zzeso;
        zzeso.zza = this;
    }

    public static zzesp zza(zzeso zzeso) {
        zzesp zzesp = zzeso.zza;
        return zzesp != null ? zzesp : new zzesp(zzeso);
    }
    ...
    public final void zzF(int i, List<zzesf> list) throws IOException {
    ...
    public final void zzn(int i, zzesf zzesf) throws IOException {
        this.zza.zzi(i, zzesf);
    }
    ...
    public final void zzr(int i, Object obj, zzevf zzevf) throws IOException {
        zzeuo zzeuo = (zzeuo) obj;
        zzesm zzesm = (zzesm) this.zza;
        zzesm.zzl((i << 3) | 2);
        ...
        zzesm.zzl(zzap);
        zzevf.zzn(zzeuo, zzesm.zza);
    }

    public final void zzs(int i, Object obj, zzevf zzevf) throws IOException {
        zzeso zzeso = this.zza;
        zzeso.zza(i, 3);
        zzevf.zzn((zzeuo) obj, zzeso.zza);
        zzeso.zza(i, 4);
    }
    ...
    public final void zzC(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzeso.zzv(list.get(i4).intValue());
            }
            this.zza.zzl(i3);
            while (i2 < list.size()) {
    ...
    public final void zzG(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzeso.zzw(list.get(i4).intValue());
            }
            this.zza.zzl(i3);
            while (i2 < list.size()) {
    ...
    public final void zzJ(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            for (int i4 = 0; i4 < list.size(); i4++) {
                ...
                i3 += zzeso.zzw((intValue >> 31) ^ (intValue + intValue));
            }
            this.zza.zzl(i3);
            while (i2 < list.size()) {
                zzeso zzeso = this.zza;
                int intValue2 = list.get(i2).intValue();
                zzeso.zzl((intValue2 >> 31) ^ (intValue2 + intValue2));
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            zzeso zzeso2 = this.zza;
            int intValue3 = list.get(i2).intValue();
            zzeso2.zzc(i, (intValue3 >> 31) ^ (intValue3 + intValue3));
            i2++;
        }
    }
    ...
    public final void zzK(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            for (int i4 = 0; i4 < list.size(); i4++) {
                ...
                i3 += zzeso.zzx((longValue >> 63) ^ (longValue + longValue));
            }
            this.zza.zzl(i3);
            while (i2 < list.size()) {
                zzeso zzeso = this.zza;
                long longValue2 = list.get(i2).longValue();
                zzeso.zzn((longValue2 >> 63) ^ (longValue2 + longValue2));
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            ...
            zzeso2.zze(i, (longValue3 >> 63) ^ (longValue3 + longValue3));
            i2++;
        }
    }
    ...
    public final void zzx(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzeso.zzx(list.get(i4).longValue());
            }
            this.zza.zzl(i3);
            while (i2 < list.size()) {
