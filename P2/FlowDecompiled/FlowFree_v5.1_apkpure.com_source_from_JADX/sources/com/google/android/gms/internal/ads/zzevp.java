...
class zzevp<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    private final int zza;
    /* access modifiers changed from: private */
    public List<zzevm> zzb = Collections.emptyList();
    /* access modifiers changed from: private */
    public Map<K, V> zzc = Collections.emptyMap();
    private boolean zzd;
    private volatile zzevo zze;
    private Map<K, V> zzf = Collections.emptyMap();

    /* synthetic */ zzevp(int i, zzevi zzevi) {
        this.zza = i;
    }
    ...
    public final V zzk(int i) {
        ...
        if (!this.zzc.isEmpty()) {
            ...
            List<zzevm> list = this.zzb;
            Map.Entry entry = (Map.Entry) it.next();
            list.add(new zzevm(this, (Comparable) entry.getKey(), entry.getValue()));
            it.remove();
        }
        return value;
    }
    ...
    public final Set<Map.Entry<K, V>> entrySet() {
        if (this.zze == null) {
            this.zze = new zzevo(this, (zzevi) null);
        }
        return this.zze;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof zzevp)) {
            return super.equals(obj);
        }
        zzevp zzevp = (zzevp) obj;
        int size = size();
        if (size != zzevp.size()) {
            return false;
        }
        int zzc2 = zzc();
        if (zzc2 != zzevp.zzc()) {
            return entrySet().equals(zzevp.entrySet());
        }
        for (int i = 0; i < zzc2; i++) {
            if (!zzd(i).equals(zzevp.zzd(i))) {
                return false;
            }
        }
        if (zzc2 != size) {
            return this.zzc.equals(zzevp.zzc);
        }
        return true;
    }
    ...
    public final V put(K k, V v) {
        ...
        int i2 = this.zza;
        if (size == i2) {
            zzevm remove = this.zzb.remove(i2 - 1);
            zzn().put(remove.zza(), remove.getValue());
        }
        this.zzb.add(i, new zzevm(this, k, v));
        return null;
    }
}
