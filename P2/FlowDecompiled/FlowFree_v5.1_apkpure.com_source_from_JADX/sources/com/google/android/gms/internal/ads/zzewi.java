...
final class zzewi {
    private static final zzewf zza = new zzewg();

    static {
        if (zzewd.zza() && zzewd.zzb()) {
            int i = zzerr.zza;
        }
    }
    ...
    static int zze(CharSequence charSequence, byte[] bArr, int i, int i2) {
        int i3;
        int i4;
        int i5;
        char charAt;
    ...
    static String zzf(byte[] bArr, int i, int i2) throws zzett {
        int i3;
        ...
        if ((i | i2 | ((length - i) - i2)) >= 0) {
            ...
            while (r11 < i4) {
                ...
                if (zzewe.zza(b2)) {
                    ...
                    if (i6 < i4 - 1) {
                        int i8 = i6 + 1;
                        zzewe.zzc(b2, bArr[i6], bArr[i8], cArr, i3);
                        r11 = i8 + 1;
                        i3++;
                    } else {
                        throw zzett.zzj();
                    ...
                    int i9 = i6 + 1;
                    int i10 = i9 + 1;
                    zzewe.zzd(b2, bArr[i6], bArr[i9], bArr[i10], cArr, i3);
                    i3 += 2;
                    r11 = i10 + 1;
                } else {
                    throw zzett.zzj();
    ...
    static /* synthetic */ int zzi(byte[] bArr, int i, int i2) {
        byte b = bArr[i - 1];
        int i3 = i2 - i;
        if (i3 != 0) {
            if (i3 == 1) {
