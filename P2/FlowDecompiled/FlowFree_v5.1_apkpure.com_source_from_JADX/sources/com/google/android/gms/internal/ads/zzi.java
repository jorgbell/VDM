...
public final class zzi {
                                            ...
                                            while (slice.hasRemaining()) {
                                                ...
                                                if (slice.remaining() >= 8) {
                                                    ...
                                                    if (i3 > slice.remaining()) {
                                                        ...
                                                        X509Certificate[][] zzb2 = zzb(randomAccessFile.getChannel(), new zze(zzi(slice, i3 - 4), longValue2, zzb, longValue, byteBuffer2, (zza) null));
    ...
    private static X509Certificate[][] zzb(FileChannel fileChannel, zze zze) throws SecurityException {
    ...
    private static byte[][] zze(int[] iArr, zzc[] zzcArr) throws DigestException {
        long j;
        int i;
        int length;
        int[] iArr2 = iArr;
        ...
        while (true) {
            ...
            j3 += (zzcArr[i3].zza() + 1048575) / 1048576;
            i3++;
        }
        if (j3 < 2097151) {
            int i4 = (int) j3;
            ...
            while (i15 < iArr2.length) {
                ...
                String zzg2 = zzg(i16);
                try {
                    bArr7[i15] = MessageDigest.getInstance(zzg2).digest(bArr8);
                    i15++;
