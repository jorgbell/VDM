...
final class zzoc {
    ...
    private zzlc[] zzg = new zzlc[1000];
    private zzit[] zzh = new zzit[1000];
    private int zzi;
    private int zzj;
    private int zzk;
    private int zzl;
    ...
    public final synchronized zzit zze() {
        if (this.zzp) {
            return null;
        }
        return this.zzq;
    ...
    public final synchronized int zzg(com.google.android.gms.internal.ads.zziu r5, com.google.android.gms.internal.ads.zzkm r6, boolean r7, boolean r8, com.google.android.gms.internal.ads.zzit r9, com.google.android.gms.internal.ads.zzob r10) {
        /*
            r4 = this;
            monitor-enter(r4)
            ...
            return r3
        L_0x0012:
            com.google.android.gms.internal.ads.zzit r6 = r4.zzq     // Catch:{ all -> 0x0092 }
        ...
        L_0x0020:
            ...
            com.google.android.gms.internal.ads.zzit[] r7 = r4.zzh     // Catch:{ all -> 0x0092 }
        ...
        L_0x002b:
            ...
            com.google.android.gms.internal.ads.zzlc[] r5 = r4.zzg     // Catch:{ all -> 0x0092 }
            r5 = r5[r7]     // Catch:{ all -> 0x0092 }
        ...
        L_0x0086:
            ...
            return r2
        L_0x0088:
            com.google.android.gms.internal.ads.zzit[] r6 = r4.zzh     // Catch:{ all -> 0x0092 }
            int r7 = r4.zzk     // Catch:{ all -> 0x0092 }
        ...
        L_0x0092:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzoc.zzg(com.google.android.gms.internal.ads.zziu, com.google.android.gms.internal.ads.zzkm, boolean, boolean, com.google.android.gms.internal.ads.zzit, com.google.android.gms.internal.ads.zzob):int");
    }
    ...
    public final synchronized long zzi(long r10, boolean r12) {
        ...
        L_0x0062:
            goto L_0x0061
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzoc.zzi(long, boolean):long");
    }

    public final synchronized boolean zzj(zzit zzit) {
        if (zzit == null) {
            this.zzp = true;
            return false;
        }
        this.zzp = false;
        if (zzqj.zza(zzit, this.zzq)) {
            return false;
        }
        this.zzq = zzit;
        return true;
    ...
    public final synchronized void zzk(long j, int i, long j2, int i2, zzlc zzlc) {
        if (this.zzo) {
            if ((i & 1) != 0) {
                this.zzo = false;
            } else {
        ...
        if (i4 == i5) {
            ...
            zzlc[] zzlcArr = new zzlc[i6];
            zzit[] zzitArr = new zzit[i6];
            int i7 = this.zzk;
            int i8 = i5 - i7;
            ...
            System.arraycopy(this.zzg, this.zzk, zzlcArr, 0, i8);
            System.arraycopy(this.zzh, this.zzk, zzitArr, 0, i8);
            ...
            System.arraycopy(this.zzg, 0, zzlcArr, i8, i9);
            System.arraycopy(this.zzh, 0, zzitArr, i8, i9);
