...
final class zzqo extends HandlerThread implements SurfaceTexture.OnFrameAvailableListener, Handler.Callback {
    ...
    public final boolean handleMessage(Message message) {
        ...
        if (i == 1) {
            try {
                ...
                zzpu.zze(eglGetDisplay != null, "eglGetDisplay failed");
                int[] iArr = new int[2];
                zzpu.zze(EGL14.eglInitialize(eglGetDisplay, iArr, 0, iArr, 1), "eglInitialize failed");
                EGLConfig[] eGLConfigArr = new EGLConfig[1];
                int[] iArr2 = new int[1];
                EGLConfig[] eGLConfigArr2 = eGLConfigArr;
                zzpu.zze(EGL14.eglChooseConfig(eglGetDisplay, new int[]{12352, 4, 12324, 8, 12323, 8, 12322, 8, 12321, 8, 12325, 0, 12327, 12344, 12339, 4, 12344}, 0, eGLConfigArr, 0, 1, iArr2, 0) && iArr2[0] > 0 && eGLConfigArr2[0] != null, "eglChooseConfig failed");
                ...
                zzpu.zze(eglCreateContext != null, "eglCreateContext failed");
                ...
                zzpu.zze(eglCreatePbufferSurface != null, "eglCreatePbufferSurface failed");
                zzpu.zze(EGL14.eglMakeCurrent(eglGetDisplay, eglCreatePbufferSurface, eglCreatePbufferSurface, eglCreateContext), "eglMakeCurrent failed");
                ...
                this.zzf = new zzqp(this, this.zzc, z, (zzqn) null);
                synchronized (this) {
                    notify();
                }
    ...
    public final zzqp zza(boolean z) {
        boolean z2;
        start();
