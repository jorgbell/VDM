...
public final class zzts extends AbstractSafeParcelable {
    public static final Parcelable.Creator<zzts> CREATOR = new zztt();
    ...
    zzts(String str, long j, String str2, String str3, String str4, Bundle bundle, boolean z, long j2, String str5, int i) {
        this.zza = str;
        this.zzb = j;
    ...
    public static zzts zza(Uri uri) {
        long parseLong;
        Uri uri2 = uri;
        try {
            ...
            return new zzts(queryParameter, j, host, str, str2, bundle, equals, 0, "", 0);
        } catch (NullPointerException | NumberFormatException e) {
            zzbbk.zzj("Unable to parse Uri into cache offering.", e);
            return null;
        }
    }
