...
class zzgp extends zzgo {
    ...
    public final boolean equals(Object obj) {
        ...
        } else if (!(zzgp instanceof zzgp)) {
            return zzgp.zze(0, zzc).equals(zze(0, zzc));
        } else {
            byte[] bArr = this.zza;
            byte[] bArr2 = zzgp.zza;
            zzgp.zzd();
    ...
    /* access modifiers changed from: package-private */
    public final void zzf(zzgi zzgi) throws IOException {
        ((zzgw) zzgi).zzp(this.zza, 0, zzc());
    }
