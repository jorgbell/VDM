...
final class zzgw extends zzgy {
    ...
    public final void zzi(int i, zzgr zzgr) throws IOException {
        zzl((i << 3) | 2);
        zzl(zzgr.zzc());
        zzgr.zzf(this);
    }
    ...
    public final void zzl(int i) throws IOException {
        ...
        try {
            ...
            throw new zzgx(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.zzd), Integer.valueOf(this.zzc), 1}), e);
        }
    }
    ...
    public final void zzr(String str) throws IOException {
        ...
        try {
            ...
            if (zzw2 == zzw) {
                int i2 = i + zzw2;
                this.zzd = i2;
                int zzd2 = zzkk.zzd(str, this.zzb, i2, this.zzc - i2);
                this.zzd = i;
                zzl((zzd2 - i) - zzw2);
                this.zzd = zzd2;
                return;
            ...
            byte[] bArr = this.zzb;
            int i3 = this.zzd;
            this.zzd = zzkk.zzd(str, bArr, i3, this.zzc - i3);
        } catch (zzkj e) {
            this.zzd = i;
            zzD(str, e);
    ...
    public final void zzp(byte[] bArr, int i, int i2) throws IOException {
        try {
            ...
            throw new zzgx(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.zzd), Integer.valueOf(this.zzc), Integer.valueOf(i2)}), e);
        }
    }

    public final void zzn(long j) throws IOException {
        if (!zzgy.zzc || this.zzc - this.zzd < 10) {
            while ((j & -128) != 0) {
                byte[] bArr = this.zzb;
                int i = this.zzd;
                this.zzd = i + 1;
            ...
            while ((j & -128) != 0) {
                ...
                int i3 = this.zzd;
                this.zzd = i3 + 1;
                zzkf.zzp(bArr3, (long) i3, (byte) ((((int) j) & 127) | 128));
                j >>>= 7;
            }
            byte[] bArr4 = this.zzb;
            int i4 = this.zzd;
            this.zzd = i4 + 1;
            zzkf.zzp(bArr4, (long) i4, (byte) ((int) j));
        }
    }
}
