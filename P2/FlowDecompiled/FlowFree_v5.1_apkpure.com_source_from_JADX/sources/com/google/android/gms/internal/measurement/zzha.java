...
final class zzha extends zzgd<Double> implements RandomAccess, zzhy, zzjd {
    private static final zzha zza;
    private double[] zzb;
    private int zzc;

    static {
        zzha zzha = new zzha(new double[0], 0);
        zza = zzha;
        zzha.zzb();
    }
    ...
    public final boolean addAll(Collection<? extends Double> collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzha.zzb, 0, this.zzb, this.zzc, zzha.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        zzha zzha = (zzha) obj;
        if (this.zzc != zzha.zzc) {
            return false;
        }
        double[] dArr = zzha.zzb;
    ...
    public final int hashCode() {
        ...
        for (int i2 = 0; i2 < this.zzc; i2++) {
            i = (i * 31) + zzhz.zze(Double.doubleToLongBits(this.zzb[i2]));
        }
        return i;
    }
