...
final class zzhs extends zzgd<Integer> implements RandomAccess, zzhw, zzjd {
    private static final zzhs zza;
    private int[] zzb;
    private int zzc;

    static {
        zzhs zzhs = new zzhs(new int[0], 0);
        zza = zzhs;
        zzhs.zzb();
    }
    ...
    public final zzhw zze(int i) {
        if (i >= this.zzc) {
            return new zzhs(Arrays.copyOf(this.zzb, i), this.zzc);
        }
