...
final class zzil extends zzgd<Long> implements RandomAccess, zzhx, zzjd {
    private static final zzil zza;
    private long[] zzb;
    private int zzc;

    static {
        zzil zzil = new zzil(new long[0], 0);
        zza = zzil;
        zzil.zzb();
    }
    ...
    public final zzhx zze(int i) {
        if (i >= this.zzc) {
            return new zzil(Arrays.copyOf(this.zzb, i), this.zzc);
        }
