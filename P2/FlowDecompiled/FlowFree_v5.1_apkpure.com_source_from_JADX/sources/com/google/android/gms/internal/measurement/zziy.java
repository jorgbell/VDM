...
final class zziy {
    static String zza(zziw zziw, String str) {
    ...
    static final void zzb(StringBuilder sb, int i, String str, Object obj) {
        if (obj instanceof List) {
            ...
            if (obj instanceof String) {
                sb.append(": \"");
                sb.append(zzjt.zza(zzgr.zzk((String) obj)));
                sb.append('\"');
            } else if (obj instanceof zzgr) {
                sb.append(": \"");
                sb.append(zzjt.zza((zzgr) obj));
                sb.append('\"');
            } else if (obj instanceof zzhr) {
                sb.append(" {");
                zzc((zzhr) obj, sb, i + 2);
                sb.append("\n");
                while (i2 < i) {
    ...
    private static void zzc(zziw zziw, StringBuilder sb, int i) {
        String str;
        boolean z;
        String str2;
        String str3;
        ...
        for (Method method : zziw.getClass().getDeclaredMethods()) {
        ...
        for (String str4 : treeSet) {
            ...
            if (substring.endsWith("List") && !substring.endsWith("OrBuilderList") && !substring.equals("List")) {
                ...
                if (method2 != null && method2.getReturnType().equals(List.class)) {
                    zzb(sb, i, zzd(str3), zzhr.zzbA(method2, zziw, new Object[0]));
                }
            }
            if (substring.endsWith("Map") && !substring.equals("Map")) {
                ...
                if (method3 != null && method3.getReturnType().equals(Map.class) && !method3.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method3.getModifiers())) {
                    zzb(sb, i, zzd(str2), zzhr.zzbA(method3, zziw, new Object[0]));
                }
            }
            ...
            if (((Method) hashMap2.get(valueOf5.length() != 0 ? "set".concat(valueOf5) : new String("set"))) != null) {
                ...
                if (method4 != null) {
                    Object zzbA = zzhr.zzbA(method4, zziw, new Object[0]);
                    if (method5 == null) {
                        if (zzbA instanceof Boolean) {
                            ...
                            if (zzbA instanceof String) {
                                ...
                                z = zzbA.equals(zzgr.zzb);
                            } else if (zzbA instanceof zziw) {
                                if (zzbA == ((zziw) zzbA).zzbK()) {
                                }
                    ...
                    } else if (!((Boolean) zzhr.zzbA(method5, zziw, new Object[0])).booleanValue()) {
                    }
                    zzb(sb, i, zzd(concat), zzbA);
                }
            }
        }
        if (!(zziw instanceof zzho)) {
            zzjw zzjw = ((zzhr) zziw).zzc;
            if (zzjw != null) {
                zzjw.zzg(sb, i);
                return;
            }
