...
class zzjr<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public List<zzjo> zzb = Collections.emptyList();
    /* access modifiers changed from: private */
    ...
    /* synthetic */ zzjr(int i, zzjk zzjk) {
        this.zza = i;
    }
    ...
    public final Set<Map.Entry<K, V>> entrySet() {
        if (this.zze == null) {
            this.zze = new zzjq(this, (zzjk) null);
        }
        return this.zze;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        int zzc2 = zzc();
        if (zzc2 != zzjr.zzc()) {
            return entrySet().equals(zzjr.entrySet());
        }
        for (int i = 0; i < zzc2; i++) {
            if (!zzd(i).equals(zzjr.zzd(i))) {
                return false;
            }
        }
        if (zzc2 != size) {
            return this.zzc.equals(zzjr.zzc);
        }
        return true;
    }
    ...
    public final V put(K k, V v) {
        ...
        int i2 = this.zza;
        if (size == i2) {
            zzjo remove = this.zzb.remove(i2 - 1);
