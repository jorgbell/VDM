...
final class zzkk {
    private static final zzkh zza = new zzki();
    ...
    static String zze(byte[] bArr, int i, int i2) throws zzib {
        int i3;
        ...
        if ((i | i2 | ((length - i) - i2)) >= 0) {
            ...
            while (r11 < i4) {
                ...
                if (zzkg.zza(b2)) {
                    ...
                    if (i6 < i4 - 1) {
                        int i8 = i6 + 1;
                        zzkg.zzc(b2, bArr[i6], bArr[i8], cArr, i3);
                        r11 = i8 + 1;
                        i3++;
                    } else {
                        throw zzib.zzf();
                    ...
                    int i9 = i6 + 1;
                    int i10 = i9 + 1;
                    zzkg.zzd(b2, bArr[i6], bArr[i9], bArr[i10], cArr, i3);
                    i3 += 2;
                    r11 = i10 + 1;
                } else {
                    throw zzib.zzf();
