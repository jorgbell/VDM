...
public final class zzd extends zze {
    ...
    static /* synthetic */ void zze(zzd zzd, String str, long j) {
        ...
        Integer num = zzd.zzb.get(str);
        if (num != null) {
            zzhy zzh = zzd.zzs.zzx().zzh(false);
    ...
    private final void zzh(long j, zzhy zzhy) {
        if (zzhy == null) {
            ...
            zzif.zzm(zzhy, bundle, true);
            this.zzs.zzk().zzs("am", "_xa", bundle);
        }
    }

    private final void zzi(String str, long j, zzhy zzhy) {
        if (zzhy == null) {
