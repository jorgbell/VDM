...
public final class zzea {
    ...
    public static final zzdz<Integer> zzax = zzb("measurement.service.storage_consent_support_version", 203600, 203600, zzdk.zza);
    ...
    public static final zzdz<String> zzd = zzb("measurement.config.url_scheme", Constants.HTTPS, Constants.HTTPS, zzcb.zza);
    ...
    static {
        ...
        zzV = zzb("measurement.quality.checksum", bool, bool, (zzdx) null);
        ...
        zzb("measurement.collection.synthetic_data_mitigation", bool, bool, zzde.zza);
        zzat = zzb("measurement.androidId.delete_feature", bool2, bool2, zzdf.zza);
        zzau = zzb("measurement.client.consent_state_v1", bool2, bool2, zzdg.zza);
        zzav = zzb("measurement.client.3p_consent_state_v1", bool2, bool2, zzdh.zza);
        zzaw = zzb("measurement.service.consent_state_v1_W36", bool2, bool2, zzdj.zza);
        zzay = zzb("measurement.upload.directly_maybe_log_error_events", bool2, bool2, zzdl.zza);
        zzaz = zzb("measurement.frontend.directly_maybe_log_error_events", bool, bool, zzdm.zza);
        zzaA = zzb("measurement.client.properties.non_null_origin", bool2, bool2, zzdn.zza);
        zzb("measurement.client.click_identifier_control.dev", bool, bool, zzdo.zza);
        zzb("measurement.service.click_identifier_control", bool, bool, zzdp.zza);
        zzaD = zzb("measurement.client.reject_blank_user_id", bool2, bool2, zzdq.zza);
        zzaE = zzb("measurement.config.persist_last_modified", bool, bool, zzdr.zza);
        zzaF = zzb("measurement.client.consent.suppress_1p_in_ga4f_install", bool2, bool2, zzds.zza);
    }

    public static Map<String, String> zza(Context context) {
        zzeo zza2 = zzeo.zza(context.getContentResolver(), zzey.zza("com.google.android.gms.measurement"));
