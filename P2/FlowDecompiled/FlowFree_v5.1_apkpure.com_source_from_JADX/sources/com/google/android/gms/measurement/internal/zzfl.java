...
final class zzfl extends Thread {
    final /* synthetic */ zzfm zza;
    private final Object zzb;
    private final BlockingQueue<zzfk<?>> zzc;
    private boolean zzd = false;

    public zzfl(zzfm zzfm, String str, BlockingQueue<zzfk<?>> blockingQueue) {
        this.zza = zzfm;
        ...
        synchronized (this.zza.zzg) {
            if (!this.zzd) {
                ...
                if (this == this.zza.zza) {
                    zzfl unused = this.zza.zza = null;
                } else if (this == this.zza.zzb) {
                    zzfl unused2 = this.zza.zzb = null;
                } else {
    ...
    public final void run() {
        ...
        L_0x0002:
            ...
            com.google.android.gms.measurement.internal.zzfm r2 = r6.zza     // Catch:{ InterruptedException -> 0x000f }
        ...
        L_0x001c:
            java.util.concurrent.BlockingQueue<com.google.android.gms.measurement.internal.zzfk<?>> r2 = r6.zzc     // Catch:{ all -> 0x0082 }
            java.lang.Object r2 = r2.poll()     // Catch:{ all -> 0x0082 }
            com.google.android.gms.measurement.internal.zzfk r2 = (com.google.android.gms.measurement.internal.zzfk) r2     // Catch:{ all -> 0x0082 }
        ...
        L_0x0035:
            ...
            java.util.concurrent.BlockingQueue<com.google.android.gms.measurement.internal.zzfk<?>> r3 = r6.zzc     // Catch:{ all -> 0x007f }
            java.lang.Object r3 = r3.peek()     // Catch:{ all -> 0x007f }
            if (r3 != 0) goto L_0x0051
            com.google.android.gms.measurement.internal.zzfm r3 = r6.zza     // Catch:{ all -> 0x007f }
        ...
        L_0x0051:
            ...
            com.google.android.gms.measurement.internal.zzfm r2 = r6.zza     // Catch:{ all -> 0x0082 }
            java.lang.Object r2 = r2.zzg     // Catch:{ all -> 0x0082 }
            monitor-enter(r2)     // Catch:{ all -> 0x0082 }
            java.util.concurrent.BlockingQueue<com.google.android.gms.measurement.internal.zzfk<?>> r3 = r6.zzc     // Catch:{ all -> 0x007c }
            java.lang.Object r3 = r3.peek()     // Catch:{ all -> 0x007c }
            if (r3 != 0) goto L_0x007a
            com.google.android.gms.measurement.internal.zzfm r0 = r6.zza     // Catch:{ all -> 0x007c }
            com.google.android.gms.measurement.internal.zzfp r0 = r0.zzs     // Catch:{ all -> 0x007c }
        ...
        L_0x0088:
            goto L_0x0087
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.zzfl.run():void");
    }
