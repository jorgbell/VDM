...
public final class zzfm extends zzgj {
    ...
    /* access modifiers changed from: private */
    public zzfl zzb;
    private final PriorityBlockingQueue<zzfk<?>> zzc = new PriorityBlockingQueue<>();
    private final BlockingQueue<zzfk<?>> zzd = new LinkedBlockingQueue();
    private final Thread.UncaughtExceptionHandler zze = new zzfj(this, "Thread death: Uncaught exception on worker thread");
    private final Thread.UncaughtExceptionHandler zzf = new zzfj(this, "Thread death: Uncaught exception on network thread");
    /* access modifiers changed from: private */
    ...
    private final void zzt(zzfk<?> zzfk) {
        synchronized (this.zzg) {
            this.zzc.add(zzfk);
            zzfl zzfl = this.zza;
            if (zzfl == null) {
                zzfl zzfl2 = new zzfl(this, "Measurement Worker", this.zzc);
                this.zza = zzfl2;
                zzfl2.setUncaughtExceptionHandler(this.zze);
                this.zza.start();
            } else {
                zzfl.zza();
            }
    ...
    public final <V> Future<V> zze(Callable<V> callable) throws IllegalStateException {
        ...
        zzfk zzfk = new zzfk(this, callable, false, "Task exception on worker thread");
    ...
    public final <V> Future<V> zzf(Callable<V> callable) throws IllegalStateException {
        zzv();
        Preconditions.checkNotNull(callable);
        zzfk zzfk = new zzfk(this, callable, true, "Task exception on worker thread");
        if (Thread.currentThread() == this.zza) {
            zzfk.run();
        } else {
            zzt(zzfk);
    ...
    public final void zzh(Runnable runnable) throws IllegalStateException {
        ...
        zzt(new zzfk(this, runnable, false, "Task exception on worker thread"));
    }
    ...
    public final <T> T zzi(java.util.concurrent.atomic.AtomicReference<T> r2, long r3, java.lang.String r5, java.lang.Runnable r6) {
        /*
            r1 = this;
            monitor-enter(r2)
            com.google.android.gms.measurement.internal.zzfp r0 = r1.zzs     // Catch:{ all -> 0x0058 }
            com.google.android.gms.measurement.internal.zzfm r0 = r0.zzav()     // Catch:{ all -> 0x0058 }
        ...
        L_0x0034:
            return r2
        L_0x0035:
            com.google.android.gms.measurement.internal.zzfp r3 = r1.zzs     // Catch:{ all -> 0x0058 }
        ...
        L_0x0058:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.zzfm.zzi(java.util.concurrent.atomic.AtomicReference, long, java.lang.String, java.lang.Runnable):java.lang.Object");
    }

    public final void zzj(Runnable runnable) throws IllegalStateException {
        zzv();
        Preconditions.checkNotNull(runnable);
        zzt(new zzfk(this, runnable, true, "Task exception on worker thread"));
    }

    public final void zzk(Runnable runnable) throws IllegalStateException {
        zzv();
        Preconditions.checkNotNull(runnable);
        zzfk zzfk = new zzfk(this, runnable, false, "Task exception on network thread");
        synchronized (this.zzg) {
            this.zzd.add(zzfk);
            zzfl zzfl = this.zzb;
            if (zzfl == null) {
                zzfl zzfl2 = new zzfl(this, "Measurement Network", this.zzd);
                this.zzb = zzfl2;
                zzfl2.setUncaughtExceptionHandler(this.zzf);
                this.zzb.start();
            } else {
                zzfl.zza();
            }
