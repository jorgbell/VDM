...
final class zzhu implements Runnable {
    ...
    public zzhu(zzhv zzhv, String str, URL url, byte[] bArr, Map map, zzfn zzfn, byte[] bArr2) {
        this.zza = zzhv;
    ...
    private final void zzb(int i, Exception exc, byte[] bArr, Map<String, List<String>> map) {
        this.zza.zzs.zzav().zzh(new zzht(this, i, exc, bArr, map));
    }
    ...
    public final void run() {
        /*
            r9 = this;
            com.google.android.gms.measurement.internal.zzhv r0 = r9.zza
            r0.zzaw()
            r0 = 0
            r1 = 0
            com.google.android.gms.measurement.internal.zzhv r2 = r9.zza     // Catch:{ IOException -> 0x006c, all -> 0x005e }
