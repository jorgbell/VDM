...
public final class zzjf extends zzf {
    ...
    protected zzjf(zzfp zzfp) {
        super(zzfp);
        this.zze = new zzjv(zzfp.zzay());
        this.zza = new zzje(this);
        this.zzd = new zzip(this, zzfp);
        this.zzg = new zzir(this, zzfp);
    }

    static /* synthetic */ void zzJ(zzjf zzjf, ComponentName componentName) {
        zzjf.zzg();
        if (zzjf.zzb != null) {
            zzjf.zzb = null;
            zzjf.zzs.zzau().zzk().zzb("Disconnected from device MeasurementService", componentName);
            zzjf.zzg();
            zzjf.zzB();
        }
    }
    ...
    public final void zzA(Bundle bundle) {
        zzg();
        zzb();
        zzQ(new zzio(this, zzS(false), bundle));
    }
    ...
    public final boolean zzD() {
        /*
            ...
            r6.zzg()
            r6.zzb()
            com.google.android.gms.measurement.internal.zzfp r0 = r6.zzs
        ...
        L_0x0034:
            ...
            goto L_0x0143
        L_0x003f:
            com.google.android.gms.measurement.internal.zzfp r4 = r6.zzs
            r4.zzat()
            com.google.android.gms.measurement.internal.zzfp r4 = r6.zzs
        ...
        L_0x0053:
            ...
            r4.zza(r5)
            com.google.android.gms.measurement.internal.zzfp r4 = r6.zzs
            com.google.android.gms.measurement.internal.zzkp r4 = r4.zzl()
    ...
    public final void zzG(zzt zzt, zzas zzas, String str) {
        zzg();
        zzb();
        if (this.zzs.zzl().zzaa(GooglePlayServicesUtilLight.GOOGLE_PLAY_SERVICES_VERSION_CODE) != 0) {
            ...
            this.zzs.zzl().zzag(zzt, new byte[0]);
            return;
        }
        zzQ(new zziq(this, zzas, str, zzt));
    }
    ...
    public final boolean zzH() {
        zzg();
        zzb();
        if (!this.zzs.zzc().zzn((String) null, zzea.zzaw)) {
            return false;
        }
        if (!zzD() || this.zzs.zzl().zzZ() >= zzea.zzax.zzb(null).intValue()) {
            return true;
        }
        return false;
    }
        ...
        while (i2 < 1001 && i3 == 100) {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                ...
                if (abstractSafeParcelable2 instanceof zzas) {
                    ...
                    try {
                        zzed.zze((zzkl) abstractSafeParcelable2, zzp);
    ...
    public final void zzl(zzas zzas, String str) {
        ...
        zzb();
        zzO();
        zzQ(new zziu(this, true, zzS(true), this.zzs.zzn().zzi(zzas), zzas, str));
    }
    ...
    public final void zzm(zzaa zzaa) {
        ...
        zzb();
        this.zzs.zzat();
        zzQ(new zziv(this, true, zzS(true), this.zzs.zzn().zzk(zzaa), new zzaa(zzaa), zzaa));
    }
    ...
    public final void zzn(AtomicReference<List<zzaa>> atomicReference, String str, String str2, String str3) {
        zzg();
        zzb();
        zzQ(new zziw(this, atomicReference, (String) null, str2, str3, zzS(false)));
    }

    /* access modifiers changed from: protected */
    public final void zzo(zzt zzt, String str, String str2) {
        zzg();
        zzb();
        zzQ(new zzix(this, str, str2, zzS(false), zzt));
    }
    ...
    public final void zzq(AtomicReference<List<zzkl>> atomicReference, String str, String str2, String str3, boolean z) {
        zzg();
        zzb();
        zzQ(new zziy(this, atomicReference, (String) null, str2, str3, zzS(false), z));
    }

    /* access modifiers changed from: protected */
    public final void zzr(zzt zzt, String str, String str2, boolean z) {
        zzg();
        zzb();
        zzQ(new zzig(this, str, str2, zzS(false), z, zzt));
    }

    /* access modifiers changed from: protected */
    public final void zzs(zzkl zzkl) {
        zzg();
        zzb();
        zzO();
        zzQ(new zzih(this, zzS(true), this.zzs.zzn().zzj(zzkl), zzkl));
    }
    ...
    public final void zzu() {
        ...
        zzO();
        this.zzs.zzn().zzh();
        zzQ(new zzij(this, zzS));
    }

    public final void zzv(AtomicReference<String> atomicReference) {
        zzg();
        zzb();
        zzQ(new zzik(this, atomicReference, zzS(false)));
    }

    public final void zzx(zzt zzt) {
        zzg();
        zzb();
        zzQ(new zzil(this, zzS(false), zzt));
    }
    ...
    public final void zzy() {
        ...
        zzp zzS = zzS(true);
        this.zzs.zzn().zzm();
        zzQ(new zzim(this, zzS));
    }

    /* access modifiers changed from: protected */
    public final void zzz(zzhy zzhy) {
        zzg();
        zzb();
        zzQ(new zzin(this, zzhy));
    }
}
