...
public final class zzjx extends zzjz {
    ...
    protected zzjx(zzki zzki) {
        super(zzki);
    }

    private final zzal zzf() {
        if (this.zzb == null) {
            this.zzb = new zzjw(this, this.zzf.zzO());
        }
        return this.zzb;
    }
    ...
    public final void zzc(long j) {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            zzh.zza(zzax2, new JobInfo.Builder(zzi, componentName).setMinimumLatency(j).setOverrideDeadline(j + j).setExtras(persistableBundle).build(), "com.google.android.gms", "UploadAlarm");
            return;
        }
        AlarmManager alarmManager = this.zza;
        if (alarmManager != null) {
