...
public final class zzkp extends zzgj {
    ...
    public static ArrayList<Bundle> zzak(List<zzaa> list) {
        ...
        for (zzaa next : list) {
            ...
            bundle.putString(MediationMetaData.KEY_NAME, next.zzc.zzb);
            zzgl.zza(bundle, next.zzc.zza());
            ...
            zzas zzas = next.zzg;
            if (zzas != null) {
                bundle.putString("timed_out_event_name", zzas.zza);
                zzaq zzaq = next.zzg.zzb;
                if (zzaq != null) {
                    bundle.putBundle("timed_out_event_params", zzaq.zzf());
                }
            }
            bundle.putLong("trigger_timeout", next.zzh);
            zzas zzas2 = next.zzi;
            if (zzas2 != null) {
                bundle.putString("triggered_event_name", zzas2.zza);
                zzaq zzaq2 = next.zzi.zzb;
                if (zzaq2 != null) {
                    bundle.putBundle("triggered_event_params", zzaq2.zzf());
                }
            }
            ...
            zzas zzas3 = next.zzk;
            if (zzas3 != null) {
                bundle.putString("expired_event_name", zzas3.zza);
                zzaq zzaq3 = next.zzk.zzb;
                if (zzaq3 != null) {
                    bundle.putBundle("expired_event_params", zzaq3.zzf());
                }
            }
    ...
    public final int zzD(java.lang.String r15, java.lang.String r16, java.lang.String r17, java.lang.Object r18, android.os.Bundle r19, java.util.List<java.lang.String> r20, boolean r21, boolean r22) {
        /*
            ...
            java.lang.String[] r2 = com.google.android.gms.measurement.internal.zzgn.zzc
        ...
        L_0x0022:
            ...
            com.google.android.gms.measurement.internal.zzjf r2 = r2.zzy()
            r2.zzg()
            r2.zzb()
            boolean r6 = r2.zzD()
        ...
        L_0x0060:
            ...
            com.google.android.gms.measurement.internal.zzfp r10 = r7.zzs
            ...
            com.google.android.gms.measurement.internal.zzfp r6 = r7.zzs
            r6.zzc()
        ...
        L_0x0172:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.zzkp.zzD(java.lang.String, java.lang.String, java.lang.String, java.lang.Object, android.os.Bundle, java.util.List, boolean, boolean):int");
    }
    ...
    public final android.os.Bundle zzF(java.lang.String r21, java.lang.String r22, android.os.Bundle r23, java.util.List<java.lang.String> r24, boolean r25) {
        /*
            ...
            r11 = r23
            r12 = r24
            java.lang.String[] r0 = com.google.android.gms.measurement.internal.zzgm.zzd
        ...
        L_0x0122:
            return r14
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.zzkp.zzF(java.lang.String, java.lang.String, android.os.Bundle, java.util.List, boolean):android.os.Bundle");
    }
    ...
    /* access modifiers changed from: package-private */
    public final void zzM(zzko zzko, String str, int i, String str2, String str3, int i2, boolean z) {
        Bundle bundle = new Bundle();
        zzan(bundle, i);
    ...
    public final void zzad(zzt zzt, String str) {
        Bundle bundle = new Bundle();
    ...
    public final void zzae(zzt zzt, long j) {
        Bundle bundle = new Bundle();
        bundle.putLong("r", j);
        try {
            zzt.zzb(bundle);
    ...
    public final void zzaf(zzt zzt, int i) {
        Bundle bundle = new Bundle();
        bundle.putInt("r", i);
        try {
            zzt.zzb(bundle);
    ...
    public final void zzag(zzt zzt, byte[] bArr) {
        Bundle bundle = new Bundle();
    ...
    public final void zzah(zzt zzt, boolean z) {
        Bundle bundle = new Bundle();
    ...
    public final void zzai(zzt zzt, Bundle bundle) {
        try {
            zzt.zzb(bundle);
        } catch (RemoteException e) {
    ...
    public final void zzaj(zzt zzt, ArrayList<Bundle> arrayList) {
        Bundle bundle = new Bundle();
    ...
    public final URL zzal(long j, String str, String str2, long j2) {
        try {
            ...
            Preconditions.checkNotEmpty(str);
            String format = String.format("https://www.googleadservices.com/pagead/conversion/app/deeplink?id_type=adid&sdk_version=%s&rdid=%s&bundleid=%s&retry=%s", new Object[]{String.format("v%s.%s", new Object[]{39065L, Integer.valueOf(zzZ())}), str2, str, Long.valueOf(j2)});
    ...
    public final int zzn(String str) {
        ...
        if (!zzl("event", zzgm.zza, zzgm.zzb, str)) {
            return 13;
        }
        this.zzs.zzc();
        if (!zzm("event", 40, str)) {
    ...
    public final int zzo(String str) {
        ...
        if (!zzl("user property", zzgo.zza, (String[]) null, str)) {
            return 15;
        }
        this.zzs.zzc();
            ...
            for (String str6 : new TreeSet(bundle.keySet())) {
                ...
                if (i != 0) {
                    ...
                    if (i2 != 0 && !"_ev".equals(str4)) {
                        ...
                        bundle2.remove(str4);
                    } else if (zzh(str4) && !zzas(str4, zzgn.zzd) && (i3 = i3 + 1) > 0) {
