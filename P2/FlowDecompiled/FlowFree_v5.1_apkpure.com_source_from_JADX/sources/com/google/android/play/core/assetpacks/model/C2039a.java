...
public final class C2039a {
    ...
    /* renamed from: a */
    private static final Map<Integer, String> f5123a;

    /* renamed from: b */
    private static final Map<Integer, String> f5124b;
    ...
    public static String m5106a(int i) {
        Map<Integer, String> map = f5123a;
        Integer valueOf = Integer.valueOf(i);
        if (!map.containsKey(valueOf)) {
            return "";
        }
        String str = map.get(valueOf);
        String str2 = f5124b.get(valueOf);
