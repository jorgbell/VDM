...
public final class C2088bp {

    /* renamed from: a */
    private static final C2058ag f5191a = new C2058ag("PhoneskyVerificationUtils");

    /* renamed from: a */
    public static boolean m5239a(Context context) {
        try {
            Signature[] signatureArr = context.getPackageManager().getPackageInfo("com.android.vending", 64).signatures;
            if (signatureArr == null || (r1 = signatureArr.length) == 0) {
                f5191a.mo22028e("Phonesky package is not signed -- possibly self-built package. Could not verify.", new Object[0]);
                return false;
            }
            for (Signature byteArray : signatureArr) {
                String b = C2150p.m5401b(byteArray.toByteArray());
    ...
    /* renamed from: b */
    public static boolean m5240b(Context context) {
