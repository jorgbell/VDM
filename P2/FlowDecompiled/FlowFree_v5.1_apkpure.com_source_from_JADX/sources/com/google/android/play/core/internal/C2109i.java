...
public final class C2109i {
    /* renamed from: a */
    static Pair<ByteBuffer, Long> m5269a(RandomAccessFile randomAccessFile) throws IOException {
        if (randomAccessFile.length() < 22) {
            return null;
        }
        Pair<ByteBuffer, Long> h = m5276h(randomAccessFile, 0);
        return h != null ? h : m5276h(randomAccessFile, 65535);
    }

    /* renamed from: b */
    public static long m5270b(ByteBuffer byteBuffer) {
        m5277i(byteBuffer);
        return m5278j(byteBuffer, byteBuffer.position() + 16);
    }

    /* renamed from: c */
    public static void m5271c(ByteBuffer byteBuffer, long j) {
        m5277i(byteBuffer);
    ...
    /* renamed from: d */
    public static long m5272d(ByteBuffer byteBuffer) {
        m5277i(byteBuffer);
        return m5278j(byteBuffer, byteBuffer.position() + 12);
    }

    /* renamed from: e */
    public static String m5273e(String str, String str2) {
    ...
    /* renamed from: f */
    public static String m5274f(String str, String str2, String str3) {
    ...
    /* renamed from: g */
    public static X509Certificate[][] m5275g(String str) throws C2106f, SecurityException, IOException {
        ByteBuffer byteBuffer;
        int limit;
        int position;
        RandomAccessFile randomAccessFile = new RandomAccessFile(str, "r");
        try {
            Pair<ByteBuffer, Long> a = m5269a(randomAccessFile);
            if (a != null) {
                ...
                if (j >= 0) {
                    ...
                    if (randomAccessFile.readInt() == 1347094023) {
                        throw new C2106f("ZIP64 APK not supported");
                    }
                }
                long b = m5270b(byteBuffer2);
                if (b >= longValue) {
                    ...
                    sb.append(longValue);
                    throw new C2106f(sb.toString());
                } else if (m5272d(byteBuffer2) + b != longValue) {
                    throw new C2106f("ZIP Central Directory is not immediately followed by End of Central Directory");
                } else if (b >= 32) {
                                            ...
                                            while (slice.hasRemaining()) {
                                                ...
                                                if (slice.remaining() >= 8) {
                                                    ...
                                                    if (i3 > slice.remaining()) {
                                                        ...
                                                        throw new C2106f(sb4.toString());
                                                    } else if (slice.getInt() == 1896449818) {
                                                        X509Certificate[][] k = m5279k(randomAccessFile.getChannel(), new C2105e(m5286r(slice, i3 - 4), longValue2, b, longValue, byteBuffer2));
                                                    ...
                                                    sb5.append(i);
                                                    throw new C2106f(sb5.toString());
                                                }
                                            }
                                            throw new C2106f("No APK Signature Scheme v2 block in APK Signing Block");
                                        }
                ...
                sb11.append(length);
                sb11.append(" bytes");
                throw new C2106f(sb11.toString());
            }
        } catch (Throwable th) {
            try {
                randomAccessFile.close();
    ...
    /* renamed from: h */
    private static Pair<ByteBuffer, Long> m5276h(RandomAccessFile randomAccessFile, int i) throws IOException {
        int i2;
        long length = randomAccessFile.length();
        if (length < 22) {
            return null;
    ...
    /* renamed from: i */
    private static void m5277i(ByteBuffer byteBuffer) {
    ...
    /* renamed from: j */
    private static long m5278j(ByteBuffer byteBuffer, int i) {
        return ((long) byteBuffer.getInt(i)) & 4294967295L;
    }

    /* renamed from: k */
    private static X509Certificate[][] m5279k(FileChannel fileChannel, C2105e eVar) throws SecurityException {
        HashMap hashMap = new HashMap();
        ArrayList arrayList = new ArrayList();
        try {
            CertificateFactory instance = CertificateFactory.getInstance("X.509");
            try {
                ByteBuffer s = m5287s(eVar.f5207a);
                int i = 0;
                while (s.hasRemaining()) {
                    i++;
                    try {
                        arrayList.add(m5280l(m5287s(s), hashMap, instance));
                ...
                if (i <= 0) {
                    ...
                    m5281m(hashMap, fileChannel, eVar.f5208b, eVar.f5209c, eVar.f5210d, eVar.f5211e);
    ...
    private static java.security.cert.X509Certificate[] m5280l(java.nio.ByteBuffer r22, java.util.Map<java.lang.Integer, byte[]> r23, java.security.cert.CertificateFactory r24) throws java.lang.SecurityException, java.io.IOException {
        /*
            java.nio.ByteBuffer r0 = m5287s(r22)
            java.nio.ByteBuffer r1 = m5287s(r22)
            byte[] r2 = m5288t(r22)
        ...
        L_0x0016:
            ...
            int r8 = r8 + 1
            java.nio.ByteBuffer r10 = m5287s(r1)     // Catch:{ IOException -> 0x0066, BufferUnderflowException -> 0x0064 }
        ...
        L_0x0046:
            ...
            int r11 = m5283o(r5)     // Catch:{ IOException -> 0x0066, BufferUnderflowException -> 0x0064 }
            int r12 = m5283o(r7)     // Catch:{ IOException -> 0x0066, BufferUnderflowException -> 0x0064 }
            if (r11 == r15) goto L_0x0016
            if (r12 == r15) goto L_0x0055
            goto L_0x0016
        L_0x0055:
            byte[] r7 = m5288t(r10)     // Catch:{ IOException -> 0x0066, BufferUnderflowException -> 0x0064 }
            r9 = r7
            r7 = r5
            goto L_0x0016
        L_0x005c:
        ...
        L_0x014e:
            ...
            r0.clear()
            java.nio.ByteBuffer r1 = m5287s(r0)
        ...
        L_0x0164:
            ...
            int r5 = r5 + r15
            java.nio.ByteBuffer r8 = m5287s(r1)     // Catch:{ IOException -> 0x0191, BufferUnderflowException -> 0x018f }
            ...
            byte[] r6 = m5288t(r8)     // Catch:{ IOException -> 0x0191, BufferUnderflowException -> 0x018f }
            goto L_0x0164
        L_0x0187:
        ...
        L_0x029f:
            goto L_0x029e
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.play.core.internal.C2109i.m5280l(java.nio.ByteBuffer, java.util.Map, java.security.cert.CertificateFactory):java.security.cert.X509Certificate[]");
    }

    /* renamed from: m */
    private static void m5281m(Map<Integer, byte[]> map, FileChannel fileChannel, long j, long j2, long j3, ByteBuffer byteBuffer) throws SecurityException {
        if (!map.isEmpty()) {
            C2104d dVar = new C2104d(fileChannel, 0, j);
            C2104d dVar2 = new C2104d(fileChannel, j2, j3 - j2);
            ByteBuffer duplicate = byteBuffer.duplicate();
            duplicate.order(ByteOrder.LITTLE_ENDIAN);
            long j4 = j;
            m5271c(duplicate, j);
            C2078b bVar = new C2078b(duplicate);
            int size = map.size();
            ...
            try {
                byte[][] n = m5282n(iArr, new C2099c[]{dVar, dVar2, bVar});
                while (i < size) {
                    int i3 = iArr[i];
                    ...
                    if (MessageDigest.isEqual(map.get(Integer.valueOf(i3)), n[i])) {
                        ...
                        throw new SecurityException(m5284p(i3).concat(" digest of contents did not verify"));
                    }
                }
    ...
    /* renamed from: n */
    private static byte[][] m5282n(int[] iArr, C2099c[] cVarArr) throws DigestException {
        long j;
        int i;
        int length;
        int[] iArr2 = iArr;
        ...
        while (true) {
            ...
            j3 += (cVarArr[i2].mo22051a() + 1048575) / 1048576;
            i2++;
        }
        if (j3 < 2097151) {
            int i3 = (int) j3;
            ...
            while (true) {
                ...
                byte[] bArr2 = new byte[((m5285q(iArr2[i4]) * i3) + 5)];
                bArr2[0] = 90;
                m5289u(i3, bArr2);
                bArr[i4] = bArr2;
                i4++;
            ...
            int i8 = 0;
            for (i = 3; i6 < i; i = 3) {
                C2099c cVar = cVarArr[i6];
                long j4 = j2;
                int i9 = i6;
                long a = cVar.mo22051a();
                while (a > j2) {
                    ...
                    long j5 = j4;
                    try {
                        cVar.mo22052b(messageDigestArr, j5, min);
                        int i11 = 0;
    ...
    /* renamed from: o */
    private static int m5283o(int i) {
        if (i == 513) {
            return 1;
        }
        if (i == 514) {
    ...
    /* renamed from: p */
    private static String m5284p(int i) {
        if (i == 1) {
            return "SHA-256";
        }
        if (i == 2) {
    ...
    /* renamed from: q */
    private static int m5285q(int i) {
        if (i == 1) {
            return 32;
        }
        if (i == 2) {
    ...
    /* renamed from: r */
    private static ByteBuffer m5286r(ByteBuffer byteBuffer, int i) throws BufferUnderflowException {
        if (i >= 0) {
    ...
    /* renamed from: s */
    private static ByteBuffer m5287s(ByteBuffer byteBuffer) throws IOException {
        if (byteBuffer.remaining() >= 4) {
            int i = byteBuffer.getInt();
            if (i < 0) {
                throw new IllegalArgumentException("Negative length");
            } else if (i <= byteBuffer.remaining()) {
                return m5286r(byteBuffer, i);
            } else {
    ...
    /* renamed from: t */
    private static byte[] m5288t(ByteBuffer byteBuffer) throws IOException {
        int i = byteBuffer.getInt();
        if (i < 0) {
    ...
    /* renamed from: u */
    private static void m5289u(int i, byte[] bArr) {
        bArr[1] = (byte) (i & 255);
        bArr[2] = (byte) ((i >>> 8) & 255);
