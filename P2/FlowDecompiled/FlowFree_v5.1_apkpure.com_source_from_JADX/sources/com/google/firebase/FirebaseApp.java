...
public class FirebaseApp {
    ...
    public String toString() {
        ...
        stringHelper.add(MediationMetaData.KEY_NAME, this.name);
        stringHelper.add("options", this.options);
    ...
    protected FirebaseApp(Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        ComponentRuntime.Builder builder = ComponentRuntime.builder(UI_EXECUTOR);
        builder.addLazyComponentRegistrars(discoverLazy);
        builder.addComponentRegistrar(new FirebaseCommonRegistrar());
        builder.addComponent(Component.m5459of(context, Context.class, new Class[0]));
        builder.addComponent(Component.m5459of(this, FirebaseApp.class, new Class[0]));
        builder.addComponent(Component.m5459of(firebaseOptions, FirebaseOptions.class, new Class[0]));
