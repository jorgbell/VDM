...
public class FirebaseCommonRegistrar implements ComponentRegistrar {
    public List<Component<?>> getComponents() {
        ...
        arrayList.add(LibraryVersionComponent.create("fire-core", "19.5.0"));
        ...
        arrayList.add(LibraryVersionComponent.fromContext("android-target-sdk", FirebaseCommonRegistrar$$Lambda$1.lambdaFactory$()));
        arrayList.add(LibraryVersionComponent.fromContext("android-min-sdk", FirebaseCommonRegistrar$$Lambda$4.lambdaFactory$()));
        arrayList.add(LibraryVersionComponent.fromContext("android-platform", FirebaseCommonRegistrar$$Lambda$5.lambdaFactory$()));
        arrayList.add(LibraryVersionComponent.fromContext("android-installer", FirebaseCommonRegistrar$$Lambda$6.lambdaFactory$()));
