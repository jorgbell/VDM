...
public final class FirebaseOptions {
    ...
    public String toString() {
        ...
        stringHelper.add("databaseUrl", this.databaseUrl);
        stringHelper.add("gcmSenderId", this.gcmSenderId);
        stringHelper.add("storageBucket", this.storageBucket);
        stringHelper.add("projectId", this.projectId);
