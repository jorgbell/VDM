...
public final class Component<T> {
    ...
    @SafeVarargs
    /* renamed from: of */
    public static <T> Component<T> m5459of(T t, Class<T> cls, Class<? super T>... clsArr) {
        Builder<T> builder = builder(cls, clsArr);
        builder.factory(Component$$Lambda$2.lambdaFactory$(t));
        return builder.build();
    }

    public static <T> Builder<T> intoSetBuilder(Class<T> cls) {
        Builder<T> builder = builder(cls);
        Builder unused = builder.intoSet();
        return builder;
    }

    public static <T> Component<T> intoSet(T t, Class<T> cls) {
        Builder<T> intoSetBuilder = intoSetBuilder(cls);
        intoSetBuilder.factory(Component$$Lambda$3.lambdaFactory$(t));
