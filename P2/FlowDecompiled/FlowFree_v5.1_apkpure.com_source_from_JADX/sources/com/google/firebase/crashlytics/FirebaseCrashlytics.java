...
public class FirebaseCrashlytics {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r13v7, resolved type: com.google.firebase.crashlytics.internal.analytics.CrashlyticsOriginAnalyticsEventLogger} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r13v8, resolved type: com.google.firebase.crashlytics.internal.analytics.UnavailableAnalyticsEventLogger} */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r13v11, resolved type: com.google.firebase.crashlytics.internal.analytics.UnavailableAnalyticsEventLogger} */
    ...
    static com.google.firebase.crashlytics.FirebaseCrashlytics init(com.google.firebase.FirebaseApp r11, com.google.firebase.installations.FirebaseInstallationsApi r12, com.google.firebase.crashlytics.internal.CrashlyticsNativeComponent r13, com.google.firebase.analytics.connector.AnalyticsConnector r14) {
        ...
        L_0x0035:
            ...
            java.lang.String r3 = "Registered Firebase Analytics listener."
            r14.mo22331d(r3)
        ...
        L_0x0078:
            ...
            java.lang.String r14 = "Firebase Analytics is not available."
            r13.mo22331d(r14)
        ...
        L_0x008d:
            ...
            r14.<init>(r2)
            com.google.firebase.crashlytics.internal.common.AppData r11 = com.google.firebase.crashlytics.internal.common.AppData.create(r2, r1, r3, r11, r14)     // Catch:{ NameNotFoundException -> 0x0116 }
            com.google.firebase.crashlytics.internal.Logger r14 = com.google.firebase.crashlytics.internal.Logger.getLogger()
            java.lang.StringBuilder r0 = new java.lang.StringBuilder
            r0.<init>()
        ...
        L_0x0116:
            ...
            java.lang.String r13 = "Error retrieving app package info."
            r12.mo22334e(r13, r11)
            r11 = 0
            return r11
        */
    ...
    private static AnalyticsConnector.AnalyticsConnectorHandle subscribeToAnalyticsEvents(AnalyticsConnector analyticsConnector, CrashlyticsAnalyticsListener crashlyticsAnalyticsListener) {
        ...
        if (registerAnalyticsConnectorListener == null) {
            Logger.getLogger().mo22331d("Could not register AnalyticsConnectorListener with Crashlytics origin.");
            ...
            if (registerAnalyticsConnectorListener != null) {
                Logger.getLogger().mo22339w("A new version of the Google Analytics for Firebase SDK is now available. For improved performance and compatibility with Crashlytics, please update to the latest version.");
            }
        }
    ...
    public void recordException(Throwable th) {
        if (th == null) {
            Logger.getLogger().mo22339w("A null value was passed to recordException. Ignoring.");
        } else {
