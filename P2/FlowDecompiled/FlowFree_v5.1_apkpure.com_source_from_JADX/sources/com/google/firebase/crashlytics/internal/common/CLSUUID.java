...
class CLSUUID {
    ...
    CLSUUID(IdManager idManager) {
        ...
        _clsId = String.format(locale, "%s%s%s%s", new Object[]{hexify.substring(0, 12), hexify.substring(12, 16), hexify.subSequence(16, 20), sha1.substring(0, 12)}).toUpperCase(locale);
    }
