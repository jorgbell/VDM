...
public class CommonUtils {
    ...
    public static java.lang.String extractFieldFromSystemFile(java.io.File r6, java.lang.String r7) {
        ...
        L_0x0040:
            ...
            r3.mo22334e(r6, r7)     // Catch:{ all -> 0x0059 }
            goto L_0x0036
        L_0x0059:
            r6 = move-exception
            r2 = r1
    ...
    enum Architecture {
        ...
        static Architecture getValue() {
            ...
            if (TextUtils.isEmpty(str)) {
                Logger.getLogger().mo22337v("Architecture#getValue()::Build.CPU_ABI returned null or empty");
                return UNKNOWN;
            }
                ...
                if (!TextUtils.isEmpty(extractFieldFromSystemFile)) {
                    ...
                    try {
                        if (upperCase.endsWith("KB")) {
                            ...
                            logger.mo22339w("Unexpected meminfo format while computing RAM: " + upperCase);
                        }
                    } catch (NumberFormatException e) {
                        Logger logger2 = Logger.getLogger();
                        logger2.mo22334e("Unexpected meminfo format while computing RAM: " + upperCase, e);
                    }
                }
                totalRamInBytes = j2;
            }
    ...
    private static String hash(byte[] bArr, String str) {
        try {
            ...
            Logger logger = Logger.getLogger();
            logger.mo22334e("Could not create hashing algorithm: " + str + ", returning empty string.", e);
            return "";
        }
    }
    ...
    public static void closeOrLog(Closeable closeable, String str) {
        if (closeable != null) {
            try {
                ...
                Logger.getLogger().mo22334e(str, e);
            }
        }
    }
    ...
    public static String getResourcePackageName(Context context) {
        ...
        try {
            ...
            if (com.mopub.common.Constants.ANDROID_PLATFORM.equals(resourcePackageName)) {
                return context.getPackageName();
            }
    ...
    public static String resolveUnityEditorVersion(Context context) {
        ...
        Logger logger = Logger.getLogger();
        logger.mo22337v("Unity Editor version is: " + string);
        return string;
    }
