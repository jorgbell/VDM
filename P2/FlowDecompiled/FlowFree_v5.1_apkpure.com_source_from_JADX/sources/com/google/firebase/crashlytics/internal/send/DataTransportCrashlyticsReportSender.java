...
public class DataTransportCrashlyticsReportSender {
    ...
    public static DataTransportCrashlyticsReportSender create(Context context) {
        ...
        Encoding of = Encoding.m4837of("json");
        Transformer<CrashlyticsReport, byte[]> transformer = DEFAULT_TRANSFORM;
        return new DataTransportCrashlyticsReportSender(TransportRuntime.getInstance().newFactory(new CCTDestination(CRASHLYTICS_ENDPOINT, CRASHLYTICS_API_KEY)).getTransport("FIREBASE_CRASHLYTICS_REPORT", CrashlyticsReport.class, of, transformer), transformer);
    }
