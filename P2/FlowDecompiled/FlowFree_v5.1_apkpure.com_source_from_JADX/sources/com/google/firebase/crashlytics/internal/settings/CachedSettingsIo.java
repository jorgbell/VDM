...
public class CachedSettingsIo {
    ...
    public JSONObject readCachedSettings() {
        ...
        Logger.getLogger().mo22331d("Checking for cached settings...");
        ...
        try {
            ...
            if (settingsFile.exists()) {
                ...
                try {
                    ...
                    e = e;
                    try {
                        Logger.getLogger().mo22334e("Failed to fetch cached settings", e);
                ...
                Logger.getLogger().mo22337v("Settings file does not exist.");
                jSONObject = null;
            }
    ...
    public void writeCachedSettings(long j, JSONObject jSONObject) {
        Logger.getLogger().mo22337v("Writing settings to cache file...");
        if (jSONObject != null) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        Logger.getLogger().mo22334e("Failed to cache settings", e);
