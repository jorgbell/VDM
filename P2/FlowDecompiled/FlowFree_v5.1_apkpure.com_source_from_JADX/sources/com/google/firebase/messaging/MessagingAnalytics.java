...
public class MessagingAnalytics {
    ...
    static {
        ...
        jsonDataEncoderBuilder.registerEncoder(FirelogAnalyticsEvent.FirelogAnalyticsEventWrapper.class, (ObjectEncoder) new FirelogAnalyticsEvent.FirelogAnalyticsEventWrapperEncoder());
        jsonDataEncoderBuilder.registerEncoder(FirelogAnalyticsEvent.class, (ObjectEncoder) new FirelogAnalyticsEvent.FirelogAnalyticsEventEncoder());
    ...
    static String getInstanceId(Intent intent) {
    ...
    static String getProjectNumber(Intent intent) {
    ...
    public static void logNotificationReceived(Intent intent) {
        ...
        if (shouldUploadFirelogAnalytics(intent)) {
            ...
            if (transportFactory != null) {
                logToFirelog("MESSAGE_DELIVERED", intent, transportFactory.getTransport("FCM_CLIENT_EVENT_LOGGING", String.class, Encoding.m4837of("json"), MessagingAnalytics$$Lambda$0.$instance));
            } else {
    ...
    private static void logToFirelog(String str, Intent intent, Transport<String> transport) {
        try {
            transport.send(Event.ofTelemetry(dataEncoder.encode(new FirelogAnalyticsEvent.FirelogAnalyticsEventWrapper(new FirelogAnalyticsEvent("MESSAGE_DELIVERED", intent)))));
