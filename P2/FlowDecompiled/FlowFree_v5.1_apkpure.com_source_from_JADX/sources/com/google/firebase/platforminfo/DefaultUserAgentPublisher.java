...
public class DefaultUserAgentPublisher implements UserAgentPublisher {
    ...
    public static Component<UserAgentPublisher> component() {
        Component.Builder<UserAgentPublisher> builder = Component.builder(UserAgentPublisher.class);
        builder.add(Dependency.setOf(LibraryVersion.class));
        builder.factory(DefaultUserAgentPublisher$$Lambda$1.lambdaFactory$());
