...
public class PersonalInfoManager {
    ...
    public PersonalInfoManager(Context context, String str, SdkInitializationListener sdkInitializationListener) {
        ...
        if (!TextUtils.isEmpty(str) && !str.equals(personalInfoData.getCachedLastAdUnitIdUsedForInit())) {
            personalInfoData.setAdUnit("");
            personalInfoData.setCachedLastAdUnitIdUsedForInit(str);
            personalInfoData.writeToDisk();
        }
        this.mConversionTracker = new MoPubConversionTracker(applicationContext);
        C25051 r4 = new MoPubIdentifier.AdvertisingIdChangeListener() {
            public void onIdChanged(AdvertisingId advertisingId, AdvertisingId advertisingId2) {
                ...
                if (!advertisingId.isDoNotTrack() && advertisingId2.isDoNotTrack()) {
                    ...
                    if (consentStatus.equals(PersonalInfoManager.this.mPersonalInfoData.getConsentStatusBeforeDnt())) {
                ...
                } else if (!TextUtils.isEmpty(advertisingId2.mAdvertisingId) && !advertisingId2.getIfa().equals(PersonalInfoManager.this.mPersonalInfoData.getIfa()) && ConsentStatus.EXPLICIT_YES.equals(PersonalInfoManager.this.mPersonalInfoData.getConsentStatus())) {
        ...
        moPubIdentifier.setIdChangeListener(r4);
    ...
    public void changeConsentStateFromDialog(ConsentStatus consentStatus) {
        ...
        int i = C25106.$SwitchMap$com$mopub$common$privacy$ConsentStatus[consentStatus.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C25106 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.mopub.common.privacy.PersonalInfoManager.C25106.<clinit>():void");
        }
    }
    ...
    public void requestSync(boolean z) {
        if (MoPub.isSdkInitialized()) {
            if (shouldMakeSyncRequest(this.mSyncRequestInFlight, gdprApplies(), z, this.mLastSyncRequestTimeUptimeMs, this.mSyncDelayMs, this.mPersonalInfoData.getIfa(), ClientMetadata.getInstance(this.mAppContext).getMoPubIdentifier().getAdvertisingInfo().isDoNotTrack())) {
                requestSync();
            }
        }
    }
    ...
    public void requestSync() {
        ...
        C2676Networking.getRequestQueue(this.mAppContext).add(new SyncRequest(this.mAppContext, syncUrlGenerator.generateUrlString(Constants.HOST), this.mSyncRequestListener));
    }
    ...
    public void attemptStateTransition(ConsentStatus consentStatus, String str) {
        ...
        if (this.mPersonalInfoData.shouldReacquireConsent() || !consentStatus2.equals(consentStatus)) {
            ...
            if (ConsentStatus.EXPLICIT_YES.equals(consentStatus)) {
                this.mPersonalInfoData.setIfa(ClientMetadata.getInstance(this.mAppContext).getMoPubIdentifier().getAdvertisingInfo().getIfa());
            }
    ...
    private static boolean shouldSetConsentedVersions(ConsentStatus consentStatus, ConsentStatus consentStatus2) {
        ...
        if (consentStatus3.equals(consentStatus) || !ConsentStatus.EXPLICIT_YES.equals(consentStatus2)) {
            return false;
        }
        return true;
    }
    ...
    private class PersonalInfoSyncRequestListener implements SyncRequest.Listener {
        ...
        public void onSuccess(SyncResponse syncResponse) {
            ...
            if (!consentStatus.equals(PersonalInfoManager.this.mSyncRequestConsentStatus)) {
                PersonalInfoManager.this.mPersonalInfoData.setIfa((String) null);
            }
