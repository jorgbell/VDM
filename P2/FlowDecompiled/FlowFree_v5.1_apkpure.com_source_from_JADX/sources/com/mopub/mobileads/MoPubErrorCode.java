    ...
    static /* synthetic */ class C25531 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.mopub.mobileads.MoPubErrorCode.C25531.<clinit>():void");
        }
    }

    public int getIntCode() {
        int i = C25531.$SwitchMap$com$mopub$mobileads$MoPubErrorCode[ordinal()];
        if (i == 1) {
            return 2;
        }
        if (i != 2) {
