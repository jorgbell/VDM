...
public class VastMacroHelper {
    ...
    private String formatContentPlayHead(int i) {
        ...
        long j = (long) i;
        return String.format("%02d:%02d:%02d.%03d", new Object[]{Long.valueOf(timeUnit.toHours(j)), Long.valueOf(timeUnit.toMinutes(j) % TimeUnit.HOURS.toMinutes(1)), Long.valueOf(timeUnit.toSeconds(j) % TimeUnit.MINUTES.toSeconds(1)), Integer.valueOf(i % 1000)});
    }
}
