...
public class AdLoader {
    ...
    public AdLoader(String str, AdFormat adFormat, String str2, Context context, Listener listener) {
        ...
        C26671 r5 = new MultiAdRequest.Listener() {
        ...
        this.mRunning = false;
        this.mFailed = false;
        this.mMultiAdRequest = new MultiAdRequest(str, adFormat, str2, context, r5);
    }
        ...
        synchronized (this.lock) {
            if (this.mMultiAdResponse != null) {
                ...
                if (this.mMultiAdResponse.hasNext()) {
                    ...
                    MultiAdRequest multiAdRequest2 = this.mMultiAdRequest;
                    MultiAdRequest multiAdRequest3 = new MultiAdRequest(failURL, multiAdRequest2.mAdFormat, multiAdRequest2.mAdUnitId, (Context) this.mContext.get(), this.mAdListener);
                    this.mMultiAdRequest = multiAdRequest3;
                    Request<?> fetchAd = fetchAd(multiAdRequest3, (Context) this.mContext.get());
                    return fetchAd;
                } else {
                    this.mHandler.post(new Runnable() {
                        public void run() {
    ...
    private Request<?> fetchAd(MultiAdRequest multiAdRequest, Context context) {
        ...
        this.mRunning = true;
        MoPubRequestQueue requestQueue = C2676Networking.getRequestQueue(context);
