...
public class MultiAdResponse implements Iterator<AdResponse> {
    ...
    protected static AdResponse parseSingleAdResponse(Context context, NetworkResponse networkResponse, JSONObject jSONObject, String str, AdFormat adFormat, String str2, String str3) throws JSONException, MoPubNetworkError {
        ...
        List<String> extractStringArray = HeaderUtils.extractStringArray(jSONObject2, responseHeader);
        ...
        List<String> extractStringArray2 = HeaderUtils.extractStringArray(jSONObject2, ResponseHeader.IMPRESSION_URLS);
        ...
        List<String> extractStringArray3 = HeaderUtils.extractStringArray(jSONObject2, responseHeader2);
        ...
        List<String> extractStringArray4 = HeaderUtils.extractStringArray(jSONObject2, responseHeader3);
        ...
        List<String> extractStringArray5 = HeaderUtils.extractStringArray(jSONObject2, responseHeader4);
        ...
        List<String> extractStringArray6 = HeaderUtils.extractStringArray(jSONObject2, responseHeader5);
        ...
        if (TextUtils.isEmpty(extractHeader10)) {
            extractHeader10 = HeaderUtils.extractHeader(jSONObject2, ResponseHeader.NATIVE_PARAMS);
        }
        try {
            ...
            throw new MoPubNetworkError("Failed to decode server extras for base ad data.", (Throwable) e3, MoPubNetworkError.Reason.BAD_HEADER_DATA);
        }
    }
    ...
    private static boolean eventDataIsInResponseBody(String str, String str2) {
        return "mraid".equals(str) || AdType.HTML.equals(str) || (AdType.INTERSTITIAL.equals(str) && FullAdType.VAST.equals(str2)) || ((AdType.INTERSTITIAL.equals(str) && "json".equals(str2)) || ((AdType.REWARDED_VIDEO.equals(str) && FullAdType.VAST.equals(str2)) || AdType.REWARDED_PLAYABLE.equals(str) || AdType.FULLSCREEN.equals(str)));
    }
}
