...
public class CacheDispatcher extends Thread {
    ...
    public void run() {
        if (DEBUG) {
            VolleyLog.m5889v("start new dispatcher", new Object[0]);
        }
        ...
        while (true) {
            try {
                ...
                VolleyLog.m5887e("Ignoring spurious interrupt of CacheDispatcher thread; use quit() to terminate it", new Object[0]);
            }
        }
    }
    ...
    private static class WaitingRequestManager implements Request.NetworkRequestCompleteListener {
        ...
        public void onResponseReceived(Request<?> request, Response<?> response) {
            ...
            if (remove != null) {
                if (VolleyLog.DEBUG) {
                    VolleyLog.m5889v("Releasing %d waiting requests for cacheKey=%s.", Integer.valueOf(remove.size()), cacheKey);
                }
        ...
        public synchronized void onNoUsableResponseReceived(Request<?> request) {
            ...
            if (remove != null && !remove.isEmpty()) {
                if (VolleyLog.DEBUG) {
                    VolleyLog.m5889v("%d waiting requests for cacheKey=%s; resend to network", Integer.valueOf(remove.size()), cacheKey);
                }
                ...
                try {
                    ...
                    VolleyLog.m5887e("Couldn't add request to queue. %s", e.toString());
                    Thread.currentThread().interrupt();
        ...
        public synchronized boolean maybeAddToWaitingRequests(com.mopub.volley.Request<?> r6) {
            ...
            L_0x001e:
                ...
                com.mopub.volley.VolleyLog.m5886d(r6, r1)     // Catch:{ all -> 0x0052 }
            L_0x0038:
                monitor-exit(r5)
                return r2
            L_0x003a:
