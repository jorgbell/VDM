...
public class NetworkDispatcher extends Thread {
    ...
    public void run() {
        ...
        while (true) {
            try {
                ...
                VolleyLog.m5887e("Ignoring spurious interrupt of NetworkDispatcher thread; use quit() to terminate it", new Object[0]);
            }
        }
    }
    ...
    public void processRequest(Request<?> request) {
        ...
        try {
            ...
            VolleyLog.m5888e(e2, "Unhandled exception %s", e2.toString());
