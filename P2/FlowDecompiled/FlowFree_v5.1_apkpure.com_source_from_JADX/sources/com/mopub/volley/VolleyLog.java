...
public class VolleyLog {
    ...
    public static boolean DEBUG = Log.isLoggable(zzao.zza, 2);
    public static String TAG = "Volley";

    public static void setTag(String str) {
        m5886d("Changing log tag to %s", str);
        TAG = str;
        DEBUG = Log.isLoggable(str, 2);
    }

    /* renamed from: v */
    public static void m5889v(String str, Object... objArr) {
        if (DEBUG) {
    ...
    /* renamed from: d */
    public static void m5886d(String str, Object... objArr) {
        Log.d(TAG, buildMessage(str, objArr));
    }

    /* renamed from: e */
    public static void m5887e(String str, Object... objArr) {
        Log.e(TAG, buildMessage(str, objArr));
    }

    /* renamed from: e */
    public static void m5888e(Throwable th, String str, Object... objArr) {
    ...
    static class MarkerLog {
        ...
        public synchronized void finish(String str) {
            ...
            if (totalDuration > 0) {
                ...
                VolleyLog.m5886d("(%-4d ms) %s", Long.valueOf(totalDuration), str);
                for (Marker next : this.mMarkers) {
                    long j2 = next.time;
                    VolleyLog.m5886d("(+%-4d) [%2d] %s", Long.valueOf(j2 - j), Long.valueOf(next.thread), next.name);
                    j = j2;
                }
            }
        }
        ...
        public void finalize() throws Throwable {
            if (!this.mFinished) {
                ...
                VolleyLog.m5887e("Marker log finalized without finish() - uncaught exit point for request", new Object[0]);
            }
        }
