...
public class BasicNetwork implements Network {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:48:0x00c3, code lost:
        r0 = r2.getStatusCode();
        com.mopub.volley.VolleyLog.m5887e("Unexpected response code %d for %s", java.lang.Integer.valueOf(r0), r29.getUrl());
     */
    ...
    public com.mopub.volley.NetworkResponse performRequest(com.mopub.volley.Request<?> r29) throws com.mopub.volley.VolleyError {
        ...
        L_0x00c1:
            ...
            com.mopub.volley.VolleyLog.m5887e(r2, r1)
    ...
    private void logSlowRequests(long j, Request<?> request, byte[] bArr, int i) {
        if (DEBUG || j > 3000) {
            ...
            VolleyLog.m5886d("HTTP response for request=<%s> [lifetime=%d], [size=%s], [rc=%d], [retryCount=%s]", objArr);
        }
    }
            ...
            try {
                ...
                if (inputStream != null) {
                    try {
                        ...
                        VolleyLog.m5889v("Error occurred when closing InputStream", new Object[0]);
                    }
                }
