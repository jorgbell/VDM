...
public class LoadModule extends AdModule<ILoadOperation, LoadOperationState> implements ILoadModule {
    ...
    public void executeAdOperation(IWebViewBridgeInvoker iWebViewBridgeInvoker, final LoadOperationState loadOperationState) {
        ...
        LoadOperation loadOperation = new LoadOperation(loadOperationState, new WebViewBridgeInvocation(iWebViewBridgeInvoker, new IWebViewBridgeInvocationCallback() {
            ...
            public void onFailure(String str, CallbackStatus callbackStatus) {
                ...
                LoadModule.this.remove(loadOperationState.f5610id);
            }
        ...
        try {
            ...
            jSONObject.put(UnityRouter.PLACEMENT_ID_KEY, loadOperationState.placementId);
            jSONObject.put("time", Device.getElapsedRealtime());
            jSONObject.put("options", loadOperationState.loadOptions.getData());
            set(loadOperation);
