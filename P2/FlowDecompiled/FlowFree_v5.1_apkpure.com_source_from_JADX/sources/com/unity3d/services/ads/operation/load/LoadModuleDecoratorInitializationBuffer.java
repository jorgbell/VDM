...
public class LoadModuleDecoratorInitializationBuffer extends LoadModuleDecorator implements IInitializationListener {
    ...
    static /* synthetic */ class C28002 {
        ...
        static final /* synthetic */ int[] f5609xe3e1bbe9;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f5609xe3e1bbe9     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.unity3d.services.ads.operation.load.LoadModuleDecoratorInitializationBuffer.C28002.<clinit>():void");
        }
    }
    ...
    public void executeAdOperation(IWebViewBridgeInvoker iWebViewBridgeInvoker, LoadOperationState loadOperationState) {
        if (loadOperationState != null) {
            int i = C28002.f5609xe3e1bbe9[SdkProperties.getCurrentInitializationState().ordinal()];
            if (i == 1) {
