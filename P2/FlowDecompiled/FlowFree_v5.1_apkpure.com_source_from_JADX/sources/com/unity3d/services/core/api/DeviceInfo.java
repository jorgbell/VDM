...
public class DeviceInfo {
    ...
    public static void registerVolumeChangeListener(Integer num, WebViewCallback webViewCallback) {
        ...
        if (_volumeChangeListeners.get(num.intValue()) == null) {
            C28461 r0 = new IVolumeChangeListener(num) {
    ...
    static /* synthetic */ class C28472 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.unity3d.services.core.api.DeviceInfo.C28472.<clinit>():void");
        }
    }

    private static File getFileForStorageType(StorageType storageType) {
        int i = C28472.$SwitchMap$com$unity3d$services$core$api$DeviceInfo$StorageType[storageType.ordinal()];
        if (i == 1) {
