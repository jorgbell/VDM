...
public class ConnectivityMonitor {
    ...
    private static void sendToWebview(ConnectivityEvent connectivityEvent, boolean z, int i) {
        ...
        if (_webappMonitoring && (currentApp = WebViewApp.getCurrentApp()) != null && currentApp.isWebAppLoaded()) {
            int i2 = C28611.f5614xede9def6[connectivityEvent.ordinal()];
            if (i2 != 1) {
                if (i2 == 2) {
    ...
    static /* synthetic */ class C28611 {
        ...
        static final /* synthetic */ int[] f5614xede9def6;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f5614xede9def6     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f5614xede9def6     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.unity3d.services.core.connectivity.ConnectivityMonitor.C28611.<clinit>():void");
        }
    }
}
