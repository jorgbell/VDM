    ...
    private void buildCreators() {
        ...
        this.creators.put(LogManager.class, new Creator() {
            ...
            public Object create() {
                return new LogManager(ServiceLocator.this.ctx, (CacheManager) ServiceLocator.this.getOrBuild(CacheManager.class), (VungleApiClient) ServiceLocator.this.getOrBuild(VungleApiClient.class), (Executor) ((Executors) ServiceLocator.this.getOrBuild(Executors.class)).getLoggerExecutor());
            }
        });
        ...
        this.creators.put(Executors.class, new Creator(this) {
            public Executors create() {
                return new SDKExecutors();
            }
        });
        this.creators.put(RuntimeValues.class, new Creator(this) {
            public RuntimeValues create() {
                return new RuntimeValues();
            }
        });
        this.creators.put(VungleStaticApi.class, new Creator(this) {
        ...
        this.creators.put(TimeoutProvider.class, new Creator(this) {
            public TimeoutProvider create() {
                return new ConcurrencyTimeoutProvider();
            }
        });
        this.creators.put(OperationSequence.class, new Creator(this) {
            public OperationSequence create() {
                return new OperationSequence();
            }
        });
        this.creators.put(AppSession.class, new Creator<AppSession>(this) {
            /* access modifiers changed from: package-private */
        ...
        this.creators.put(OMTracker.Factory.class, new Creator<OMTracker.Factory>(this) {
