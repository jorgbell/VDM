package com.vungle.warren.p054ui.state;
...
public class BundleOptionsState implements OptionsState, Parcelable {
    ...
    protected BundleOptionsState(Parcel parcel) {
        ...
        for (int i = 0; i < readInt; i++) {
            this.ints.put(parcel.readString(), (Integer) parcel.readValue(cls.getClassLoader()));
        }
        int readInt2 = parcel.readInt();
        for (int i2 = 0; i2 < readInt2; i2++) {
            this.strings.put(parcel.readString(), (String) parcel.readValue(cls.getClassLoader()));
        }
