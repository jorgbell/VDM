...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    private void startHttp2(int i) throws IOException {
        ...
        Http2Connection build = builder.build();
    ...
    private void connectTls(okhttp3.internal.connection.ConnectionSpecSelector r8) throws java.io.IOException {
        /*
            ...
            okhttp3.HttpUrl r4 = r0.url()     // Catch:{ AssertionError -> 0x0130 }
            java.lang.String r4 = r4.host()     // Catch:{ AssertionError -> 0x0130 }
            okhttp3.HttpUrl r5 = r0.url()     // Catch:{ AssertionError -> 0x0130 }
            ...
            okhttp3.ConnectionSpec r8 = r8.configureSecureSocket(r1)     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            boolean r3 = r8.supportsTlsExtensions()     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            if (r3 == 0) goto L_0x0041
            okhttp3.internal.platform.Platform r3 = okhttp3.internal.platform.Platform.get()     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            okhttp3.HttpUrl r4 = r0.url()     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
        ...
        L_0x0041:
            ...
            okhttp3.Handshake r4 = okhttp3.Handshake.get(r3)     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            javax.net.ssl.HostnameVerifier r5 = r0.hostnameVerifier()     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            okhttp3.HttpUrl r6 = r0.url()     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            ...
            okhttp3.HttpUrl r0 = r0.url()     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            ...
            r4.append(r0)     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            java.lang.String r0 = okhttp3.CertificatePinner.pin(r8)     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            r4.append(r0)     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            java.lang.String r0 = "\n    DN: "
            r4.append(r0)     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            ...
            java.lang.String r0 = "\n    subjectAltNames: "
            r4.append(r0)     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            java.util.List r8 = okhttp3.internal.tls.OkHostnameVerifier.allSubjectAltNames(r8)     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
        ...
        L_0x00d8:
            okhttp3.CertificatePinner r3 = r0.certificatePinner()     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            okhttp3.HttpUrl r0 = r0.url()     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            java.lang.String r0 = r0.host()     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            java.util.List r5 = r4.peerCertificates()     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            r3.check(r0, r5)     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            boolean r8 = r8.supportsTlsExtensions()     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            if (r8 == 0) goto L_0x00f9
            okhttp3.internal.platform.Platform r8 = okhttp3.internal.platform.Platform.get()     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
        ...
        L_0x0130:
            r8 = move-exception
        L_0x0131:
            boolean r0 = okhttp3.internal.Util.isAndroidGetsocknameError(r8)     // Catch:{ all -> 0x012e }
    ...
    private Request createTunnel(int i, int i2, Request request, HttpUrl httpUrl) throws IOException {
        ...
        while (true) {
            ...
            Http1Codec http1Codec = new Http1Codec((OkHttpClient) null, (StreamAllocation) null, bufferedSource, this.sink);
