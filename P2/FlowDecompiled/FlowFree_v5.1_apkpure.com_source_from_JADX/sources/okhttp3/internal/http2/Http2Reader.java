...
final class Http2Reader implements Closeable {
    ...
    public boolean nextFrame(boolean z, Handler handler) throws IOException {
        try {
            ...
            byte readByte = (byte) (this.source.readByte() & Constants.UNKNOWN);
            if (!z || readByte == 4) {
                byte readByte2 = (byte) (this.source.readByte() & Constants.UNKNOWN);
    ...
    private void readHeaders(Handler handler, int i, byte b, int i2) throws IOException {
        ...
        if (i2 != 0) {
            boolean z = (b & 1) != 0;
            if ((b & 8) != 0) {
                s = (short) (this.source.readByte() & Constants.UNKNOWN);
            }
            if ((b & 32) != 0) {
    ...
    private void readPriority(Handler handler, int i) throws IOException {
        ...
        handler.priority(i, readInt & Integer.MAX_VALUE, (this.source.readByte() & Constants.UNKNOWN) + 1, (Integer.MIN_VALUE & readInt) != 0);
    }
    ...
    static final class ContinuationSource implements Source {
        ...
        private void readContinuationHeader() throws IOException {
            ...
            byte readByte = (byte) (this.source.readByte() & Constants.UNKNOWN);
            this.flags = (byte) (this.source.readByte() & Constants.UNKNOWN);
