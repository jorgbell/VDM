...
public final class Http2Stream {
    ...
    public boolean isLocallyInitiated() {
        if (this.connection.client == ((this.f5331id & 1) == 1)) {
            return true;
        }
        return false;
    }
    ...
    public void close(ErrorCode errorCode2) throws IOException {
        if (closeInternal(errorCode2)) {
            this.connection.writeSynReset(this.f5331id, errorCode2);
        }
    }

    public void closeLater(ErrorCode errorCode2) {
        if (closeInternal(errorCode2)) {
            this.connection.writeSynResetLater(this.f5331id, errorCode2);
        }
    }
    ...
    private boolean closeInternal(ErrorCode errorCode2) {
        synchronized (this) {
            ...
            notifyAll();
            this.connection.removeStream(this.f5331id);
            return true;
        }
    }
    ...
    private final class FramingSource implements Source {
        ...
        public long read(okio.Buffer r17, long r18) throws java.io.IOException {
            ...
            L_0x0049:
                ...
                int r9 = r0.f5331id     // Catch:{ all -> 0x00d4 }
                long r14 = r0.unacknowledgedBytesRead     // Catch:{ all -> 0x00d4 }
    ...
    final class FramingSink implements Sink {
        ...
        private void emitFrame(boolean r12) throws java.io.IOException {
            ...
            L_0x0024:
                ...
                int r6 = r0.f5331id     // Catch:{ all -> 0x006d }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:15:0x002d, code lost:
            r0 = r8.this$0;
            r0.connection.writeData(r0.f5331id, true, (okio.Buffer) null, 0);
         */
