...
public class ByteString implements Serializable, Comparable<ByteString> {
    public static final ByteString EMPTY = m5898of(new byte[0]);
    ...
    /* renamed from: of */
    public static ByteString m5898of(byte... bArr) {
        if (bArr != null) {
    ...
    private ByteString digest(String str) {
        try {
            return m5898of(MessageDigest.getInstance(str).digest(this.data));
    ...
    public int compareTo(ByteString byteString) {
        ...
        int i = 0;
        while (i < min) {
            byte b = getByte(i) & Constants.UNKNOWN;
            byte b2 = byteString.getByte(i) & Constants.UNKNOWN;
            if (b == b2) {
                i++;
            } else if (b < b2) {
                return -1;
